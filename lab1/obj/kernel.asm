...
void print_regs(struct pushregs *gpr) {
    ...
    802001a2:	b6250513          	addi	a0,a0,-1182 # 80200d00 <etext+0x292>
void print_regs(struct pushregs *gpr) {
    ...
    8020035a:	c9250513          	addi	a0,a0,-878 # 80200fe8 <etext+0x57a>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200370:	c9450513          	addi	a0,a0,-876 # 80201000 <etext+0x592>
void print_trapframe(struct trapframe *tf) {
    ...
    802003bc:	ca850513          	addi	a0,a0,-856 # 80201060 <etext+0x5f2>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003ec:	8c850513          	addi	a0,a0,-1848 # 80200cb0 <etext+0x242>
    802003f0:	c7dff06f          	j	8020006c <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003f4:	00001517          	auipc	a0,0x1
    802003f8:	89c50513          	addi	a0,a0,-1892 # 80200c90 <etext+0x222>
    802003fc:	c71ff06f          	j	8020006c <cprintf>
            cprintf("User software interrupt\n");
    80200400:	00001517          	auipc	a0,0x1
    80200404:	85050513          	addi	a0,a0,-1968 # 80200c50 <etext+0x1e2>
    80200408:	c65ff06f          	j	8020006c <cprintf>
            cprintf("Supervisor software interrupt\n");
    8020040c:	00001517          	auipc	a0,0x1
    80200410:	86450513          	addi	a0,a0,-1948 # 80200c70 <etext+0x202>
    ...
    8020041c:	8c850513          	addi	a0,a0,-1848 # 80200ce0 <etext+0x272>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020045c:	87850513          	addi	a0,a0,-1928 # 80200cd0 <etext+0x262>
    80200460:	c0dff0ef          	jal	ra,8020006c <cprintf>
				if(++num==10){
    80200464:	00004797          	auipc	a5,0x4
    80200468:	bac78793          	addi	a5,a5,-1108 # 80204010 <edata>
    8020046c:	639c                	ld	a5,0(a5)
    8020046e:	4729                	li	a4,10
    80200470:	0785                	addi	a5,a5,1
    80200472:	00004697          	auipc	a3,0x4
    80200476:	b8f6bf23          	sd	a5,-1122(a3) # 80204010 <edata>
    8020047a:	fce798e3          	bne	a5,a4,8020044a <interrupt_handler+0x84>
					asm volatile("ebreak");
    8020047e:	9002                	ebreak
					asm volatile("mret");
    80200480:	30200073          	mret
}
...
void exception_handler(struct trapframe *tf) {
    ...
    802004ba:	0141                	addi	sp,sp,16
            print_trapframe(tf);
    802004bc:	ea9ff06f          	j	80200364 <print_trapframe>
    802004c0:	8082                	ret
    ...
    8020050c:	b61ff0ef          	jal	ra,8020006c <cprintf>
			tf->epc += 2;
    80200510:	10843783          	ld	a5,264(s0)
}
    80200514:	60a2                	ld	ra,8(sp)
			tf->epc += 2;
    80200516:	0789                	addi	a5,a5,2
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    8020052a:	f63ff06f          	j	8020048c <exception_handler>
        interrupt_handler(tf);
    8020052e:	e99ff06f          	j	802003c6 <interrupt_handler>
	...
