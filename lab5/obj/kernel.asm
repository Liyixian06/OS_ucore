...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	1da060ef          	jal	ra,ffffffffc0206228 <memset>
...
ffffffffc020005a:	61258593          	addi	a1,a1,1554 # ffffffffc0206668 <etext+0x6>
ffffffffc020005e:	00006517          	auipc	a0,0x6
ffffffffc0200062:	62a50513          	addi	a0,a0,1578 # ffffffffc0206688 <etext+0x26>
...
ffffffffc020007e:	5b5050ef          	jal	ra,ffffffffc0205e32 <proc_init>
...
ffffffffc0200092:	6ed050ef          	jal	ra,ffffffffc0205f7e <cpu_idle>
...
ffffffffc02000c2:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000c4:	1fa060ef          	jal	ra,ffffffffc02062be <vprintfmt>
    return cnt;
}
...
ffffffffc02000f6:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000f8:	1c6060ef          	jal	ra,ffffffffc02062be <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200174:	52050513          	addi	a0,a0,1312 # ffffffffc0206690 <etext+0x2e>
...
ffffffffc020024c:	45050513          	addi	a0,a0,1104 # ffffffffc0206698 <etext+0x36>
    va_start(ap, fmt);
...
ffffffffc0200262:	28250513          	addi	a0,a0,642 # ffffffffc02074e0 <commands+0xd08>
...
ffffffffc0200294:	42850513          	addi	a0,a0,1064 # ffffffffc02066b8 <etext+0x56>
__warn(const char *file, int line, const char *fmt, ...) {
...
ffffffffc02002b4:	23050513          	addi	a0,a0,560 # ffffffffc02074e0 <commands+0xd08>
...
ffffffffc02002ca:	44250513          	addi	a0,a0,1090 # ffffffffc0206708 <etext+0xa6>
void print_kerninfo(void) {
...
ffffffffc02002e0:	44c50513          	addi	a0,a0,1100 # ffffffffc0206728 <etext+0xc6>
ffffffffc02002e4:	dedff0ef          	jal	ra,ffffffffc02000d0 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02002e8:	00006597          	auipc	a1,0x6
ffffffffc02002ec:	37a58593          	addi	a1,a1,890 # ffffffffc0206662 <etext>
ffffffffc02002f0:	00006517          	auipc	a0,0x6
ffffffffc02002f4:	45850513          	addi	a0,a0,1112 # ffffffffc0206748 <etext+0xe6>
...
ffffffffc0200308:	46450513          	addi	a0,a0,1124 # ffffffffc0206768 <etext+0x106>
...
ffffffffc020031c:	47050513          	addi	a0,a0,1136 # ffffffffc0206788 <etext+0x126>
...
ffffffffc020034a:	46250513          	addi	a0,a0,1122 # ffffffffc02067a8 <etext+0x146>
}
...
ffffffffc020035a:	38260613          	addi	a2,a2,898 # ffffffffc02066d8 <etext+0x76>
ffffffffc020035e:	04d00593          	li	a1,77
ffffffffc0200362:	00006517          	auipc	a0,0x6
ffffffffc0200366:	38e50513          	addi	a0,a0,910 # ffffffffc02066f0 <etext+0x8e>
void print_stackframe(void) {
...
ffffffffc0200376:	54660613          	addi	a2,a2,1350 # ffffffffc02068b8 <commands+0xe0>
ffffffffc020037a:	00006597          	auipc	a1,0x6
ffffffffc020037e:	55e58593          	addi	a1,a1,1374 # ffffffffc02068d8 <commands+0x100>
ffffffffc0200382:	00006517          	auipc	a0,0x6
ffffffffc0200386:	55e50513          	addi	a0,a0,1374 # ffffffffc02068e0 <commands+0x108>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200394:	56060613          	addi	a2,a2,1376 # ffffffffc02068f0 <commands+0x118>
ffffffffc0200398:	00006597          	auipc	a1,0x6
ffffffffc020039c:	58058593          	addi	a1,a1,1408 # ffffffffc0206918 <commands+0x140>
ffffffffc02003a0:	00006517          	auipc	a0,0x6
ffffffffc02003a4:	54050513          	addi	a0,a0,1344 # ffffffffc02068e0 <commands+0x108>
ffffffffc02003a8:	d29ff0ef          	jal	ra,ffffffffc02000d0 <cprintf>
ffffffffc02003ac:	00006617          	auipc	a2,0x6
ffffffffc02003b0:	57c60613          	addi	a2,a2,1404 # ffffffffc0206928 <commands+0x150>
ffffffffc02003b4:	00006597          	auipc	a1,0x6
ffffffffc02003b8:	59458593          	addi	a1,a1,1428 # ffffffffc0206948 <commands+0x170>
ffffffffc02003bc:	00006517          	auipc	a0,0x6
ffffffffc02003c0:	52450513          	addi	a0,a0,1316 # ffffffffc02068e0 <commands+0x108>
...
ffffffffc02003fa:	42a50513          	addi	a0,a0,1066 # ffffffffc0206820 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020041c:	43050513          	addi	a0,a0,1072 # ffffffffc0206848 <commands+0x70>
...
ffffffffc0200432:	3aac8c93          	addi	s9,s9,938 # ffffffffc02067d8 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200436:	00006997          	auipc	s3,0x6
ffffffffc020043a:	43a98993          	addi	s3,s3,1082 # ffffffffc0206870 <commands+0x98>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020043e:	00006917          	auipc	s2,0x6
ffffffffc0200442:	43a90913          	addi	s2,s2,1082 # ffffffffc0206878 <commands+0xa0>
        if (argc == MAXARGS - 1) {
ffffffffc0200446:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200448:	00006b17          	auipc	s6,0x6
ffffffffc020044c:	438b0b13          	addi	s6,s6,1080 # ffffffffc0206880 <commands+0xa8>
    if (argc == 0) {
ffffffffc0200450:	00006a97          	auipc	s5,0x6
ffffffffc0200454:	488a8a93          	addi	s5,s5,1160 # ffffffffc02068d8 <commands+0x100>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020046e:	59d050ef          	jal	ra,ffffffffc020620a <strchr>
...
ffffffffc0200488:	354d0d13          	addi	s10,s10,852 # ffffffffc02067d8 <commands>
    if (argc == 0) {
...
ffffffffc0200492:	54f050ef          	jal	ra,ffffffffc02061e0 <strcmp>
...
ffffffffc02004a6:	53b050ef          	jal	ra,ffffffffc02061e0 <strcmp>
...
ffffffffc020050c:	4ff050ef          	jal	ra,ffffffffc020620a <strchr>
...
ffffffffc0200528:	37c50513          	addi	a0,a0,892 # ffffffffc02068a0 <commands+0xc8>
...
ffffffffc0200556:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200558:	4e3050ef          	jal	ra,ffffffffc020623a <memcpy>
    return 0;
}
...
ffffffffc020057c:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc020057e:	4bd050ef          	jal	ra,ffffffffc020623a <memcpy>
    return 0;
}
...
ffffffffc02005b4:	3a850513          	addi	a0,a0,936 # ffffffffc0206958 <commands+0x180>
    ticks = 0;
...
ffffffffc0200688:	67c50513          	addi	a0,a0,1660 # ffffffffc0206d00 <commands+0x528>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200698:	68450513          	addi	a0,a0,1668 # ffffffffc0206d18 <commands+0x540>
...
ffffffffc02006a6:	68e50513          	addi	a0,a0,1678 # ffffffffc0206d30 <commands+0x558>
...
ffffffffc02006b4:	69850513          	addi	a0,a0,1688 # ffffffffc0206d48 <commands+0x570>
...
ffffffffc02006c2:	6a250513          	addi	a0,a0,1698 # ffffffffc0206d60 <commands+0x588>
...
ffffffffc02006d0:	6ac50513          	addi	a0,a0,1708 # ffffffffc0206d78 <commands+0x5a0>
...
ffffffffc02006de:	6b650513          	addi	a0,a0,1718 # ffffffffc0206d90 <commands+0x5b8>
...
ffffffffc02006ec:	6c050513          	addi	a0,a0,1728 # ffffffffc0206da8 <commands+0x5d0>
...
ffffffffc02006fa:	6ca50513          	addi	a0,a0,1738 # ffffffffc0206dc0 <commands+0x5e8>
...
ffffffffc0200708:	6d450513          	addi	a0,a0,1748 # ffffffffc0206dd8 <commands+0x600>
...
ffffffffc0200716:	6de50513          	addi	a0,a0,1758 # ffffffffc0206df0 <commands+0x618>
...
ffffffffc0200724:	6e850513          	addi	a0,a0,1768 # ffffffffc0206e08 <commands+0x630>
...
ffffffffc0200732:	6f250513          	addi	a0,a0,1778 # ffffffffc0206e20 <commands+0x648>
...
ffffffffc0200740:	6fc50513          	addi	a0,a0,1788 # ffffffffc0206e38 <commands+0x660>
...
ffffffffc020074e:	70650513          	addi	a0,a0,1798 # ffffffffc0206e50 <commands+0x678>
...
ffffffffc020075c:	71050513          	addi	a0,a0,1808 # ffffffffc0206e68 <commands+0x690>
...
ffffffffc020076a:	71a50513          	addi	a0,a0,1818 # ffffffffc0206e80 <commands+0x6a8>
...
ffffffffc0200778:	72450513          	addi	a0,a0,1828 # ffffffffc0206e98 <commands+0x6c0>
...
ffffffffc0200786:	72e50513          	addi	a0,a0,1838 # ffffffffc0206eb0 <commands+0x6d8>
...
ffffffffc0200794:	73850513          	addi	a0,a0,1848 # ffffffffc0206ec8 <commands+0x6f0>
...
ffffffffc02007a2:	74250513          	addi	a0,a0,1858 # ffffffffc0206ee0 <commands+0x708>
...
ffffffffc02007b0:	74c50513          	addi	a0,a0,1868 # ffffffffc0206ef8 <commands+0x720>
...
ffffffffc02007be:	75650513          	addi	a0,a0,1878 # ffffffffc0206f10 <commands+0x738>
...
ffffffffc02007cc:	76050513          	addi	a0,a0,1888 # ffffffffc0206f28 <commands+0x750>
...
ffffffffc02007da:	76a50513          	addi	a0,a0,1898 # ffffffffc0206f40 <commands+0x768>
...
ffffffffc02007e8:	77450513          	addi	a0,a0,1908 # ffffffffc0206f58 <commands+0x780>
...
ffffffffc02007f6:	77e50513          	addi	a0,a0,1918 # ffffffffc0206f70 <commands+0x798>
...
ffffffffc0200804:	78850513          	addi	a0,a0,1928 # ffffffffc0206f88 <commands+0x7b0>
...
ffffffffc0200812:	79250513          	addi	a0,a0,1938 # ffffffffc0206fa0 <commands+0x7c8>
...
ffffffffc0200820:	79c50513          	addi	a0,a0,1948 # ffffffffc0206fb8 <commands+0x7e0>
...
ffffffffc020082e:	7a650513          	addi	a0,a0,1958 # ffffffffc0206fd0 <commands+0x7f8>
...
ffffffffc0200840:	7ac50513          	addi	a0,a0,1964 # ffffffffc0206fe8 <commands+0x810>
}
...
ffffffffc0200856:	7ae50513          	addi	a0,a0,1966 # ffffffffc0207000 <commands+0x828>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc020086e:	7ae50513          	addi	a0,a0,1966 # ffffffffc0207018 <commands+0x840>
...
ffffffffc020087e:	7b650513          	addi	a0,a0,1974 # ffffffffc0207030 <commands+0x858>
...
ffffffffc020088e:	7be50513          	addi	a0,a0,1982 # ffffffffc0207048 <commands+0x870>
...
ffffffffc02008a2:	7ba50513          	addi	a0,a0,1978 # ffffffffc0207058 <commands+0x880>
}
...
ffffffffc02008ea:	39a50513          	addi	a0,a0,922 # ffffffffc0206c80 <commands+0x4a8>
...
ffffffffc020095c:	34868693          	addi	a3,a3,840 # ffffffffc0206ca0 <commands+0x4c8>
ffffffffc0200960:	00006617          	auipc	a2,0x6
ffffffffc0200964:	35860613          	addi	a2,a2,856 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0200968:	06d00593          	li	a1,109
ffffffffc020096c:	00006517          	auipc	a0,0x6
ffffffffc0200970:	36450513          	addi	a0,a0,868 # ffffffffc0206cd0 <commands+0x4f8>
...
ffffffffc02009a6:	2de50513          	addi	a0,a0,734 # ffffffffc0206c80 <commands+0x4a8>
ffffffffc02009aa:	f26ff0ef          	jal	ra,ffffffffc02000d0 <cprintf>
            panic("unhandled page fault.\n");
ffffffffc02009ae:	00006617          	auipc	a2,0x6
ffffffffc02009b2:	33a60613          	addi	a2,a2,826 # ffffffffc0206ce8 <commands+0x510>
ffffffffc02009b6:	07400593          	li	a1,116
ffffffffc02009ba:	00006517          	auipc	a0,0x6
ffffffffc02009be:	31650513          	addi	a0,a0,790 # ffffffffc0206cd0 <commands+0x4f8>
...
ffffffffc02009e0:	f9870713          	addi	a4,a4,-104 # ffffffffc0206974 <commands+0x19c>
...
ffffffffc02009f2:	25250513          	addi	a0,a0,594 # ffffffffc0206c40 <commands+0x468>
ffffffffc02009f6:	edaff06f          	j	ffffffffc02000d0 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02009fa:	00006517          	auipc	a0,0x6
ffffffffc02009fe:	22650513          	addi	a0,a0,550 # ffffffffc0206c20 <commands+0x448>
ffffffffc0200a02:	eceff06f          	j	ffffffffc02000d0 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc0200a06:	00006517          	auipc	a0,0x6
ffffffffc0200a0a:	1da50513          	addi	a0,a0,474 # ffffffffc0206be0 <commands+0x408>
ffffffffc0200a0e:	ec2ff06f          	j	ffffffffc02000d0 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc0200a12:	00006517          	auipc	a0,0x6
ffffffffc0200a16:	1ee50513          	addi	a0,a0,494 # ffffffffc0206c00 <commands+0x428>
...
ffffffffc0200a22:	24250513          	addi	a0,a0,578 # ffffffffc0206c60 <commands+0x488>
...
ffffffffc0200a78:	f3070713          	addi	a4,a4,-208 # ffffffffc02069a4 <commands+0x1cc>
...
ffffffffc0200a94:	0a850513          	addi	a0,a0,168 # ffffffffc0206b38 <commands+0x360>
...
ffffffffc0200aac:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200aae:	65c0506f          	j	ffffffffc020610a <syscall>
            cprintf("Environment call from H-mode\n");
ffffffffc0200ab2:	00006517          	auipc	a0,0x6
ffffffffc0200ab6:	0a650513          	addi	a0,a0,166 # ffffffffc0206b58 <commands+0x380>
}
...
ffffffffc0200aca:	0b250513          	addi	a0,a0,178 # ffffffffc0206b78 <commands+0x3a0>
ffffffffc0200ace:	b7f5                	j	ffffffffc0200aba <exception_handler+0x50>
            cprintf("Instruction page fault\n");
ffffffffc0200ad0:	00006517          	auipc	a0,0x6
ffffffffc0200ad4:	0c850513          	addi	a0,a0,200 # ffffffffc0206b98 <commands+0x3c0>
ffffffffc0200ad8:	b7cd                	j	ffffffffc0200aba <exception_handler+0x50>
            cprintf("Load page fault\n");
ffffffffc0200ada:	00006517          	auipc	a0,0x6
ffffffffc0200ade:	0d650513          	addi	a0,a0,214 # ffffffffc0206bb0 <commands+0x3d8>
...
ffffffffc0200b00:	0cc50513          	addi	a0,a0,204 # ffffffffc0206bc8 <commands+0x3f0>
...
ffffffffc0200b5a:	efa50513          	addi	a0,a0,-262 # ffffffffc0206a50 <commands+0x278>
...
ffffffffc0200b72:	f1250513          	addi	a0,a0,-238 # ffffffffc0206a80 <commands+0x2a8>
...
ffffffffc0200b8a:	f0a50513          	addi	a0,a0,-246 # ffffffffc0206a90 <commands+0x2b8>
...
ffffffffc0200ba2:	f1250513          	addi	a0,a0,-238 # ffffffffc0206ab0 <commands+0x2d8>
ffffffffc0200ba6:	bf11                	j	ffffffffc0200aba <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc0200ba8:	00006517          	auipc	a0,0x6
ffffffffc0200bac:	f2850513          	addi	a0,a0,-216 # ffffffffc0206ad0 <commands+0x2f8>
...
ffffffffc0200bca:	f2260613          	addi	a2,a2,-222 # ffffffffc0206ae8 <commands+0x310>
ffffffffc0200bce:	0de00593          	li	a1,222
ffffffffc0200bd2:	00006517          	auipc	a0,0x6
ffffffffc0200bd6:	0fe50513          	addi	a0,a0,254 # ffffffffc0206cd0 <commands+0x4f8>
ffffffffc0200bda:	e3cff0ef          	jal	ra,ffffffffc0200216 <__panic>
            cprintf("Store/AMO access fault\n");
ffffffffc0200bde:	00006517          	auipc	a0,0x6
ffffffffc0200be2:	f4250513          	addi	a0,a0,-190 # ffffffffc0206b20 <commands+0x348>
...
ffffffffc0200c02:	eea60613          	addi	a2,a2,-278 # ffffffffc0206ae8 <commands+0x310>
ffffffffc0200c06:	0e800593          	li	a1,232
ffffffffc0200c0a:	00006517          	auipc	a0,0x6
ffffffffc0200c0e:	0c650513          	addi	a0,a0,198 # ffffffffc0206cd0 <commands+0x4f8>
...
ffffffffc0200c28:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200c2c:	4de050ef          	jal	ra,ffffffffc020610a <syscall>
...
ffffffffc0200c52:	eba60613          	addi	a2,a2,-326 # ffffffffc0206b08 <commands+0x330>
ffffffffc0200c56:	0e200593          	li	a1,226
ffffffffc0200c5a:	00006517          	auipc	a0,0x6
ffffffffc0200c5e:	07650513          	addi	a0,a0,118 # ffffffffc0206cd0 <commands+0x4f8>
...
ffffffffc0200c76:	e7660613          	addi	a2,a2,-394 # ffffffffc0206ae8 <commands+0x310>
ffffffffc0200c7a:	10200593          	li	a1,258
ffffffffc0200c7e:	00006517          	auipc	a0,0x6
ffffffffc0200c82:	05250513          	addi	a0,a0,82 # ffffffffc0206cd0 <commands+0x4f8>
...
ffffffffc0200d08:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200d0a:	30a0506f          	j	ffffffffc0206014 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200d0e:	555d                	li	a0,-9
ffffffffc0200d10:	76c040ef          	jal	ra,ffffffffc020547c <do_exit>
...
ffffffffc0200e94:	24860613          	addi	a2,a2,584 # ffffffffc02070d8 <commands+0x900>
ffffffffc0200e98:	06200593          	li	a1,98
ffffffffc0200e9c:	00006517          	auipc	a0,0x6
ffffffffc0200ea0:	25c50513          	addi	a0,a0,604 # ffffffffc02070f8 <commands+0x920>
pa2page(uintptr_t pa) {
...
ffffffffc020103e:	1ea050ef          	jal	ra,ffffffffc0206228 <memset>
    return page - pages + nbase;
...
ffffffffc02010d0:	158050ef          	jal	ra,ffffffffc0206228 <memset>
    return page - pages + nbase;
...
ffffffffc020112a:	f7a60613          	addi	a2,a2,-134 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc020112e:	0e300593          	li	a1,227
ffffffffc0201132:	00006517          	auipc	a0,0x6
ffffffffc0201136:	f9650513          	addi	a0,a0,-106 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc020113a:	8dcff0ef          	jal	ra,ffffffffc0200216 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc020113e:	00006617          	auipc	a2,0x6
ffffffffc0201142:	f6260613          	addi	a2,a2,-158 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201146:	0ee00593          	li	a1,238
ffffffffc020114a:	00006517          	auipc	a0,0x6
ffffffffc020114e:	f7e50513          	addi	a0,a0,-130 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc020115c:	f4860613          	addi	a2,a2,-184 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201160:	0eb00593          	li	a1,235
ffffffffc0201164:	00006517          	auipc	a0,0x6
ffffffffc0201168:	f6450513          	addi	a0,a0,-156 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0201176:	f2e60613          	addi	a2,a2,-210 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc020117a:	0df00593          	li	a1,223
ffffffffc020117e:	00006517          	auipc	a0,0x6
ffffffffc0201182:	f4a50513          	addi	a0,a0,-182 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc02012c4:	40868693          	addi	a3,a3,1032 # ffffffffc02076c8 <commands+0xef0>
ffffffffc02012c8:	00006617          	auipc	a2,0x6
ffffffffc02012cc:	9f060613          	addi	a2,a2,-1552 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02012d0:	11000593          	li	a1,272
ffffffffc02012d4:	00006517          	auipc	a0,0x6
ffffffffc02012d8:	df450513          	addi	a0,a0,-524 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc02012dc:	f3bfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc02012e0:	00006697          	auipc	a3,0x6
ffffffffc02012e4:	3b868693          	addi	a3,a3,952 # ffffffffc0207698 <commands+0xec0>
ffffffffc02012e8:	00006617          	auipc	a2,0x6
ffffffffc02012ec:	9d060613          	addi	a2,a2,-1584 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02012f0:	10f00593          	li	a1,271
ffffffffc02012f4:	00006517          	auipc	a0,0x6
ffffffffc02012f8:	dd450513          	addi	a0,a0,-556 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc02014ee:	1ae68693          	addi	a3,a3,430 # ffffffffc0207698 <commands+0xec0>
ffffffffc02014f2:	00005617          	auipc	a2,0x5
ffffffffc02014f6:	7c660613          	addi	a2,a2,1990 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02014fa:	12000593          	li	a1,288
ffffffffc02014fe:	00006517          	auipc	a0,0x6
ffffffffc0201502:	bca50513          	addi	a0,a0,-1078 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201506:	d11fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    return KADDR(page2pa(page));
ffffffffc020150a:	00006617          	auipc	a2,0x6
ffffffffc020150e:	b9660613          	addi	a2,a2,-1130 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201512:	06900593          	li	a1,105
ffffffffc0201516:	00006517          	auipc	a0,0x6
ffffffffc020151a:	be250513          	addi	a0,a0,-1054 # ffffffffc02070f8 <commands+0x920>
ffffffffc020151e:	cf9fe0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0201522:	00006617          	auipc	a2,0x6
ffffffffc0201526:	bb660613          	addi	a2,a2,-1098 # ffffffffc02070d8 <commands+0x900>
ffffffffc020152a:	06200593          	li	a1,98
ffffffffc020152e:	00006517          	auipc	a0,0x6
ffffffffc0201532:	bca50513          	addi	a0,a0,-1078 # ffffffffc02070f8 <commands+0x920>
ffffffffc0201536:	ce1fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc020153a:	00006697          	auipc	a3,0x6
ffffffffc020153e:	18e68693          	addi	a3,a3,398 # ffffffffc02076c8 <commands+0xef0>
ffffffffc0201542:	00005617          	auipc	a2,0x5
ffffffffc0201546:	77660613          	addi	a2,a2,1910 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020154a:	12100593          	li	a1,289
ffffffffc020154e:	00006517          	auipc	a0,0x6
ffffffffc0201552:	b7a50513          	addi	a0,a0,-1158 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0201690:	d4c78793          	addi	a5,a5,-692 # ffffffffc02083d8 <default_pmm_manager>
...
ffffffffc020169c:	a8850513          	addi	a0,a0,-1400 # ffffffffc0207120 <commands+0x948>
void pmm_init(void) {
...
ffffffffc02016e6:	a5650513          	addi	a0,a0,-1450 # ffffffffc0207138 <commands+0x960>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc020170a:	a4a50513          	addi	a0,a0,-1462 # ffffffffc0207150 <commands+0x978>
...
ffffffffc02017b4:	9f050513          	addi	a0,a0,-1552 # ffffffffc02071a0 <commands+0x9c8>
...
ffffffffc02017ce:	9ee50513          	addi	a0,a0,-1554 # ffffffffc02071b8 <commands+0x9e0>
...
ffffffffc0201a24:	aa850513          	addi	a0,a0,-1368 # ffffffffc02074c8 <commands+0xcf0>
...
ffffffffc0201ad0:	b3458593          	addi	a1,a1,-1228 # ffffffffc0207600 <commands+0xe28>
ffffffffc0201ad4:	10000513          	li	a0,256
ffffffffc0201ad8:	6f6040ef          	jal	ra,ffffffffc02061ce <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201adc:	100b0593          	addi	a1,s6,256
ffffffffc0201ae0:	10000513          	li	a0,256
ffffffffc0201ae4:	6fc040ef          	jal	ra,ffffffffc02061e0 <strcmp>
...
ffffffffc0201b18:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fd52b88>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201b1c:	66e040ef          	jal	ra,ffffffffc020618a <strlen>
...
ffffffffc0201ba4:	ad850513          	addi	a0,a0,-1320 # ffffffffc0207678 <commands+0xea0>
...
ffffffffc0201bce:	91e68693          	addi	a3,a3,-1762 # ffffffffc02074e8 <commands+0xd10>
ffffffffc0201bd2:	00005617          	auipc	a2,0x5
ffffffffc0201bd6:	0e660613          	addi	a2,a2,230 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201bda:	22900593          	li	a1,553
ffffffffc0201bde:	00005517          	auipc	a0,0x5
ffffffffc0201be2:	4ea50513          	addi	a0,a0,1258 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0201bf0:	4b460613          	addi	a2,a2,1204 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201bf4:	22900593          	li	a1,553
ffffffffc0201bf8:	00005517          	auipc	a0,0x5
ffffffffc0201bfc:	4d050513          	addi	a0,a0,1232 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201c00:	e16fe0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0201c04:	00006697          	auipc	a3,0x6
ffffffffc0201c08:	92468693          	addi	a3,a3,-1756 # ffffffffc0207528 <commands+0xd50>
ffffffffc0201c0c:	00005617          	auipc	a2,0x5
ffffffffc0201c10:	0ac60613          	addi	a2,a2,172 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201c14:	22a00593          	li	a1,554
ffffffffc0201c18:	00005517          	auipc	a0,0x5
ffffffffc0201c1c:	4b050513          	addi	a0,a0,1200 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0201c2c:	47860613          	addi	a2,a2,1144 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201c30:	06900593          	li	a1,105
ffffffffc0201c34:	00005517          	auipc	a0,0x5
ffffffffc0201c38:	4c450513          	addi	a0,a0,1220 # ffffffffc02070f8 <commands+0x920>
ffffffffc0201c3c:	ddafe0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0201c40:	00005617          	auipc	a2,0x5
ffffffffc0201c44:	67860613          	addi	a2,a2,1656 # ffffffffc02072b8 <commands+0xae0>
ffffffffc0201c48:	07400593          	li	a1,116
ffffffffc0201c4c:	00005517          	auipc	a0,0x5
ffffffffc0201c50:	4ac50513          	addi	a0,a0,1196 # ffffffffc02070f8 <commands+0x920>
ffffffffc0201c54:	dc2fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc0201c58:	00005697          	auipc	a3,0x5
ffffffffc0201c5c:	5a068693          	addi	a3,a3,1440 # ffffffffc02071f8 <commands+0xa20>
ffffffffc0201c60:	00005617          	auipc	a2,0x5
ffffffffc0201c64:	05860613          	addi	a2,a2,88 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201c68:	1ed00593          	li	a1,493
ffffffffc0201c6c:	00005517          	auipc	a0,0x5
ffffffffc0201c70:	45c50513          	addi	a0,a0,1116 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201c74:	da2fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0201c78:	00005697          	auipc	a3,0x5
ffffffffc0201c7c:	66868693          	addi	a3,a3,1640 # ffffffffc02072e0 <commands+0xb08>
ffffffffc0201c80:	00005617          	auipc	a2,0x5
ffffffffc0201c84:	03860613          	addi	a2,a2,56 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201c88:	20900593          	li	a1,521
ffffffffc0201c8c:	00005517          	auipc	a0,0x5
ffffffffc0201c90:	43c50513          	addi	a0,a0,1084 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201c94:	d82fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0201c98:	00006697          	auipc	a3,0x6
ffffffffc0201c9c:	8c068693          	addi	a3,a3,-1856 # ffffffffc0207558 <commands+0xd80>
ffffffffc0201ca0:	00005617          	auipc	a2,0x5
ffffffffc0201ca4:	01860613          	addi	a2,a2,24 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201ca8:	23200593          	li	a1,562
ffffffffc0201cac:	00005517          	auipc	a0,0x5
ffffffffc0201cb0:	41c50513          	addi	a0,a0,1052 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201cb4:	d62fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0201cb8:	00005697          	auipc	a3,0x5
ffffffffc0201cbc:	6b868693          	addi	a3,a3,1720 # ffffffffc0207370 <commands+0xb98>
ffffffffc0201cc0:	00005617          	auipc	a2,0x5
ffffffffc0201cc4:	ff860613          	addi	a2,a2,-8 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201cc8:	20800593          	li	a1,520
ffffffffc0201ccc:	00005517          	auipc	a0,0x5
ffffffffc0201cd0:	3fc50513          	addi	a0,a0,1020 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201cd4:	d42fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0201cd8:	00005697          	auipc	a3,0x5
ffffffffc0201cdc:	76068693          	addi	a3,a3,1888 # ffffffffc0207438 <commands+0xc60>
ffffffffc0201ce0:	00005617          	auipc	a2,0x5
ffffffffc0201ce4:	fd860613          	addi	a2,a2,-40 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201ce8:	20700593          	li	a1,519
ffffffffc0201cec:	00005517          	auipc	a0,0x5
ffffffffc0201cf0:	3dc50513          	addi	a0,a0,988 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201cf4:	d22fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0201cf8:	00005697          	auipc	a3,0x5
ffffffffc0201cfc:	72868693          	addi	a3,a3,1832 # ffffffffc0207420 <commands+0xc48>
ffffffffc0201d00:	00005617          	auipc	a2,0x5
ffffffffc0201d04:	fb860613          	addi	a2,a2,-72 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201d08:	20600593          	li	a1,518
ffffffffc0201d0c:	00005517          	auipc	a0,0x5
ffffffffc0201d10:	3bc50513          	addi	a0,a0,956 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201d14:	d02fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0201d18:	00005697          	auipc	a3,0x5
ffffffffc0201d1c:	6d868693          	addi	a3,a3,1752 # ffffffffc02073f0 <commands+0xc18>
ffffffffc0201d20:	00005617          	auipc	a2,0x5
ffffffffc0201d24:	f9860613          	addi	a2,a2,-104 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201d28:	20500593          	li	a1,517
ffffffffc0201d2c:	00005517          	auipc	a0,0x5
ffffffffc0201d30:	39c50513          	addi	a0,a0,924 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201d34:	ce2fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0201d38:	00005697          	auipc	a3,0x5
ffffffffc0201d3c:	6a068693          	addi	a3,a3,1696 # ffffffffc02073d8 <commands+0xc00>
ffffffffc0201d40:	00005617          	auipc	a2,0x5
ffffffffc0201d44:	f7860613          	addi	a2,a2,-136 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201d48:	20300593          	li	a1,515
ffffffffc0201d4c:	00005517          	auipc	a0,0x5
ffffffffc0201d50:	37c50513          	addi	a0,a0,892 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201d54:	cc2fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc0201d58:	00005697          	auipc	a3,0x5
ffffffffc0201d5c:	66868693          	addi	a3,a3,1640 # ffffffffc02073c0 <commands+0xbe8>
ffffffffc0201d60:	00005617          	auipc	a2,0x5
ffffffffc0201d64:	f5860613          	addi	a2,a2,-168 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201d68:	20200593          	li	a1,514
ffffffffc0201d6c:	00005517          	auipc	a0,0x5
ffffffffc0201d70:	35c50513          	addi	a0,a0,860 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201d74:	ca2fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(*ptep & PTE_W);
ffffffffc0201d78:	00005697          	auipc	a3,0x5
ffffffffc0201d7c:	63868693          	addi	a3,a3,1592 # ffffffffc02073b0 <commands+0xbd8>
ffffffffc0201d80:	00005617          	auipc	a2,0x5
ffffffffc0201d84:	f3860613          	addi	a2,a2,-200 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201d88:	20100593          	li	a1,513
ffffffffc0201d8c:	00005517          	auipc	a0,0x5
ffffffffc0201d90:	33c50513          	addi	a0,a0,828 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201d94:	c82fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(*ptep & PTE_U);
ffffffffc0201d98:	00005697          	auipc	a3,0x5
ffffffffc0201d9c:	60868693          	addi	a3,a3,1544 # ffffffffc02073a0 <commands+0xbc8>
ffffffffc0201da0:	00005617          	auipc	a2,0x5
ffffffffc0201da4:	f1860613          	addi	a2,a2,-232 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201da8:	20000593          	li	a1,512
ffffffffc0201dac:	00005517          	auipc	a0,0x5
ffffffffc0201db0:	31c50513          	addi	a0,a0,796 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201db4:	c62fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0201db8:	00005697          	auipc	a3,0x5
ffffffffc0201dbc:	5b868693          	addi	a3,a3,1464 # ffffffffc0207370 <commands+0xb98>
ffffffffc0201dc0:	00005617          	auipc	a2,0x5
ffffffffc0201dc4:	ef860613          	addi	a2,a2,-264 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201dc8:	1ff00593          	li	a1,511
ffffffffc0201dcc:	00005517          	auipc	a0,0x5
ffffffffc0201dd0:	2fc50513          	addi	a0,a0,764 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201dd4:	c42fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0201dd8:	00005697          	auipc	a3,0x5
ffffffffc0201ddc:	56068693          	addi	a3,a3,1376 # ffffffffc0207338 <commands+0xb60>
ffffffffc0201de0:	00005617          	auipc	a2,0x5
ffffffffc0201de4:	ed860613          	addi	a2,a2,-296 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201de8:	1fe00593          	li	a1,510
ffffffffc0201dec:	00005517          	auipc	a0,0x5
ffffffffc0201df0:	2dc50513          	addi	a0,a0,732 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201df4:	c22fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0201df8:	00005697          	auipc	a3,0x5
ffffffffc0201dfc:	51868693          	addi	a3,a3,1304 # ffffffffc0207310 <commands+0xb38>
ffffffffc0201e00:	00005617          	auipc	a2,0x5
ffffffffc0201e04:	eb860613          	addi	a2,a2,-328 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201e08:	1fb00593          	li	a1,507
ffffffffc0201e0c:	00005517          	auipc	a0,0x5
ffffffffc0201e10:	2bc50513          	addi	a0,a0,700 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0201e1e:	28660613          	addi	a2,a2,646 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201e22:	1fa00593          	li	a1,506
ffffffffc0201e26:	00005517          	auipc	a0,0x5
ffffffffc0201e2a:	2a250513          	addi	a0,a0,674 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0201e38:	26c60613          	addi	a2,a2,620 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201e3c:	06900593          	li	a1,105
ffffffffc0201e40:	00005517          	auipc	a0,0x5
ffffffffc0201e44:	2b850513          	addi	a0,a0,696 # ffffffffc02070f8 <commands+0x920>
ffffffffc0201e48:	bcefe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc0201e4c:	00005697          	auipc	a3,0x5
ffffffffc0201e50:	63468693          	addi	a3,a3,1588 # ffffffffc0207480 <commands+0xca8>
ffffffffc0201e54:	00005617          	auipc	a2,0x5
ffffffffc0201e58:	e6460613          	addi	a2,a2,-412 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201e5c:	21400593          	li	a1,532
ffffffffc0201e60:	00005517          	auipc	a0,0x5
ffffffffc0201e64:	26850513          	addi	a0,a0,616 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201e68:	baefe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0201e6c:	00005697          	auipc	a3,0x5
ffffffffc0201e70:	5cc68693          	addi	a3,a3,1484 # ffffffffc0207438 <commands+0xc60>
ffffffffc0201e74:	00005617          	auipc	a2,0x5
ffffffffc0201e78:	e4460613          	addi	a2,a2,-444 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201e7c:	21200593          	li	a1,530
ffffffffc0201e80:	00005517          	auipc	a0,0x5
ffffffffc0201e84:	24850513          	addi	a0,a0,584 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201e88:	b8efe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0201e8c:	00005697          	auipc	a3,0x5
ffffffffc0201e90:	5dc68693          	addi	a3,a3,1500 # ffffffffc0207468 <commands+0xc90>
ffffffffc0201e94:	00005617          	auipc	a2,0x5
ffffffffc0201e98:	e2460613          	addi	a2,a2,-476 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201e9c:	21100593          	li	a1,529
ffffffffc0201ea0:	00005517          	auipc	a0,0x5
ffffffffc0201ea4:	22850513          	addi	a0,a0,552 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201ea8:	b6efe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0201eac:	00005697          	auipc	a3,0x5
ffffffffc0201eb0:	73c68693          	addi	a3,a3,1852 # ffffffffc02075e8 <commands+0xe10>
ffffffffc0201eb4:	00005617          	auipc	a2,0x5
ffffffffc0201eb8:	e0460613          	addi	a2,a2,-508 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201ebc:	23500593          	li	a1,565
ffffffffc0201ec0:	00005517          	auipc	a0,0x5
ffffffffc0201ec4:	20850513          	addi	a0,a0,520 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201ec8:	b4efe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0201ecc:	00005697          	auipc	a3,0x5
ffffffffc0201ed0:	6dc68693          	addi	a3,a3,1756 # ffffffffc02075a8 <commands+0xdd0>
ffffffffc0201ed4:	00005617          	auipc	a2,0x5
ffffffffc0201ed8:	de460613          	addi	a2,a2,-540 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201edc:	23400593          	li	a1,564
ffffffffc0201ee0:	00005517          	auipc	a0,0x5
ffffffffc0201ee4:	1e850513          	addi	a0,a0,488 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201ee8:	b2efe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0201eec:	00005697          	auipc	a3,0x5
ffffffffc0201ef0:	6a468693          	addi	a3,a3,1700 # ffffffffc0207590 <commands+0xdb8>
ffffffffc0201ef4:	00005617          	auipc	a2,0x5
ffffffffc0201ef8:	dc460613          	addi	a2,a2,-572 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201efc:	23300593          	li	a1,563
ffffffffc0201f00:	00005517          	auipc	a0,0x5
ffffffffc0201f04:	1c850513          	addi	a0,a0,456 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0201f12:	19260613          	addi	a2,a2,402 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0201f16:	1f900593          	li	a1,505
ffffffffc0201f1a:	00005517          	auipc	a0,0x5
ffffffffc0201f1e:	1ae50513          	addi	a0,a0,430 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201f22:	af4fe0ef          	jal	ra,ffffffffc0200216 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0201f26:	00005617          	auipc	a2,0x5
ffffffffc0201f2a:	25260613          	addi	a2,a2,594 # ffffffffc0207178 <commands+0x9a0>
ffffffffc0201f2e:	07f00593          	li	a1,127
ffffffffc0201f32:	00005517          	auipc	a0,0x5
ffffffffc0201f36:	19650513          	addi	a0,a0,406 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201f3a:	adcfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f3e:	00005697          	auipc	a3,0x5
ffffffffc0201f42:	6da68693          	addi	a3,a3,1754 # ffffffffc0207618 <commands+0xe40>
ffffffffc0201f46:	00005617          	auipc	a2,0x5
ffffffffc0201f4a:	d7260613          	addi	a2,a2,-654 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201f4e:	23900593          	li	a1,569
ffffffffc0201f52:	00005517          	auipc	a0,0x5
ffffffffc0201f56:	17650513          	addi	a0,a0,374 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201f5a:	abcfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0201f5e:	00005697          	auipc	a3,0x5
ffffffffc0201f62:	54a68693          	addi	a3,a3,1354 # ffffffffc02074a8 <commands+0xcd0>
ffffffffc0201f66:	00005617          	auipc	a2,0x5
ffffffffc0201f6a:	d5260613          	addi	a2,a2,-686 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201f6e:	24500593          	li	a1,581
ffffffffc0201f72:	00005517          	auipc	a0,0x5
ffffffffc0201f76:	15650513          	addi	a0,a0,342 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201f7a:	a9cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0201f7e:	00005697          	auipc	a3,0x5
ffffffffc0201f82:	37a68693          	addi	a3,a3,890 # ffffffffc02072f8 <commands+0xb20>
ffffffffc0201f86:	00005617          	auipc	a2,0x5
ffffffffc0201f8a:	d3260613          	addi	a2,a2,-718 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201f8e:	1f700593          	li	a1,503
ffffffffc0201f92:	00005517          	auipc	a0,0x5
ffffffffc0201f96:	13650513          	addi	a0,a0,310 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201f9a:	a7cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0201f9e:	00005697          	auipc	a3,0x5
ffffffffc0201fa2:	34268693          	addi	a3,a3,834 # ffffffffc02072e0 <commands+0xb08>
ffffffffc0201fa6:	00005617          	auipc	a2,0x5
ffffffffc0201faa:	d1260613          	addi	a2,a2,-750 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201fae:	1f600593          	li	a1,502
ffffffffc0201fb2:	00005517          	auipc	a0,0x5
ffffffffc0201fb6:	11650513          	addi	a0,a0,278 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201fba:	a5cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0201fbe:	00005697          	auipc	a3,0x5
ffffffffc0201fc2:	27268693          	addi	a3,a3,626 # ffffffffc0207230 <commands+0xa58>
ffffffffc0201fc6:	00005617          	auipc	a2,0x5
ffffffffc0201fca:	cf260613          	addi	a2,a2,-782 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201fce:	1ee00593          	li	a1,494
ffffffffc0201fd2:	00005517          	auipc	a0,0x5
ffffffffc0201fd6:	0f650513          	addi	a0,a0,246 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201fda:	a3cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((ptep = get_pte(boot_pgdir, 0x0, 0)) != NULL);
ffffffffc0201fde:	00005697          	auipc	a3,0x5
ffffffffc0201fe2:	2aa68693          	addi	a3,a3,682 # ffffffffc0207288 <commands+0xab0>
ffffffffc0201fe6:	00005617          	auipc	a2,0x5
ffffffffc0201fea:	cd260613          	addi	a2,a2,-814 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0201fee:	1f500593          	li	a1,501
ffffffffc0201ff2:	00005517          	auipc	a0,0x5
ffffffffc0201ff6:	0d650513          	addi	a0,a0,214 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc0201ffa:	a1cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0201ffe:	00005697          	auipc	a3,0x5
ffffffffc0202002:	25a68693          	addi	a3,a3,602 # ffffffffc0207258 <commands+0xa80>
ffffffffc0202006:	00005617          	auipc	a2,0x5
ffffffffc020200a:	cb260613          	addi	a2,a2,-846 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020200e:	1f200593          	li	a1,498
ffffffffc0202012:	00005517          	auipc	a0,0x5
ffffffffc0202016:	0b650513          	addi	a0,a0,182 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc020201a:	9fcfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020201e:	00005697          	auipc	a3,0x5
ffffffffc0202022:	41a68693          	addi	a3,a3,1050 # ffffffffc0207438 <commands+0xc60>
ffffffffc0202026:	00005617          	auipc	a2,0x5
ffffffffc020202a:	c9260613          	addi	a2,a2,-878 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020202e:	20e00593          	li	a1,526
ffffffffc0202032:	00005517          	auipc	a0,0x5
ffffffffc0202036:	09650513          	addi	a0,a0,150 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc020203a:	9dcfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020203e:	00005697          	auipc	a3,0x5
ffffffffc0202042:	2ba68693          	addi	a3,a3,698 # ffffffffc02072f8 <commands+0xb20>
ffffffffc0202046:	00005617          	auipc	a2,0x5
ffffffffc020204a:	c7260613          	addi	a2,a2,-910 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020204e:	20d00593          	li	a1,525
ffffffffc0202052:	00005517          	auipc	a0,0x5
ffffffffc0202056:	07650513          	addi	a0,a0,118 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc020205a:	9bcfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020205e:	00005697          	auipc	a3,0x5
ffffffffc0202062:	3f268693          	addi	a3,a3,1010 # ffffffffc0207450 <commands+0xc78>
ffffffffc0202066:	00005617          	auipc	a2,0x5
ffffffffc020206a:	c5260613          	addi	a2,a2,-942 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020206e:	20a00593          	li	a1,522
ffffffffc0202072:	00005517          	auipc	a0,0x5
ffffffffc0202076:	05650513          	addi	a0,a0,86 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc020207a:	99cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020207e:	00005697          	auipc	a3,0x5
ffffffffc0202082:	5d268693          	addi	a3,a3,1490 # ffffffffc0207650 <commands+0xe78>
ffffffffc0202086:	00005617          	auipc	a2,0x5
ffffffffc020208a:	c3260613          	addi	a2,a2,-974 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020208e:	23c00593          	li	a1,572
ffffffffc0202092:	00005517          	auipc	a0,0x5
ffffffffc0202096:	03650513          	addi	a0,a0,54 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc020209a:	97cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020209e:	00005697          	auipc	a3,0x5
ffffffffc02020a2:	40a68693          	addi	a3,a3,1034 # ffffffffc02074a8 <commands+0xcd0>
ffffffffc02020a6:	00005617          	auipc	a2,0x5
ffffffffc02020aa:	c1260613          	addi	a2,a2,-1006 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02020ae:	21c00593          	li	a1,540
ffffffffc02020b2:	00005517          	auipc	a0,0x5
ffffffffc02020b6:	01650513          	addi	a0,a0,22 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc02020ba:	95cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02020be:	00005697          	auipc	a3,0x5
ffffffffc02020c2:	48268693          	addi	a3,a3,1154 # ffffffffc0207540 <commands+0xd68>
ffffffffc02020c6:	00005617          	auipc	a2,0x5
ffffffffc02020ca:	bf260613          	addi	a2,a2,-1038 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02020ce:	22e00593          	li	a1,558
ffffffffc02020d2:	00005517          	auipc	a0,0x5
ffffffffc02020d6:	ff650513          	addi	a0,a0,-10 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc02020da:	93cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc02020de:	00005697          	auipc	a3,0x5
ffffffffc02020e2:	0fa68693          	addi	a3,a3,250 # ffffffffc02071d8 <commands+0xa00>
ffffffffc02020e6:	00005617          	auipc	a2,0x5
ffffffffc02020ea:	bd260613          	addi	a2,a2,-1070 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02020ee:	1ec00593          	li	a1,492
ffffffffc02020f2:	00005517          	auipc	a0,0x5
ffffffffc02020f6:	fd650513          	addi	a0,a0,-42 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc02020fa:	91cfe0ef          	jal	ra,ffffffffc0200216 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02020fe:	00005617          	auipc	a2,0x5
ffffffffc0202102:	07a60613          	addi	a2,a2,122 # ffffffffc0207178 <commands+0x9a0>
ffffffffc0202106:	0c100593          	li	a1,193
ffffffffc020210a:	00005517          	auipc	a0,0x5
ffffffffc020210e:	fbe50513          	addi	a0,a0,-66 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0202236:	004040ef          	jal	ra,ffffffffc020623a <memcpy>
...
ffffffffc020224c:	e4868693          	addi	a3,a3,-440 # ffffffffc0207090 <commands+0x8b8>
ffffffffc0202250:	00005617          	auipc	a2,0x5
ffffffffc0202254:	a6860613          	addi	a2,a2,-1432 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202258:	18c00593          	li	a1,396
ffffffffc020225c:	00005517          	auipc	a0,0x5
ffffffffc0202260:	e6c50513          	addi	a0,a0,-404 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc0202286:	e1e60613          	addi	a2,a2,-482 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc020228a:	06900593          	li	a1,105
ffffffffc020228e:	00005517          	auipc	a0,0x5
ffffffffc0202292:	e6a50513          	addi	a0,a0,-406 # ffffffffc02070f8 <commands+0x920>
ffffffffc0202296:	f81fd0ef          	jal	ra,ffffffffc0200216 <__panic>
            assert(page != NULL);
ffffffffc020229a:	00005697          	auipc	a3,0x5
ffffffffc020229e:	dd668693          	addi	a3,a3,-554 # ffffffffc0207070 <commands+0x898>
ffffffffc02022a2:	00005617          	auipc	a2,0x5
ffffffffc02022a6:	a1660613          	addi	a2,a2,-1514 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02022aa:	17200593          	li	a1,370
ffffffffc02022ae:	00005517          	auipc	a0,0x5
ffffffffc02022b2:	e1a50513          	addi	a0,a0,-486 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc02022b6:	f61fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc02022ba:	00005697          	auipc	a3,0x5
ffffffffc02022be:	40e68693          	addi	a3,a3,1038 # ffffffffc02076c8 <commands+0xef0>
ffffffffc02022c2:	00005617          	auipc	a2,0x5
ffffffffc02022c6:	9f660613          	addi	a2,a2,-1546 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02022ca:	15e00593          	li	a1,350
ffffffffc02022ce:	00005517          	auipc	a0,0x5
ffffffffc02022d2:	dfa50513          	addi	a0,a0,-518 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc02022d6:	f41fd0ef          	jal	ra,ffffffffc0200216 <__panic>
            assert(npage != NULL);
ffffffffc02022da:	00005697          	auipc	a3,0x5
ffffffffc02022de:	da668693          	addi	a3,a3,-602 # ffffffffc0207080 <commands+0x8a8>
ffffffffc02022e2:	00005617          	auipc	a2,0x5
ffffffffc02022e6:	9d660613          	addi	a2,a2,-1578 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02022ea:	17300593          	li	a1,371
ffffffffc02022ee:	00005517          	auipc	a0,0x5
ffffffffc02022f2:	dda50513          	addi	a0,a0,-550 # ffffffffc02070c8 <commands+0x8f0>
ffffffffc02022f6:	f21fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02022fa:	00005617          	auipc	a2,0x5
ffffffffc02022fe:	dde60613          	addi	a2,a2,-546 # ffffffffc02070d8 <commands+0x900>
ffffffffc0202302:	06200593          	li	a1,98
ffffffffc0202306:	00005517          	auipc	a0,0x5
ffffffffc020230a:	df250513          	addi	a0,a0,-526 # ffffffffc02070f8 <commands+0x920>
ffffffffc020230e:	f09fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202312:	00005617          	auipc	a2,0x5
ffffffffc0202316:	fa660613          	addi	a2,a2,-90 # ffffffffc02072b8 <commands+0xae0>
ffffffffc020231a:	07400593          	li	a1,116
ffffffffc020231e:	00005517          	auipc	a0,0x5
ffffffffc0202322:	dda50513          	addi	a0,a0,-550 # ffffffffc02070f8 <commands+0x920>
ffffffffc0202326:	ef1fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc020232a:	00005697          	auipc	a3,0x5
ffffffffc020232e:	36e68693          	addi	a3,a3,878 # ffffffffc0207698 <commands+0xec0>
ffffffffc0202332:	00005617          	auipc	a2,0x5
ffffffffc0202336:	98660613          	addi	a2,a2,-1658 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020233a:	15d00593          	li	a1,349
ffffffffc020233e:	00005517          	auipc	a0,0x5
ffffffffc0202342:	d8a50513          	addi	a0,a0,-630 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc02023c8:	d4468693          	addi	a3,a3,-700 # ffffffffc0207108 <commands+0x930>
ffffffffc02023cc:	00005617          	auipc	a2,0x5
ffffffffc02023d0:	8ec60613          	addi	a2,a2,-1812 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02023d4:	1cd00593          	li	a1,461
ffffffffc02023d8:	00005517          	auipc	a0,0x5
ffffffffc02023dc:	cf050513          	addi	a0,a0,-784 # ffffffffc02070c8 <commands+0x8f0>
...
ffffffffc02023ea:	2fa68693          	addi	a3,a3,762 # ffffffffc02076e0 <commands+0xf08>
ffffffffc02023ee:	00005617          	auipc	a2,0x5
ffffffffc02023f2:	8ca60613          	addi	a2,a2,-1846 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02023f6:	06d00593          	li	a1,109
ffffffffc02023fa:	00005517          	auipc	a0,0x5
ffffffffc02023fe:	30650513          	addi	a0,a0,774 # ffffffffc0207700 <commands+0xf28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0202532:	2c268693          	addi	a3,a3,706 # ffffffffc02077f0 <commands+0x1018>
ffffffffc0202536:	00004617          	auipc	a2,0x4
ffffffffc020253a:	78260613          	addi	a2,a2,1922 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020253e:	07400593          	li	a1,116
ffffffffc0202542:	00005517          	auipc	a0,0x5
ffffffffc0202546:	1be50513          	addi	a0,a0,446 # ffffffffc0207700 <commands+0xf28>
ffffffffc020254a:	ccdfd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020254e:	00005697          	auipc	a3,0x5
ffffffffc0202552:	2e268693          	addi	a3,a3,738 # ffffffffc0207830 <commands+0x1058>
ffffffffc0202556:	00004617          	auipc	a2,0x4
ffffffffc020255a:	76260613          	addi	a2,a2,1890 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020255e:	06c00593          	li	a1,108
ffffffffc0202562:	00005517          	auipc	a0,0x5
ffffffffc0202566:	19e50513          	addi	a0,a0,414 # ffffffffc0207700 <commands+0xf28>
ffffffffc020256a:	cadfd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020256e:	00005697          	auipc	a3,0x5
ffffffffc0202572:	2a268693          	addi	a3,a3,674 # ffffffffc0207810 <commands+0x1038>
ffffffffc0202576:	00004617          	auipc	a2,0x4
ffffffffc020257a:	74260613          	addi	a2,a2,1858 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020257e:	06b00593          	li	a1,107
ffffffffc0202582:	00005517          	auipc	a0,0x5
ffffffffc0202586:	17e50513          	addi	a0,a0,382 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc02025c4:	29068693          	addi	a3,a3,656 # ffffffffc0207850 <commands+0x1078>
ffffffffc02025c8:	00004617          	auipc	a2,0x4
ffffffffc02025cc:	6f060613          	addi	a2,a2,1776 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02025d0:	09400593          	li	a1,148
ffffffffc02025d4:	00005517          	auipc	a0,0x5
ffffffffc02025d8:	12c50513          	addi	a0,a0,300 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc0202676:	1f668693          	addi	a3,a3,502 # ffffffffc0207868 <commands+0x1090>
ffffffffc020267a:	00004617          	auipc	a2,0x4
ffffffffc020267e:	63e60613          	addi	a2,a2,1598 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202682:	0a700593          	li	a1,167
ffffffffc0202686:	00005517          	auipc	a0,0x5
ffffffffc020268a:	07a50513          	addi	a0,a0,122 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc0202712:	0a268693          	addi	a3,a3,162 # ffffffffc02077b0 <commands+0xfd8>
ffffffffc0202716:	00004617          	auipc	a2,0x4
ffffffffc020271a:	5a260613          	addi	a2,a2,1442 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020271e:	0c000593          	li	a1,192
ffffffffc0202722:	00005517          	auipc	a0,0x5
ffffffffc0202726:	fde50513          	addi	a0,a0,-34 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc0202788:	04c68693          	addi	a3,a3,76 # ffffffffc02077d0 <commands+0xff8>
ffffffffc020278c:	00004617          	auipc	a2,0x4
ffffffffc0202790:	52c60613          	addi	a2,a2,1324 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202794:	0d600593          	li	a1,214
ffffffffc0202798:	00005517          	auipc	a0,0x5
ffffffffc020279c:	f6850513          	addi	a0,a0,-152 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc02027e8:	2ac68693          	addi	a3,a3,684 # ffffffffc0207a90 <commands+0x12b8>
ffffffffc02027ec:	00004617          	auipc	a2,0x4
ffffffffc02027f0:	4cc60613          	addi	a2,a2,1228 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02027f4:	11300593          	li	a1,275
ffffffffc02027f8:	00005517          	auipc	a0,0x5
ffffffffc02027fc:	f0850513          	addi	a0,a0,-248 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc0202836:	25e68693          	addi	a3,a3,606 # ffffffffc0207a90 <commands+0x12b8>
ffffffffc020283a:	00004617          	auipc	a2,0x4
ffffffffc020283e:	47e60613          	addi	a2,a2,1150 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202842:	11900593          	li	a1,281
ffffffffc0202846:	00005517          	auipc	a0,0x5
ffffffffc020284a:	eba50513          	addi	a0,a0,-326 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc020290a:	07250513          	addi	a0,a0,114 # ffffffffc0207978 <commands+0x11a0>
ffffffffc020290e:	fc2fd0ef          	jal	ra,ffffffffc02000d0 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0202912:	00005697          	auipc	a3,0x5
ffffffffc0202916:	08e68693          	addi	a3,a3,142 # ffffffffc02079a0 <commands+0x11c8>
ffffffffc020291a:	00004617          	auipc	a2,0x4
ffffffffc020291e:	39e60613          	addi	a2,a2,926 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202922:	13b00593          	li	a1,315
ffffffffc0202926:	00005517          	auipc	a0,0x5
ffffffffc020292a:	dda50513          	addi	a0,a0,-550 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc0202942:	07a50513          	addi	a0,a0,122 # ffffffffc02079b8 <commands+0x11e0>
...
ffffffffc02029f8:	3ac68693          	addi	a3,a3,940 # ffffffffc0208da0 <nbase>
...
ffffffffc0202a96:	fc650513          	addi	a0,a0,-58 # ffffffffc0207a58 <commands+0x1280>
...
ffffffffc0202ab0:	fcc50513          	addi	a0,a0,-52 # ffffffffc0207a78 <commands+0x12a0>
}
...
ffffffffc0202abe:	dd668693          	addi	a3,a3,-554 # ffffffffc0207890 <commands+0x10b8>
ffffffffc0202ac2:	00004617          	auipc	a2,0x4
ffffffffc0202ac6:	1f660613          	addi	a2,a2,502 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202aca:	12200593          	li	a1,290
ffffffffc0202ace:	00005517          	auipc	a0,0x5
ffffffffc0202ad2:	c3250513          	addi	a0,a0,-974 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202ad6:	f40fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0202ada:	00005697          	auipc	a3,0x5
ffffffffc0202ade:	e3e68693          	addi	a3,a3,-450 # ffffffffc0207918 <commands+0x1140>
ffffffffc0202ae2:	00004617          	auipc	a2,0x4
ffffffffc0202ae6:	1d660613          	addi	a2,a2,470 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202aea:	13200593          	li	a1,306
ffffffffc0202aee:	00005517          	auipc	a0,0x5
ffffffffc0202af2:	c1250513          	addi	a0,a0,-1006 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202af6:	f20fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0202afa:	00005697          	auipc	a3,0x5
ffffffffc0202afe:	e4e68693          	addi	a3,a3,-434 # ffffffffc0207948 <commands+0x1170>
ffffffffc0202b02:	00004617          	auipc	a2,0x4
ffffffffc0202b06:	1b660613          	addi	a2,a2,438 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202b0a:	13300593          	li	a1,307
ffffffffc0202b0e:	00005517          	auipc	a0,0x5
ffffffffc0202b12:	bf250513          	addi	a0,a0,-1038 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202b16:	f00fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(vma != NULL);
ffffffffc0202b1a:	00005697          	auipc	a3,0x5
ffffffffc0202b1e:	f7668693          	addi	a3,a3,-138 # ffffffffc0207a90 <commands+0x12b8>
ffffffffc0202b22:	00004617          	auipc	a2,0x4
ffffffffc0202b26:	19660613          	addi	a2,a2,406 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202b2a:	15200593          	li	a1,338
ffffffffc0202b2e:	00005517          	auipc	a0,0x5
ffffffffc0202b32:	bd250513          	addi	a0,a0,-1070 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202b36:	ee0fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0202b3a:	00005697          	auipc	a3,0x5
ffffffffc0202b3e:	d3e68693          	addi	a3,a3,-706 # ffffffffc0207878 <commands+0x10a0>
ffffffffc0202b42:	00004617          	auipc	a2,0x4
ffffffffc0202b46:	17660613          	addi	a2,a2,374 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202b4a:	12000593          	li	a1,288
ffffffffc0202b4e:	00005517          	auipc	a0,0x5
ffffffffc0202b52:	bb250513          	addi	a0,a0,-1102 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202b56:	ec0fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(vma3 == NULL);
ffffffffc0202b5a:	00005697          	auipc	a3,0x5
ffffffffc0202b5e:	d8e68693          	addi	a3,a3,-626 # ffffffffc02078e8 <commands+0x1110>
ffffffffc0202b62:	00004617          	auipc	a2,0x4
ffffffffc0202b66:	15660613          	addi	a2,a2,342 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202b6a:	12c00593          	li	a1,300
ffffffffc0202b6e:	00005517          	auipc	a0,0x5
ffffffffc0202b72:	b9250513          	addi	a0,a0,-1134 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202b76:	ea0fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(vma2 != NULL);
ffffffffc0202b7a:	00005697          	auipc	a3,0x5
ffffffffc0202b7e:	d5e68693          	addi	a3,a3,-674 # ffffffffc02078d8 <commands+0x1100>
ffffffffc0202b82:	00004617          	auipc	a2,0x4
ffffffffc0202b86:	13660613          	addi	a2,a2,310 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202b8a:	12a00593          	li	a1,298
ffffffffc0202b8e:	00005517          	auipc	a0,0x5
ffffffffc0202b92:	b7250513          	addi	a0,a0,-1166 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202b96:	e80fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(vma1 != NULL);
ffffffffc0202b9a:	00005697          	auipc	a3,0x5
ffffffffc0202b9e:	d2e68693          	addi	a3,a3,-722 # ffffffffc02078c8 <commands+0x10f0>
ffffffffc0202ba2:	00004617          	auipc	a2,0x4
ffffffffc0202ba6:	11660613          	addi	a2,a2,278 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202baa:	12800593          	li	a1,296
ffffffffc0202bae:	00005517          	auipc	a0,0x5
ffffffffc0202bb2:	b5250513          	addi	a0,a0,-1198 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202bb6:	e60fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(vma5 == NULL);
ffffffffc0202bba:	00005697          	auipc	a3,0x5
ffffffffc0202bbe:	d4e68693          	addi	a3,a3,-690 # ffffffffc0207908 <commands+0x1130>
ffffffffc0202bc2:	00004617          	auipc	a2,0x4
ffffffffc0202bc6:	0f660613          	addi	a2,a2,246 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202bca:	13000593          	li	a1,304
ffffffffc0202bce:	00005517          	auipc	a0,0x5
ffffffffc0202bd2:	b3250513          	addi	a0,a0,-1230 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202bd6:	e40fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        assert(vma4 == NULL);
ffffffffc0202bda:	00005697          	auipc	a3,0x5
ffffffffc0202bde:	d1e68693          	addi	a3,a3,-738 # ffffffffc02078f8 <commands+0x1120>
ffffffffc0202be2:	00004617          	auipc	a2,0x4
ffffffffc0202be6:	0d660613          	addi	a2,a2,214 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202bea:	12e00593          	li	a1,302
ffffffffc0202bee:	00005517          	auipc	a0,0x5
ffffffffc0202bf2:	b1250513          	addi	a0,a0,-1262 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202bf6:	e20fd0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202bfa:	00004617          	auipc	a2,0x4
ffffffffc0202bfe:	4de60613          	addi	a2,a2,1246 # ffffffffc02070d8 <commands+0x900>
ffffffffc0202c02:	06200593          	li	a1,98
ffffffffc0202c06:	00004517          	auipc	a0,0x4
ffffffffc0202c0a:	4f250513          	addi	a0,a0,1266 # ffffffffc02070f8 <commands+0x920>
ffffffffc0202c0e:	e08fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(mm != NULL);
ffffffffc0202c12:	00005697          	auipc	a3,0x5
ffffffffc0202c16:	c5668693          	addi	a3,a3,-938 # ffffffffc0207868 <commands+0x1090>
ffffffffc0202c1a:	00004617          	auipc	a2,0x4
ffffffffc0202c1e:	09e60613          	addi	a2,a2,158 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202c22:	10c00593          	li	a1,268
ffffffffc0202c26:	00005517          	auipc	a0,0x5
ffffffffc0202c2a:	ada50513          	addi	a0,a0,-1318 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202c2e:	de8fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0202c32:	00005697          	auipc	a3,0x5
ffffffffc0202c36:	dfe68693          	addi	a3,a3,-514 # ffffffffc0207a30 <commands+0x1258>
ffffffffc0202c3a:	00004617          	auipc	a2,0x4
ffffffffc0202c3e:	07e60613          	addi	a2,a2,126 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202c42:	17000593          	li	a1,368
ffffffffc0202c46:	00005517          	auipc	a0,0x5
ffffffffc0202c4a:	aba50513          	addi	a0,a0,-1350 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202c4e:	dc8fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0202c52:	00005697          	auipc	a3,0x5
ffffffffc0202c56:	d9e68693          	addi	a3,a3,-610 # ffffffffc02079f0 <commands+0x1218>
ffffffffc0202c5a:	00004617          	auipc	a2,0x4
ffffffffc0202c5e:	05e60613          	addi	a2,a2,94 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202c62:	14f00593          	li	a1,335
ffffffffc0202c66:	00005517          	auipc	a0,0x5
ffffffffc0202c6a:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202c6e:	da8fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0202c72:	00005697          	auipc	a3,0x5
ffffffffc0202c76:	d8e68693          	addi	a3,a3,-626 # ffffffffc0207a00 <commands+0x1228>
ffffffffc0202c7a:	00004617          	auipc	a2,0x4
ffffffffc0202c7e:	03e60613          	addi	a2,a2,62 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202c82:	15700593          	li	a1,343
ffffffffc0202c86:	00005517          	auipc	a0,0x5
ffffffffc0202c8a:	a7a50513          	addi	a0,a0,-1414 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202c8e:	d88fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    return KADDR(page2pa(page));
ffffffffc0202c92:	00004617          	auipc	a2,0x4
ffffffffc0202c96:	40e60613          	addi	a2,a2,1038 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0202c9a:	06900593          	li	a1,105
ffffffffc0202c9e:	00004517          	auipc	a0,0x4
ffffffffc0202ca2:	45a50513          	addi	a0,a0,1114 # ffffffffc02070f8 <commands+0x920>
ffffffffc0202ca6:	d70fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(sum == 0);
ffffffffc0202caa:	00005697          	auipc	a3,0x5
ffffffffc0202cae:	d7668693          	addi	a3,a3,-650 # ffffffffc0207a20 <commands+0x1248>
ffffffffc0202cb2:	00004617          	auipc	a2,0x4
ffffffffc0202cb6:	00660613          	addi	a2,a2,6 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202cba:	16300593          	li	a1,355
ffffffffc0202cbe:	00005517          	auipc	a0,0x5
ffffffffc0202cc2:	a4250513          	addi	a0,a0,-1470 # ffffffffc0207700 <commands+0xf28>
ffffffffc0202cc6:	d50fd0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0202cca:	00005697          	auipc	a3,0x5
ffffffffc0202cce:	d0e68693          	addi	a3,a3,-754 # ffffffffc02079d8 <commands+0x1200>
ffffffffc0202cd2:	00004617          	auipc	a2,0x4
ffffffffc0202cd6:	fe660613          	addi	a2,a2,-26 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0202cda:	14b00593          	li	a1,331
ffffffffc0202cde:	00005517          	auipc	a0,0x5
ffffffffc0202ce2:	a2250513          	addi	a0,a0,-1502 # ffffffffc0207700 <commands+0xf28>
...
ffffffffc0202d92:	9d250513          	addi	a0,a0,-1582 # ffffffffc0207760 <commands+0xf88>
...
ffffffffc0202da4:	97050513          	addi	a0,a0,-1680 # ffffffffc0207710 <commands+0xf38>
...
ffffffffc0202db4:	9d850513          	addi	a0,a0,-1576 # ffffffffc0207788 <commands+0xfb0>
...
ffffffffc0202dc4:	98050513          	addi	a0,a0,-1664 # ffffffffc0207740 <commands+0xf68>
...
ffffffffc0202ee2:	c4250513          	addi	a0,a0,-958 # ffffffffc0207b20 <commands+0x1348>
...
ffffffffc0202f40:	c2c50513          	addi	a0,a0,-980 # ffffffffc0207b68 <commands+0x1390>
...
ffffffffc0202f9a:	c1250513          	addi	a0,a0,-1006 # ffffffffc0207ba8 <commands+0x13d0>
...
ffffffffc0202fb6:	c4650513          	addi	a0,a0,-954 # ffffffffc0207bf8 <commands+0x1420>
...
ffffffffc0203036:	c4e50513          	addi	a0,a0,-946 # ffffffffc0207c80 <commands+0x14a8>
...
ffffffffc020310e:	c96d8d93          	addi	s11,s11,-874 # ffffffffc0208da0 <nbase>
...
ffffffffc0203176:	bc650513          	addi	a0,a0,-1082 # ffffffffc0207d38 <commands+0x1560>
...
ffffffffc0203272:	b1a50513          	addi	a0,a0,-1254 # ffffffffc0207d88 <commands+0x15b0>
...
ffffffffc0203288:	8b468693          	addi	a3,a3,-1868 # ffffffffc0207b38 <commands+0x1360>
ffffffffc020328c:	00004617          	auipc	a2,0x4
ffffffffc0203290:	a2c60613          	addi	a2,a2,-1492 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203294:	0bc00593          	li	a1,188
ffffffffc0203298:	00005517          	auipc	a0,0x5
ffffffffc020329c:	87850513          	addi	a0,a0,-1928 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02032a0:	f77fc0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02032a4:	00004617          	auipc	a2,0x4
ffffffffc02032a8:	e3460613          	addi	a2,a2,-460 # ffffffffc02070d8 <commands+0x900>
ffffffffc02032ac:	06200593          	li	a1,98
ffffffffc02032b0:	00004517          	auipc	a0,0x4
ffffffffc02032b4:	e4850513          	addi	a0,a0,-440 # ffffffffc02070f8 <commands+0x920>
ffffffffc02032b8:	f5ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc02032bc:	00005697          	auipc	a3,0x5
ffffffffc02032c0:	a5468693          	addi	a3,a3,-1452 # ffffffffc0207d10 <commands+0x1538>
ffffffffc02032c4:	00004617          	auipc	a2,0x4
ffffffffc02032c8:	9f460613          	addi	a2,a2,-1548 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02032cc:	0fc00593          	li	a1,252
ffffffffc02032d0:	00005517          	auipc	a0,0x5
ffffffffc02032d4:	84050513          	addi	a0,a0,-1984 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02032d8:	f3ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02032dc:	00004617          	auipc	a2,0x4
ffffffffc02032e0:	fdc60613          	addi	a2,a2,-36 # ffffffffc02072b8 <commands+0xae0>
ffffffffc02032e4:	07400593          	li	a1,116
ffffffffc02032e8:	00004517          	auipc	a0,0x4
ffffffffc02032ec:	e1050513          	addi	a0,a0,-496 # ffffffffc02070f8 <commands+0x920>
ffffffffc02032f0:	f27fc0ef          	jal	ra,ffffffffc0200216 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc02032f4:	00005697          	auipc	a3,0x5
ffffffffc02032f8:	94468693          	addi	a3,a3,-1724 # ffffffffc0207c38 <commands+0x1460>
ffffffffc02032fc:	00004617          	auipc	a2,0x4
ffffffffc0203300:	9bc60613          	addi	a2,a2,-1604 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203304:	0dd00593          	li	a1,221
ffffffffc0203308:	00005517          	auipc	a0,0x5
ffffffffc020330c:	80850513          	addi	a0,a0,-2040 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203310:	f07fc0ef          	jal	ra,ffffffffc0200216 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0203314:	00005697          	auipc	a3,0x5
ffffffffc0203318:	90c68693          	addi	a3,a3,-1780 # ffffffffc0207c20 <commands+0x1448>
ffffffffc020331c:	00004617          	auipc	a2,0x4
ffffffffc0203320:	99c60613          	addi	a2,a2,-1636 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203324:	0dc00593          	li	a1,220
ffffffffc0203328:	00004517          	auipc	a0,0x4
ffffffffc020332c:	7e850513          	addi	a0,a0,2024 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203330:	ee7fc0ef          	jal	ra,ffffffffc0200216 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0203334:	00005697          	auipc	a3,0x5
ffffffffc0203338:	9c468693          	addi	a3,a3,-1596 # ffffffffc0207cf8 <commands+0x1520>
ffffffffc020333c:	00004617          	auipc	a2,0x4
ffffffffc0203340:	97c60613          	addi	a2,a2,-1668 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203344:	0fb00593          	li	a1,251
ffffffffc0203348:	00004517          	auipc	a0,0x4
ffffffffc020334c:	7c850513          	addi	a0,a0,1992 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203350:	ec7fc0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203354:	00004617          	auipc	a2,0x4
ffffffffc0203358:	79c60613          	addi	a2,a2,1948 # ffffffffc0207af0 <commands+0x1318>
ffffffffc020335c:	02800593          	li	a1,40
ffffffffc0203360:	00004517          	auipc	a0,0x4
ffffffffc0203364:	7b050513          	addi	a0,a0,1968 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203368:	eaffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==2);
ffffffffc020336c:	00005697          	auipc	a3,0x5
ffffffffc0203370:	94c68693          	addi	a3,a3,-1716 # ffffffffc0207cb8 <commands+0x14e0>
ffffffffc0203374:	00004617          	auipc	a2,0x4
ffffffffc0203378:	94460613          	addi	a2,a2,-1724 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020337c:	09700593          	li	a1,151
ffffffffc0203380:	00004517          	auipc	a0,0x4
ffffffffc0203384:	79050513          	addi	a0,a0,1936 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203388:	e8ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==2);
ffffffffc020338c:	00005697          	auipc	a3,0x5
ffffffffc0203390:	92c68693          	addi	a3,a3,-1748 # ffffffffc0207cb8 <commands+0x14e0>
ffffffffc0203394:	00004617          	auipc	a2,0x4
ffffffffc0203398:	92460613          	addi	a2,a2,-1756 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020339c:	09900593          	li	a1,153
ffffffffc02033a0:	00004517          	auipc	a0,0x4
ffffffffc02033a4:	77050513          	addi	a0,a0,1904 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02033a8:	e6ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==3);
ffffffffc02033ac:	00005697          	auipc	a3,0x5
ffffffffc02033b0:	91c68693          	addi	a3,a3,-1764 # ffffffffc0207cc8 <commands+0x14f0>
ffffffffc02033b4:	00004617          	auipc	a2,0x4
ffffffffc02033b8:	90460613          	addi	a2,a2,-1788 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02033bc:	09b00593          	li	a1,155
ffffffffc02033c0:	00004517          	auipc	a0,0x4
ffffffffc02033c4:	75050513          	addi	a0,a0,1872 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02033c8:	e4ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==3);
ffffffffc02033cc:	00005697          	auipc	a3,0x5
ffffffffc02033d0:	8fc68693          	addi	a3,a3,-1796 # ffffffffc0207cc8 <commands+0x14f0>
ffffffffc02033d4:	00004617          	auipc	a2,0x4
ffffffffc02033d8:	8e460613          	addi	a2,a2,-1820 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02033dc:	09d00593          	li	a1,157
ffffffffc02033e0:	00004517          	auipc	a0,0x4
ffffffffc02033e4:	73050513          	addi	a0,a0,1840 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02033e8:	e2ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==1);
ffffffffc02033ec:	00005697          	auipc	a3,0x5
ffffffffc02033f0:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0207ca8 <commands+0x14d0>
ffffffffc02033f4:	00004617          	auipc	a2,0x4
ffffffffc02033f8:	8c460613          	addi	a2,a2,-1852 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02033fc:	09300593          	li	a1,147
ffffffffc0203400:	00004517          	auipc	a0,0x4
ffffffffc0203404:	71050513          	addi	a0,a0,1808 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203408:	e0ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==1);
ffffffffc020340c:	00005697          	auipc	a3,0x5
ffffffffc0203410:	89c68693          	addi	a3,a3,-1892 # ffffffffc0207ca8 <commands+0x14d0>
ffffffffc0203414:	00004617          	auipc	a2,0x4
ffffffffc0203418:	8a460613          	addi	a2,a2,-1884 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020341c:	09500593          	li	a1,149
ffffffffc0203420:	00004517          	auipc	a0,0x4
ffffffffc0203424:	6f050513          	addi	a0,a0,1776 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203428:	deffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==4);
ffffffffc020342c:	00005697          	auipc	a3,0x5
ffffffffc0203430:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0207cd8 <commands+0x1500>
ffffffffc0203434:	00004617          	auipc	a2,0x4
ffffffffc0203438:	88460613          	addi	a2,a2,-1916 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020343c:	09f00593          	li	a1,159
ffffffffc0203440:	00004517          	auipc	a0,0x4
ffffffffc0203444:	6d050513          	addi	a0,a0,1744 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203448:	dcffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgfault_num==4);
ffffffffc020344c:	00005697          	auipc	a3,0x5
ffffffffc0203450:	88c68693          	addi	a3,a3,-1908 # ffffffffc0207cd8 <commands+0x1500>
ffffffffc0203454:	00004617          	auipc	a2,0x4
ffffffffc0203458:	86460613          	addi	a2,a2,-1948 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020345c:	0a100593          	li	a1,161
ffffffffc0203460:	00004517          	auipc	a0,0x4
ffffffffc0203464:	6b050513          	addi	a0,a0,1712 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203468:	daffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(pgdir[0] == 0);
ffffffffc020346c:	00004697          	auipc	a3,0x4
ffffffffc0203470:	58468693          	addi	a3,a3,1412 # ffffffffc02079f0 <commands+0x1218>
ffffffffc0203474:	00004617          	auipc	a2,0x4
ffffffffc0203478:	84460613          	addi	a2,a2,-1980 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020347c:	0cc00593          	li	a1,204
ffffffffc0203480:	00004517          	auipc	a0,0x4
ffffffffc0203484:	69050513          	addi	a0,a0,1680 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203488:	d8ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(vma != NULL);
ffffffffc020348c:	00004697          	auipc	a3,0x4
ffffffffc0203490:	60468693          	addi	a3,a3,1540 # ffffffffc0207a90 <commands+0x12b8>
ffffffffc0203494:	00004617          	auipc	a2,0x4
ffffffffc0203498:	82460613          	addi	a2,a2,-2012 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020349c:	0cf00593          	li	a1,207
ffffffffc02034a0:	00004517          	auipc	a0,0x4
ffffffffc02034a4:	67050513          	addi	a0,a0,1648 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02034a8:	d6ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc02034ac:	00004697          	auipc	a3,0x4
ffffffffc02034b0:	73468693          	addi	a3,a3,1844 # ffffffffc0207be0 <commands+0x1408>
ffffffffc02034b4:	00004617          	auipc	a2,0x4
ffffffffc02034b8:	80460613          	addi	a2,a2,-2044 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02034bc:	0d700593          	li	a1,215
ffffffffc02034c0:	00004517          	auipc	a0,0x4
ffffffffc02034c4:	65050513          	addi	a0,a0,1616 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02034c8:	d4ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert( nr_free == 0);         
ffffffffc02034cc:	00005697          	auipc	a3,0x5
ffffffffc02034d0:	81c68693          	addi	a3,a3,-2020 # ffffffffc0207ce8 <commands+0x1510>
ffffffffc02034d4:	00003617          	auipc	a2,0x3
ffffffffc02034d8:	7e460613          	addi	a2,a2,2020 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02034dc:	0f300593          	li	a1,243
ffffffffc02034e0:	00004517          	auipc	a0,0x4
ffffffffc02034e4:	63050513          	addi	a0,a0,1584 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02034e8:	d2ffc0ef          	jal	ra,ffffffffc0200216 <__panic>
    return KADDR(page2pa(page));
ffffffffc02034ec:	00004617          	auipc	a2,0x4
ffffffffc02034f0:	bb460613          	addi	a2,a2,-1100 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc02034f4:	06900593          	li	a1,105
ffffffffc02034f8:	00004517          	auipc	a0,0x4
ffffffffc02034fc:	c0050513          	addi	a0,a0,-1024 # ffffffffc02070f8 <commands+0x920>
ffffffffc0203500:	d17fc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(count==0);
ffffffffc0203504:	00005697          	auipc	a3,0x5
ffffffffc0203508:	86468693          	addi	a3,a3,-1948 # ffffffffc0207d68 <commands+0x1590>
ffffffffc020350c:	00003617          	auipc	a2,0x3
ffffffffc0203510:	7ac60613          	addi	a2,a2,1964 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203514:	11d00593          	li	a1,285
ffffffffc0203518:	00004517          	auipc	a0,0x4
ffffffffc020351c:	5f850513          	addi	a0,a0,1528 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203520:	cf7fc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(total==0);
ffffffffc0203524:	00005697          	auipc	a3,0x5
ffffffffc0203528:	85468693          	addi	a3,a3,-1964 # ffffffffc0207d78 <commands+0x15a0>
ffffffffc020352c:	00003617          	auipc	a2,0x3
ffffffffc0203530:	78c60613          	addi	a2,a2,1932 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203534:	11e00593          	li	a1,286
ffffffffc0203538:	00004517          	auipc	a0,0x4
ffffffffc020353c:	5d850513          	addi	a0,a0,1496 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203540:	cd7fc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203544:	00004697          	auipc	a3,0x4
ffffffffc0203548:	71468693          	addi	a3,a3,1812 # ffffffffc0207c58 <commands+0x1480>
ffffffffc020354c:	00003617          	auipc	a2,0x3
ffffffffc0203550:	76c60613          	addi	a2,a2,1900 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203554:	0ea00593          	li	a1,234
ffffffffc0203558:	00004517          	auipc	a0,0x4
ffffffffc020355c:	5b850513          	addi	a0,a0,1464 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203560:	cb7fc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(mm != NULL);
ffffffffc0203564:	00004697          	auipc	a3,0x4
ffffffffc0203568:	30468693          	addi	a3,a3,772 # ffffffffc0207868 <commands+0x1090>
ffffffffc020356c:	00003617          	auipc	a2,0x3
ffffffffc0203570:	74c60613          	addi	a2,a2,1868 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203574:	0c400593          	li	a1,196
ffffffffc0203578:	00004517          	auipc	a0,0x4
ffffffffc020357c:	59850513          	addi	a0,a0,1432 # ffffffffc0207b10 <commands+0x1338>
ffffffffc0203580:	c97fc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203584:	00004697          	auipc	a3,0x4
ffffffffc0203588:	60c68693          	addi	a3,a3,1548 # ffffffffc0207b90 <commands+0x13b8>
ffffffffc020358c:	00003617          	auipc	a2,0x3
ffffffffc0203590:	72c60613          	addi	a2,a2,1836 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203594:	0c700593          	li	a1,199
ffffffffc0203598:	00004517          	auipc	a0,0x4
ffffffffc020359c:	57850513          	addi	a0,a0,1400 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02035a0:	c77fc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(ret==0);
ffffffffc02035a4:	00004697          	auipc	a3,0x4
ffffffffc02035a8:	7bc68693          	addi	a3,a3,1980 # ffffffffc0207d60 <commands+0x1588>
ffffffffc02035ac:	00003617          	auipc	a2,0x3
ffffffffc02035b0:	70c60613          	addi	a2,a2,1804 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02035b4:	10200593          	li	a1,258
ffffffffc02035b8:	00004517          	auipc	a0,0x4
ffffffffc02035bc:	55850513          	addi	a0,a0,1368 # ffffffffc0207b10 <commands+0x1338>
ffffffffc02035c0:	c57fc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(total == nr_free_pages());
ffffffffc02035c4:	00004697          	auipc	a3,0x4
ffffffffc02035c8:	58468693          	addi	a3,a3,1412 # ffffffffc0207b48 <commands+0x1370>
ffffffffc02035cc:	00003617          	auipc	a2,0x3
ffffffffc02035d0:	6ec60613          	addi	a2,a2,1772 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02035d4:	0bf00593          	li	a1,191
ffffffffc02035d8:	00004517          	auipc	a0,0x4
ffffffffc02035dc:	53850513          	addi	a0,a0,1336 # ffffffffc0207b10 <commands+0x1338>
...
ffffffffc0203630:	7dcb0b13          	addi	s6,s6,2012 # ffffffffc0207e08 <commands+0x1630>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203634:	00004b97          	auipc	s7,0x4
ffffffffc0203638:	7bcb8b93          	addi	s7,s7,1980 # ffffffffc0207df0 <commands+0x1618>
...
ffffffffc02036ea:	6c250513          	addi	a0,a0,1730 # ffffffffc0207da8 <commands+0x15d0>
...
ffffffffc02036fc:	6e068693          	addi	a3,a3,1760 # ffffffffc0207dd8 <commands+0x1600>
ffffffffc0203700:	00003617          	auipc	a2,0x3
ffffffffc0203704:	5b860613          	addi	a2,a2,1464 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203708:	06800593          	li	a1,104
ffffffffc020370c:	00004517          	auipc	a0,0x4
ffffffffc0203710:	40450513          	addi	a0,a0,1028 # ffffffffc0207b10 <commands+0x1338>
...
ffffffffc0203754:	36050513          	addi	a0,a0,864 # ffffffffc0207ab0 <commands+0x12d8>
...
ffffffffc0203776:	32e68693          	addi	a3,a3,814 # ffffffffc0207aa0 <commands+0x12c8>
ffffffffc020377a:	00003617          	auipc	a2,0x3
ffffffffc020377e:	53e60613          	addi	a2,a2,1342 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203782:	07e00593          	li	a1,126
ffffffffc0203786:	00004517          	auipc	a0,0x4
ffffffffc020378a:	38a50513          	addi	a0,a0,906 # ffffffffc0207b10 <commands+0x1338>
...
ffffffffc02038c6:	4de78793          	addi	a5,a5,1246 # ffffffffc0208da0 <nbase>
    return KADDR(page2pa(page));
...
ffffffffc0203908:	79c60613          	addi	a2,a2,1948 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc020390c:	06900593          	li	a1,105
ffffffffc0203910:	00003517          	auipc	a0,0x3
ffffffffc0203914:	7e850513          	addi	a0,a0,2024 # ffffffffc02070f8 <commands+0x920>
...
ffffffffc0203a04:	46868693          	addi	a3,a3,1128 # ffffffffc0207e68 <commands+0x1690>
ffffffffc0203a08:	00003617          	auipc	a2,0x3
ffffffffc0203a0c:	2b060613          	addi	a2,a2,688 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203a10:	06400593          	li	a1,100
ffffffffc0203a14:	00004517          	auipc	a0,0x4
ffffffffc0203a18:	47450513          	addi	a0,a0,1140 # ffffffffc0207e88 <commands+0x16b0>
...
ffffffffc0203a26:	47e50513          	addi	a0,a0,1150 # ffffffffc0207ea0 <commands+0x16c8>
kmalloc_init(void) {
...
ffffffffc0203a36:	41650513          	addi	a0,a0,1046 # ffffffffc0207e48 <commands+0x1670>
}
...
ffffffffc0203b82:	22278793          	addi	a5,a5,546 # ffffffffc0208da0 <nbase>
...
ffffffffc0203bf8:	58460613          	addi	a2,a2,1412 # ffffffffc0207178 <commands+0x9a0>
ffffffffc0203bfc:	06e00593          	li	a1,110
ffffffffc0203c00:	00003517          	auipc	a0,0x3
ffffffffc0203c04:	4f850513          	addi	a0,a0,1272 # ffffffffc02070f8 <commands+0x920>
ffffffffc0203c08:	e0efc0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c0c:	00003617          	auipc	a2,0x3
ffffffffc0203c10:	4cc60613          	addi	a2,a2,1228 # ffffffffc02070d8 <commands+0x900>
ffffffffc0203c14:	06200593          	li	a1,98
ffffffffc0203c18:	00003517          	auipc	a0,0x3
ffffffffc0203c1c:	4e050513          	addi	a0,a0,1248 # ffffffffc02070f8 <commands+0x920>
...
ffffffffc0203c4c:	27050513          	addi	a0,a0,624 # ffffffffc0207eb8 <commands+0x16e0>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc0203c84:	27850513          	addi	a0,a0,632 # ffffffffc0207ef8 <commands+0x1720>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203ca2:	28250513          	addi	a0,a0,642 # ffffffffc0207f20 <commands+0x1748>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc0203cbe:	28e50513          	addi	a0,a0,654 # ffffffffc0207f48 <commands+0x1770>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203cda:	29a50513          	addi	a0,a0,666 # ffffffffc0207f70 <commands+0x1798>
...
ffffffffc0203cf8:	25450513          	addi	a0,a0,596 # ffffffffc0207f48 <commands+0x1770>
...
ffffffffc0203d10:	1ec50513          	addi	a0,a0,492 # ffffffffc0207ef8 <commands+0x1720>
...
ffffffffc0203d2a:	22250513          	addi	a0,a0,546 # ffffffffc0207f48 <commands+0x1770>
...
ffffffffc0203d44:	17850513          	addi	a0,a0,376 # ffffffffc0207eb8 <commands+0x16e0>
...
ffffffffc0203d5e:	1c650513          	addi	a0,a0,454 # ffffffffc0207f20 <commands+0x1748>
...
ffffffffc0203d78:	1fc50513          	addi	a0,a0,508 # ffffffffc0207f70 <commands+0x1798>
...
ffffffffc0203d96:	16650513          	addi	a0,a0,358 # ffffffffc0207ef8 <commands+0x1720>
...
ffffffffc0203dd2:	f0a68693          	addi	a3,a3,-246 # ffffffffc0207cd8 <commands+0x1500>
ffffffffc0203dd6:	00003617          	auipc	a2,0x3
ffffffffc0203dda:	ee260613          	addi	a2,a2,-286 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203dde:	05100593          	li	a1,81
ffffffffc0203de2:	00004517          	auipc	a0,0x4
ffffffffc0203de6:	0fe50513          	addi	a0,a0,254 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203dea:	c2cfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==11);
ffffffffc0203dee:	00004697          	auipc	a3,0x4
ffffffffc0203df2:	23268693          	addi	a3,a3,562 # ffffffffc0208020 <commands+0x1848>
ffffffffc0203df6:	00003617          	auipc	a2,0x3
ffffffffc0203dfa:	ec260613          	addi	a2,a2,-318 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203dfe:	07300593          	li	a1,115
ffffffffc0203e02:	00004517          	auipc	a0,0x4
ffffffffc0203e06:	0de50513          	addi	a0,a0,222 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203e0a:	c0cfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203e0e:	00004697          	auipc	a3,0x4
ffffffffc0203e12:	1ea68693          	addi	a3,a3,490 # ffffffffc0207ff8 <commands+0x1820>
ffffffffc0203e16:	00003617          	auipc	a2,0x3
ffffffffc0203e1a:	ea260613          	addi	a2,a2,-350 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203e1e:	07100593          	li	a1,113
ffffffffc0203e22:	00004517          	auipc	a0,0x4
ffffffffc0203e26:	0be50513          	addi	a0,a0,190 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203e2a:	becfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==10);
ffffffffc0203e2e:	00004697          	auipc	a3,0x4
ffffffffc0203e32:	1ba68693          	addi	a3,a3,442 # ffffffffc0207fe8 <commands+0x1810>
ffffffffc0203e36:	00003617          	auipc	a2,0x3
ffffffffc0203e3a:	e8260613          	addi	a2,a2,-382 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203e3e:	06f00593          	li	a1,111
ffffffffc0203e42:	00004517          	auipc	a0,0x4
ffffffffc0203e46:	09e50513          	addi	a0,a0,158 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203e4a:	bccfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==9);
ffffffffc0203e4e:	00004697          	auipc	a3,0x4
ffffffffc0203e52:	18a68693          	addi	a3,a3,394 # ffffffffc0207fd8 <commands+0x1800>
ffffffffc0203e56:	00003617          	auipc	a2,0x3
ffffffffc0203e5a:	e6260613          	addi	a2,a2,-414 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203e5e:	06c00593          	li	a1,108
ffffffffc0203e62:	00004517          	auipc	a0,0x4
ffffffffc0203e66:	07e50513          	addi	a0,a0,126 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203e6a:	bacfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==8);
ffffffffc0203e6e:	00004697          	auipc	a3,0x4
ffffffffc0203e72:	15a68693          	addi	a3,a3,346 # ffffffffc0207fc8 <commands+0x17f0>
ffffffffc0203e76:	00003617          	auipc	a2,0x3
ffffffffc0203e7a:	e4260613          	addi	a2,a2,-446 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203e7e:	06900593          	li	a1,105
ffffffffc0203e82:	00004517          	auipc	a0,0x4
ffffffffc0203e86:	05e50513          	addi	a0,a0,94 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203e8a:	b8cfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==7);
ffffffffc0203e8e:	00004697          	auipc	a3,0x4
ffffffffc0203e92:	12a68693          	addi	a3,a3,298 # ffffffffc0207fb8 <commands+0x17e0>
ffffffffc0203e96:	00003617          	auipc	a2,0x3
ffffffffc0203e9a:	e2260613          	addi	a2,a2,-478 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203e9e:	06600593          	li	a1,102
ffffffffc0203ea2:	00004517          	auipc	a0,0x4
ffffffffc0203ea6:	03e50513          	addi	a0,a0,62 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203eaa:	b6cfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==6);
ffffffffc0203eae:	00004697          	auipc	a3,0x4
ffffffffc0203eb2:	0fa68693          	addi	a3,a3,250 # ffffffffc0207fa8 <commands+0x17d0>
ffffffffc0203eb6:	00003617          	auipc	a2,0x3
ffffffffc0203eba:	e0260613          	addi	a2,a2,-510 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203ebe:	06300593          	li	a1,99
ffffffffc0203ec2:	00004517          	auipc	a0,0x4
ffffffffc0203ec6:	01e50513          	addi	a0,a0,30 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203eca:	b4cfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==5);
ffffffffc0203ece:	00004697          	auipc	a3,0x4
ffffffffc0203ed2:	0ca68693          	addi	a3,a3,202 # ffffffffc0207f98 <commands+0x17c0>
ffffffffc0203ed6:	00003617          	auipc	a2,0x3
ffffffffc0203eda:	de260613          	addi	a2,a2,-542 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203ede:	06000593          	li	a1,96
ffffffffc0203ee2:	00004517          	auipc	a0,0x4
ffffffffc0203ee6:	ffe50513          	addi	a0,a0,-2 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203eea:	b2cfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==5);
ffffffffc0203eee:	00004697          	auipc	a3,0x4
ffffffffc0203ef2:	0aa68693          	addi	a3,a3,170 # ffffffffc0207f98 <commands+0x17c0>
ffffffffc0203ef6:	00003617          	auipc	a2,0x3
ffffffffc0203efa:	dc260613          	addi	a2,a2,-574 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203efe:	05d00593          	li	a1,93
ffffffffc0203f02:	00004517          	auipc	a0,0x4
ffffffffc0203f06:	fde50513          	addi	a0,a0,-34 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203f0a:	b0cfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==4);
ffffffffc0203f0e:	00004697          	auipc	a3,0x4
ffffffffc0203f12:	dca68693          	addi	a3,a3,-566 # ffffffffc0207cd8 <commands+0x1500>
ffffffffc0203f16:	00003617          	auipc	a2,0x3
ffffffffc0203f1a:	da260613          	addi	a2,a2,-606 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203f1e:	05a00593          	li	a1,90
ffffffffc0203f22:	00004517          	auipc	a0,0x4
ffffffffc0203f26:	fbe50513          	addi	a0,a0,-66 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203f2a:	aecfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==4);
ffffffffc0203f2e:	00004697          	auipc	a3,0x4
ffffffffc0203f32:	daa68693          	addi	a3,a3,-598 # ffffffffc0207cd8 <commands+0x1500>
ffffffffc0203f36:	00003617          	auipc	a2,0x3
ffffffffc0203f3a:	d8260613          	addi	a2,a2,-638 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203f3e:	05700593          	li	a1,87
ffffffffc0203f42:	00004517          	auipc	a0,0x4
ffffffffc0203f46:	f9e50513          	addi	a0,a0,-98 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203f4a:	accfc0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgfault_num==4);
ffffffffc0203f4e:	00004697          	auipc	a3,0x4
ffffffffc0203f52:	d8a68693          	addi	a3,a3,-630 # ffffffffc0207cd8 <commands+0x1500>
ffffffffc0203f56:	00003617          	auipc	a2,0x3
ffffffffc0203f5a:	d6260613          	addi	a2,a2,-670 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203f5e:	05400593          	li	a1,84
ffffffffc0203f62:	00004517          	auipc	a0,0x4
ffffffffc0203f66:	f7e50513          	addi	a0,a0,-130 # ffffffffc0207ee0 <commands+0x1708>
...
ffffffffc0203f94:	0c068693          	addi	a3,a3,192 # ffffffffc0208050 <commands+0x1878>
ffffffffc0203f98:	00003617          	auipc	a2,0x3
ffffffffc0203f9c:	d2060613          	addi	a2,a2,-736 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203fa0:	04100593          	li	a1,65
ffffffffc0203fa4:	00004517          	auipc	a0,0x4
ffffffffc0203fa8:	f3c50513          	addi	a0,a0,-196 # ffffffffc0207ee0 <commands+0x1708>
ffffffffc0203fac:	a6afc0ef          	jal	ra,ffffffffc0200216 <__panic>
     assert(in_tick==0);
ffffffffc0203fb0:	00004697          	auipc	a3,0x4
ffffffffc0203fb4:	0b068693          	addi	a3,a3,176 # ffffffffc0208060 <commands+0x1888>
ffffffffc0203fb8:	00003617          	auipc	a2,0x3
ffffffffc0203fbc:	d0060613          	addi	a2,a2,-768 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203fc0:	04200593          	li	a1,66
ffffffffc0203fc4:	00004517          	auipc	a0,0x4
ffffffffc0203fc8:	f1c50513          	addi	a0,a0,-228 # ffffffffc0207ee0 <commands+0x1708>
...
ffffffffc0203fee:	04668693          	addi	a3,a3,70 # ffffffffc0208030 <commands+0x1858>
ffffffffc0203ff2:	00003617          	auipc	a2,0x3
ffffffffc0203ff6:	cc660613          	addi	a2,a2,-826 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0203ffa:	03200593          	li	a1,50
ffffffffc0203ffe:	00004517          	auipc	a0,0x4
ffffffffc0204002:	ee250513          	addi	a0,a0,-286 # ffffffffc0207ee0 <commands+0x1708>
{
...
ffffffffc02040d6:	cce70713          	addi	a4,a4,-818 # ffffffffc0208da0 <nbase>
...
ffffffffc020435e:	7de68693          	addi	a3,a3,2014 # ffffffffc0207b38 <commands+0x1360>
ffffffffc0204362:	00003617          	auipc	a2,0x3
ffffffffc0204366:	95660613          	addi	a2,a2,-1706 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020436a:	0f000593          	li	a1,240
ffffffffc020436e:	00004517          	auipc	a0,0x4
ffffffffc0204372:	d1a50513          	addi	a0,a0,-742 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204376:	ea1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc020437a:	00004697          	auipc	a3,0x4
ffffffffc020437e:	d8668693          	addi	a3,a3,-634 # ffffffffc0208100 <commands+0x1928>
ffffffffc0204382:	00003617          	auipc	a2,0x3
ffffffffc0204386:	93660613          	addi	a2,a2,-1738 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020438a:	0bd00593          	li	a1,189
ffffffffc020438e:	00004517          	auipc	a0,0x4
ffffffffc0204392:	cfa50513          	addi	a0,a0,-774 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204396:	e81fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc020439a:	00004697          	auipc	a3,0x4
ffffffffc020439e:	d8e68693          	addi	a3,a3,-626 # ffffffffc0208128 <commands+0x1950>
ffffffffc02043a2:	00003617          	auipc	a2,0x3
ffffffffc02043a6:	91660613          	addi	a2,a2,-1770 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02043aa:	0be00593          	li	a1,190
ffffffffc02043ae:	00004517          	auipc	a0,0x4
ffffffffc02043b2:	cda50513          	addi	a0,a0,-806 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02043b6:	e61fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc02043ba:	00004697          	auipc	a3,0x4
ffffffffc02043be:	dae68693          	addi	a3,a3,-594 # ffffffffc0208168 <commands+0x1990>
ffffffffc02043c2:	00003617          	auipc	a2,0x3
ffffffffc02043c6:	8f660613          	addi	a2,a2,-1802 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02043ca:	0c000593          	li	a1,192
ffffffffc02043ce:	00004517          	auipc	a0,0x4
ffffffffc02043d2:	cba50513          	addi	a0,a0,-838 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02043d6:	e41fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(!list_empty(&free_list));
ffffffffc02043da:	00004697          	auipc	a3,0x4
ffffffffc02043de:	e1668693          	addi	a3,a3,-490 # ffffffffc02081f0 <commands+0x1a18>
ffffffffc02043e2:	00003617          	auipc	a2,0x3
ffffffffc02043e6:	8d660613          	addi	a2,a2,-1834 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02043ea:	0d900593          	li	a1,217
ffffffffc02043ee:	00004517          	auipc	a0,0x4
ffffffffc02043f2:	c9a50513          	addi	a0,a0,-870 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02043f6:	e21fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02043fa:	00004697          	auipc	a3,0x4
ffffffffc02043fe:	ca668693          	addi	a3,a3,-858 # ffffffffc02080a0 <commands+0x18c8>
ffffffffc0204402:	00003617          	auipc	a2,0x3
ffffffffc0204406:	8b660613          	addi	a2,a2,-1866 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020440a:	0d200593          	li	a1,210
ffffffffc020440e:	00004517          	auipc	a0,0x4
ffffffffc0204412:	c7a50513          	addi	a0,a0,-902 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204416:	e01fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(nr_free == 3);
ffffffffc020441a:	00004697          	auipc	a3,0x4
ffffffffc020441e:	dc668693          	addi	a3,a3,-570 # ffffffffc02081e0 <commands+0x1a08>
ffffffffc0204422:	00003617          	auipc	a2,0x3
ffffffffc0204426:	89660613          	addi	a2,a2,-1898 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020442a:	0d000593          	li	a1,208
ffffffffc020442e:	00004517          	auipc	a0,0x4
ffffffffc0204432:	c5a50513          	addi	a0,a0,-934 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204436:	de1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020443a:	00004697          	auipc	a3,0x4
ffffffffc020443e:	d8e68693          	addi	a3,a3,-626 # ffffffffc02081c8 <commands+0x19f0>
ffffffffc0204442:	00003617          	auipc	a2,0x3
ffffffffc0204446:	87660613          	addi	a2,a2,-1930 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020444a:	0cb00593          	li	a1,203
ffffffffc020444e:	00004517          	auipc	a0,0x4
ffffffffc0204452:	c3a50513          	addi	a0,a0,-966 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204456:	dc1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc020445a:	00004697          	auipc	a3,0x4
ffffffffc020445e:	d4e68693          	addi	a3,a3,-690 # ffffffffc02081a8 <commands+0x19d0>
ffffffffc0204462:	00003617          	auipc	a2,0x3
ffffffffc0204466:	85660613          	addi	a2,a2,-1962 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020446a:	0c200593          	li	a1,194
ffffffffc020446e:	00004517          	auipc	a0,0x4
ffffffffc0204472:	c1a50513          	addi	a0,a0,-998 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204476:	da1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(p0 != NULL);
ffffffffc020447a:	00004697          	auipc	a3,0x4
ffffffffc020447e:	dae68693          	addi	a3,a3,-594 # ffffffffc0208228 <commands+0x1a50>
ffffffffc0204482:	00003617          	auipc	a2,0x3
ffffffffc0204486:	83660613          	addi	a2,a2,-1994 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020448a:	0f800593          	li	a1,248
ffffffffc020448e:	00004517          	auipc	a0,0x4
ffffffffc0204492:	bfa50513          	addi	a0,a0,-1030 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204496:	d81fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(nr_free == 0);
ffffffffc020449a:	00004697          	auipc	a3,0x4
ffffffffc020449e:	84e68693          	addi	a3,a3,-1970 # ffffffffc0207ce8 <commands+0x1510>
ffffffffc02044a2:	00003617          	auipc	a2,0x3
ffffffffc02044a6:	81660613          	addi	a2,a2,-2026 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02044aa:	0df00593          	li	a1,223
ffffffffc02044ae:	00004517          	auipc	a0,0x4
ffffffffc02044b2:	bda50513          	addi	a0,a0,-1062 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02044b6:	d61fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02044ba:	00004697          	auipc	a3,0x4
ffffffffc02044be:	d0e68693          	addi	a3,a3,-754 # ffffffffc02081c8 <commands+0x19f0>
ffffffffc02044c2:	00002617          	auipc	a2,0x2
ffffffffc02044c6:	7f660613          	addi	a2,a2,2038 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02044ca:	0dd00593          	li	a1,221
ffffffffc02044ce:	00004517          	auipc	a0,0x4
ffffffffc02044d2:	bba50513          	addi	a0,a0,-1094 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02044d6:	d41fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc02044da:	00004697          	auipc	a3,0x4
ffffffffc02044de:	d2e68693          	addi	a3,a3,-722 # ffffffffc0208208 <commands+0x1a30>
ffffffffc02044e2:	00002617          	auipc	a2,0x2
ffffffffc02044e6:	7d660613          	addi	a2,a2,2006 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02044ea:	0dc00593          	li	a1,220
ffffffffc02044ee:	00004517          	auipc	a0,0x4
ffffffffc02044f2:	b9a50513          	addi	a0,a0,-1126 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02044f6:	d21fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02044fa:	00004697          	auipc	a3,0x4
ffffffffc02044fe:	ba668693          	addi	a3,a3,-1114 # ffffffffc02080a0 <commands+0x18c8>
ffffffffc0204502:	00002617          	auipc	a2,0x2
ffffffffc0204506:	7b660613          	addi	a2,a2,1974 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020450a:	0b900593          	li	a1,185
ffffffffc020450e:	00004517          	auipc	a0,0x4
ffffffffc0204512:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204516:	d01fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020451a:	00004697          	auipc	a3,0x4
ffffffffc020451e:	cae68693          	addi	a3,a3,-850 # ffffffffc02081c8 <commands+0x19f0>
ffffffffc0204522:	00002617          	auipc	a2,0x2
ffffffffc0204526:	79660613          	addi	a2,a2,1942 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020452a:	0d600593          	li	a1,214
ffffffffc020452e:	00004517          	auipc	a0,0x4
ffffffffc0204532:	b5a50513          	addi	a0,a0,-1190 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204536:	ce1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc020453a:	00004697          	auipc	a3,0x4
ffffffffc020453e:	ba668693          	addi	a3,a3,-1114 # ffffffffc02080e0 <commands+0x1908>
ffffffffc0204542:	00002617          	auipc	a2,0x2
ffffffffc0204546:	77660613          	addi	a2,a2,1910 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020454a:	0d400593          	li	a1,212
ffffffffc020454e:	00004517          	auipc	a0,0x4
ffffffffc0204552:	b3a50513          	addi	a0,a0,-1222 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204556:	cc1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc020455a:	00004697          	auipc	a3,0x4
ffffffffc020455e:	b6668693          	addi	a3,a3,-1178 # ffffffffc02080c0 <commands+0x18e8>
ffffffffc0204562:	00002617          	auipc	a2,0x2
ffffffffc0204566:	75660613          	addi	a2,a2,1878 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020456a:	0d300593          	li	a1,211
ffffffffc020456e:	00004517          	auipc	a0,0x4
ffffffffc0204572:	b1a50513          	addi	a0,a0,-1254 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204576:	ca1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc020457a:	00004697          	auipc	a3,0x4
ffffffffc020457e:	b6668693          	addi	a3,a3,-1178 # ffffffffc02080e0 <commands+0x1908>
ffffffffc0204582:	00002617          	auipc	a2,0x2
ffffffffc0204586:	73660613          	addi	a2,a2,1846 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020458a:	0bb00593          	li	a1,187
ffffffffc020458e:	00004517          	auipc	a0,0x4
ffffffffc0204592:	afa50513          	addi	a0,a0,-1286 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204596:	c81fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(count == 0);
ffffffffc020459a:	00004697          	auipc	a3,0x4
ffffffffc020459e:	dde68693          	addi	a3,a3,-546 # ffffffffc0208378 <commands+0x1ba0>
ffffffffc02045a2:	00002617          	auipc	a2,0x2
ffffffffc02045a6:	71660613          	addi	a2,a2,1814 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02045aa:	12500593          	li	a1,293
ffffffffc02045ae:	00004517          	auipc	a0,0x4
ffffffffc02045b2:	ada50513          	addi	a0,a0,-1318 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02045b6:	c61fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(nr_free == 0);
ffffffffc02045ba:	00003697          	auipc	a3,0x3
ffffffffc02045be:	72e68693          	addi	a3,a3,1838 # ffffffffc0207ce8 <commands+0x1510>
ffffffffc02045c2:	00002617          	auipc	a2,0x2
ffffffffc02045c6:	6f660613          	addi	a2,a2,1782 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02045ca:	11a00593          	li	a1,282
ffffffffc02045ce:	00004517          	auipc	a0,0x4
ffffffffc02045d2:	aba50513          	addi	a0,a0,-1350 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02045d6:	c41fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02045da:	00004697          	auipc	a3,0x4
ffffffffc02045de:	bee68693          	addi	a3,a3,-1042 # ffffffffc02081c8 <commands+0x19f0>
ffffffffc02045e2:	00002617          	auipc	a2,0x2
ffffffffc02045e6:	6d660613          	addi	a2,a2,1750 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02045ea:	11800593          	li	a1,280
ffffffffc02045ee:	00004517          	auipc	a0,0x4
ffffffffc02045f2:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02045f6:	c21fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc02045fa:	00004697          	auipc	a3,0x4
ffffffffc02045fe:	b8e68693          	addi	a3,a3,-1138 # ffffffffc0208188 <commands+0x19b0>
ffffffffc0204602:	00002617          	auipc	a2,0x2
ffffffffc0204606:	6b660613          	addi	a2,a2,1718 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020460a:	0c100593          	li	a1,193
ffffffffc020460e:	00004517          	auipc	a0,0x4
ffffffffc0204612:	a7a50513          	addi	a0,a0,-1414 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204616:	c01fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc020461a:	00004697          	auipc	a3,0x4
ffffffffc020461e:	d1e68693          	addi	a3,a3,-738 # ffffffffc0208338 <commands+0x1b60>
ffffffffc0204622:	00002617          	auipc	a2,0x2
ffffffffc0204626:	69660613          	addi	a2,a2,1686 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020462a:	11200593          	li	a1,274
ffffffffc020462e:	00004517          	auipc	a0,0x4
ffffffffc0204632:	a5a50513          	addi	a0,a0,-1446 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204636:	be1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc020463a:	00004697          	auipc	a3,0x4
ffffffffc020463e:	cde68693          	addi	a3,a3,-802 # ffffffffc0208318 <commands+0x1b40>
ffffffffc0204642:	00002617          	auipc	a2,0x2
ffffffffc0204646:	67660613          	addi	a2,a2,1654 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020464a:	11000593          	li	a1,272
ffffffffc020464e:	00004517          	auipc	a0,0x4
ffffffffc0204652:	a3a50513          	addi	a0,a0,-1478 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204656:	bc1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc020465a:	00004697          	auipc	a3,0x4
ffffffffc020465e:	c9668693          	addi	a3,a3,-874 # ffffffffc02082f0 <commands+0x1b18>
ffffffffc0204662:	00002617          	auipc	a2,0x2
ffffffffc0204666:	65660613          	addi	a2,a2,1622 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020466a:	10e00593          	li	a1,270
ffffffffc020466e:	00004517          	auipc	a0,0x4
ffffffffc0204672:	a1a50513          	addi	a0,a0,-1510 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204676:	ba1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc020467a:	00004697          	auipc	a3,0x4
ffffffffc020467e:	c4e68693          	addi	a3,a3,-946 # ffffffffc02082c8 <commands+0x1af0>
ffffffffc0204682:	00002617          	auipc	a2,0x2
ffffffffc0204686:	63660613          	addi	a2,a2,1590 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020468a:	10d00593          	li	a1,269
ffffffffc020468e:	00004517          	auipc	a0,0x4
ffffffffc0204692:	9fa50513          	addi	a0,a0,-1542 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204696:	b81fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(p0 + 2 == p1);
ffffffffc020469a:	00004697          	auipc	a3,0x4
ffffffffc020469e:	c1e68693          	addi	a3,a3,-994 # ffffffffc02082b8 <commands+0x1ae0>
ffffffffc02046a2:	00002617          	auipc	a2,0x2
ffffffffc02046a6:	61660613          	addi	a2,a2,1558 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02046aa:	10800593          	li	a1,264
ffffffffc02046ae:	00004517          	auipc	a0,0x4
ffffffffc02046b2:	9da50513          	addi	a0,a0,-1574 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02046b6:	b61fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02046ba:	00004697          	auipc	a3,0x4
ffffffffc02046be:	b0e68693          	addi	a3,a3,-1266 # ffffffffc02081c8 <commands+0x19f0>
ffffffffc02046c2:	00002617          	auipc	a2,0x2
ffffffffc02046c6:	5f660613          	addi	a2,a2,1526 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02046ca:	10700593          	li	a1,263
ffffffffc02046ce:	00004517          	auipc	a0,0x4
ffffffffc02046d2:	9ba50513          	addi	a0,a0,-1606 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02046d6:	b41fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02046da:	00004697          	auipc	a3,0x4
ffffffffc02046de:	bbe68693          	addi	a3,a3,-1090 # ffffffffc0208298 <commands+0x1ac0>
ffffffffc02046e2:	00002617          	auipc	a2,0x2
ffffffffc02046e6:	5d660613          	addi	a2,a2,1494 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02046ea:	10600593          	li	a1,262
ffffffffc02046ee:	00004517          	auipc	a0,0x4
ffffffffc02046f2:	99a50513          	addi	a0,a0,-1638 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02046f6:	b21fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc02046fa:	00004697          	auipc	a3,0x4
ffffffffc02046fe:	b6e68693          	addi	a3,a3,-1170 # ffffffffc0208268 <commands+0x1a90>
ffffffffc0204702:	00002617          	auipc	a2,0x2
ffffffffc0204706:	5b660613          	addi	a2,a2,1462 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020470a:	10500593          	li	a1,261
ffffffffc020470e:	00004517          	auipc	a0,0x4
ffffffffc0204712:	97a50513          	addi	a0,a0,-1670 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204716:	b01fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc020471a:	00004697          	auipc	a3,0x4
ffffffffc020471e:	b3668693          	addi	a3,a3,-1226 # ffffffffc0208250 <commands+0x1a78>
ffffffffc0204722:	00002617          	auipc	a2,0x2
ffffffffc0204726:	59660613          	addi	a2,a2,1430 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020472a:	10400593          	li	a1,260
ffffffffc020472e:	00004517          	auipc	a0,0x4
ffffffffc0204732:	95a50513          	addi	a0,a0,-1702 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204736:	ae1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020473a:	00004697          	auipc	a3,0x4
ffffffffc020473e:	a8e68693          	addi	a3,a3,-1394 # ffffffffc02081c8 <commands+0x19f0>
ffffffffc0204742:	00002617          	auipc	a2,0x2
ffffffffc0204746:	57660613          	addi	a2,a2,1398 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020474a:	0fe00593          	li	a1,254
ffffffffc020474e:	00004517          	auipc	a0,0x4
ffffffffc0204752:	93a50513          	addi	a0,a0,-1734 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204756:	ac1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(!PageProperty(p0));
ffffffffc020475a:	00004697          	auipc	a3,0x4
ffffffffc020475e:	ade68693          	addi	a3,a3,-1314 # ffffffffc0208238 <commands+0x1a60>
ffffffffc0204762:	00002617          	auipc	a2,0x2
ffffffffc0204766:	55660613          	addi	a2,a2,1366 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020476a:	0f900593          	li	a1,249
ffffffffc020476e:	00004517          	auipc	a0,0x4
ffffffffc0204772:	91a50513          	addi	a0,a0,-1766 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204776:	aa1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc020477a:	00004697          	auipc	a3,0x4
ffffffffc020477e:	bde68693          	addi	a3,a3,-1058 # ffffffffc0208358 <commands+0x1b80>
ffffffffc0204782:	00002617          	auipc	a2,0x2
ffffffffc0204786:	53660613          	addi	a2,a2,1334 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020478a:	11700593          	li	a1,279
ffffffffc020478e:	00004517          	auipc	a0,0x4
ffffffffc0204792:	8fa50513          	addi	a0,a0,-1798 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204796:	a81fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(total == 0);
ffffffffc020479a:	00004697          	auipc	a3,0x4
ffffffffc020479e:	bee68693          	addi	a3,a3,-1042 # ffffffffc0208388 <commands+0x1bb0>
ffffffffc02047a2:	00002617          	auipc	a2,0x2
ffffffffc02047a6:	51660613          	addi	a2,a2,1302 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02047aa:	12600593          	li	a1,294
ffffffffc02047ae:	00004517          	auipc	a0,0x4
ffffffffc02047b2:	8da50513          	addi	a0,a0,-1830 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02047b6:	a61fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(total == nr_free_pages());
ffffffffc02047ba:	00003697          	auipc	a3,0x3
ffffffffc02047be:	38e68693          	addi	a3,a3,910 # ffffffffc0207b48 <commands+0x1370>
ffffffffc02047c2:	00002617          	auipc	a2,0x2
ffffffffc02047c6:	4f660613          	addi	a2,a2,1270 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02047ca:	0f300593          	li	a1,243
ffffffffc02047ce:	00004517          	auipc	a0,0x4
ffffffffc02047d2:	8ba50513          	addi	a0,a0,-1862 # ffffffffc0208088 <commands+0x18b0>
ffffffffc02047d6:	a41fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02047da:	00004697          	auipc	a3,0x4
ffffffffc02047de:	8e668693          	addi	a3,a3,-1818 # ffffffffc02080c0 <commands+0x18e8>
ffffffffc02047e2:	00002617          	auipc	a2,0x2
ffffffffc02047e6:	4d660613          	addi	a2,a2,1238 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02047ea:	0ba00593          	li	a1,186
ffffffffc02047ee:	00004517          	auipc	a0,0x4
ffffffffc02047f2:	89a50513          	addi	a0,a0,-1894 # ffffffffc0208088 <commands+0x18b0>
...
ffffffffc020495e:	a3e68693          	addi	a3,a3,-1474 # ffffffffc0208398 <commands+0x1bc0>
ffffffffc0204962:	00002617          	auipc	a2,0x2
ffffffffc0204966:	35660613          	addi	a2,a2,854 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020496a:	08300593          	li	a1,131
ffffffffc020496e:	00003517          	auipc	a0,0x3
ffffffffc0204972:	71a50513          	addi	a0,a0,1818 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204976:	8a1fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(n > 0);
ffffffffc020497a:	00004697          	auipc	a3,0x4
ffffffffc020497e:	a4668693          	addi	a3,a3,-1466 # ffffffffc02083c0 <commands+0x1be8>
ffffffffc0204982:	00002617          	auipc	a2,0x2
ffffffffc0204986:	33660613          	addi	a2,a2,822 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020498a:	08000593          	li	a1,128
ffffffffc020498e:	00003517          	auipc	a0,0x3
ffffffffc0204992:	6fa50513          	addi	a0,a0,1786 # ffffffffc0208088 <commands+0x18b0>
...
ffffffffc0204a36:	98e68693          	addi	a3,a3,-1650 # ffffffffc02083c0 <commands+0x1be8>
ffffffffc0204a3a:	00002617          	auipc	a2,0x2
ffffffffc0204a3e:	27e60613          	addi	a2,a2,638 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0204a42:	06200593          	li	a1,98
ffffffffc0204a46:	00003517          	auipc	a0,0x3
ffffffffc0204a4a:	64250513          	addi	a0,a0,1602 # ffffffffc0208088 <commands+0x18b0>
default_alloc_pages(size_t n) {
...
ffffffffc0204b1e:	8ae68693          	addi	a3,a3,-1874 # ffffffffc02083c8 <commands+0x1bf0>
ffffffffc0204b22:	00002617          	auipc	a2,0x2
ffffffffc0204b26:	19660613          	addi	a2,a2,406 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0204b2a:	04900593          	li	a1,73
ffffffffc0204b2e:	00003517          	auipc	a0,0x3
ffffffffc0204b32:	55a50513          	addi	a0,a0,1370 # ffffffffc0208088 <commands+0x18b0>
ffffffffc0204b36:	ee0fb0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(n > 0);
ffffffffc0204b3a:	00004697          	auipc	a3,0x4
ffffffffc0204b3e:	88668693          	addi	a3,a3,-1914 # ffffffffc02083c0 <commands+0x1be8>
ffffffffc0204b42:	00002617          	auipc	a2,0x2
ffffffffc0204b46:	17660613          	addi	a2,a2,374 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0204b4a:	04600593          	li	a1,70
ffffffffc0204b4e:	00003517          	auipc	a0,0x3
ffffffffc0204b52:	53a50513          	addi	a0,a0,1338 # ffffffffc0208088 <commands+0x18b0>
...
ffffffffc0204b80:	8ac60613          	addi	a2,a2,-1876 # ffffffffc0208428 <default_pmm_manager+0x50>
ffffffffc0204b84:	45b5                	li	a1,13
ffffffffc0204b86:	00004517          	auipc	a0,0x4
ffffffffc0204b8a:	8c250513          	addi	a0,a0,-1854 # ffffffffc0208448 <default_pmm_manager+0x70>
...
ffffffffc0204bb8:	1ec70713          	addi	a4,a4,492 # ffffffffc0208da0 <nbase>
    return KADDR(page2pa(page));
...
ffffffffc0204bfe:	86660613          	addi	a2,a2,-1946 # ffffffffc0208460 <default_pmm_manager+0x88>
ffffffffc0204c02:	45d1                	li	a1,20
ffffffffc0204c04:	00004517          	auipc	a0,0x4
ffffffffc0204c08:	84450513          	addi	a0,a0,-1980 # ffffffffc0208448 <default_pmm_manager+0x70>
...
ffffffffc0204c1a:	48a60613          	addi	a2,a2,1162 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0204c1e:	00002517          	auipc	a0,0x2
ffffffffc0204c22:	4da50513          	addi	a0,a0,1242 # ffffffffc02070f8 <commands+0x920>
...
ffffffffc0204c50:	15470713          	addi	a4,a4,340 # ffffffffc0208da0 <nbase>
    return KADDR(page2pa(page));
...
ffffffffc0204c96:	7ce60613          	addi	a2,a2,1998 # ffffffffc0208460 <default_pmm_manager+0x88>
ffffffffc0204c9a:	45e5                	li	a1,25
ffffffffc0204c9c:	00003517          	auipc	a0,0x3
ffffffffc0204ca0:	7ac50513          	addi	a0,a0,1964 # ffffffffc0208448 <default_pmm_manager+0x70>
...
ffffffffc0204cb2:	3f260613          	addi	a2,a2,1010 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0204cb6:	00002517          	auipc	a0,0x2
ffffffffc0204cba:	44250513          	addi	a0,a0,1090 # ffffffffc02070f8 <commands+0x920>
...
ffffffffc0204cc4:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cc6:	7b6000ef          	jal	ra,ffffffffc020547c <do_exit>
...
ffffffffc0204d6a:	4be010ef          	jal	ra,ffffffffc0206228 <memset>
    proc->tf = NULL;
    proc->cr3 = boot_cr3;
...
ffffffffc0204d8a:	49e010ef          	jal	ra,ffffffffc0206228 <memset>
    proc->wait_state = 0;
...
ffffffffc0204dc8:	aac60613          	addi	a2,a2,-1364 # ffffffffc0208870 <default_pmm_manager+0x498>
ffffffffc0204dcc:	43cc                	lw	a1,4(a5)
ffffffffc0204dce:	00004517          	auipc	a0,0x4
ffffffffc0204dd2:	ab250513          	addi	a0,a0,-1358 # ffffffffc0208880 <default_pmm_manager+0x4a8>
user_main(void *arg) {
...
ffffffffc0204de0:	a9478793          	addi	a5,a5,-1388 # ffffffffc0208870 <default_pmm_manager+0x498>
...
ffffffffc0204dfe:	38c010ef          	jal	ra,ffffffffc020618a <strlen>
...
ffffffffc0204e1a:	a9250513          	addi	a0,a0,-1390 # ffffffffc02088a8 <default_pmm_manager+0x4d0>
...
ffffffffc0204e26:	a9660613          	addi	a2,a2,-1386 # ffffffffc02088b8 <default_pmm_manager+0x4e0>
ffffffffc0204e2a:	34c00593          	li	a1,844
ffffffffc0204e2e:	00004517          	auipc	a0,0x4
ffffffffc0204e32:	aaa50513          	addi	a0,a0,-1366 # ffffffffc02088d8 <default_pmm_manager+0x500>
...
ffffffffc0204e68:	f3c78793          	addi	a5,a5,-196 # ffffffffc0208da0 <nbase>
...
ffffffffc0204e8c:	2f060613          	addi	a2,a2,752 # ffffffffc0207178 <commands+0x9a0>
ffffffffc0204e90:	06e00593          	li	a1,110
ffffffffc0204e94:	00002517          	auipc	a0,0x2
ffffffffc0204e98:	26450513          	addi	a0,a0,612 # ffffffffc02070f8 <commands+0x920>
ffffffffc0204e9c:	b7afb0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204ea0:	00002617          	auipc	a2,0x2
ffffffffc0204ea4:	23860613          	addi	a2,a2,568 # ffffffffc02070d8 <commands+0x900>
ffffffffc0204ea8:	06200593          	li	a1,98
ffffffffc0204eac:	00002517          	auipc	a0,0x2
ffffffffc0204eb0:	24c50513          	addi	a0,a0,588 # ffffffffc02070f8 <commands+0x920>
...
ffffffffc0204ed8:	ecc78793          	addi	a5,a5,-308 # ffffffffc0208da0 <nbase>
...
ffffffffc0204f16:	324010ef          	jal	ra,ffffffffc020623a <memcpy>
    return 0;
...
ffffffffc0204f30:	17460613          	addi	a2,a2,372 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0204f34:	06900593          	li	a1,105
ffffffffc0204f38:	00002517          	auipc	a0,0x2
ffffffffc0204f3c:	1c050513          	addi	a0,a0,448 # ffffffffc02070f8 <commands+0x920>
...
ffffffffc0204f56:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204f58:	2d0010ef          	jal	ra,ffffffffc0206228 <memset>
...
ffffffffc0204f68:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204f6a:	2d00106f          	j	ffffffffc020623a <memcpy>
...
ffffffffc0204ff4:	e406                	sd	ra,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204ff6:	654010ef          	jal	ra,ffffffffc020664a <hash32>
...
ffffffffc020503a:	000a7997          	auipc	s3,0xa7
ffffffffc020503e:	40698993          	addi	s3,s3,1030 # ffffffffc02ac440 <nr_process>
ffffffffc0205042:	0009a703          	lw	a4,0(s3)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0205046:	e486                	sd	ra,72(sp)
ffffffffc0205048:	e0a2                	sd	s0,64(sp)
ffffffffc020504a:	fc26                	sd	s1,56(sp)
ffffffffc020504c:	f84a                	sd	s2,48(sp)
...
ffffffffc020505a:	32f75a63          	ble	a5,a4,ffffffffc020538e <do_fork+0x358>
ffffffffc020505e:	8aaa                	mv	s5,a0
ffffffffc0205060:	892e                	mv	s2,a1
ffffffffc0205062:	84b2                	mv	s1,a2
    proc = alloc_proc();
ffffffffc0205064:	cd1ff0ef          	jal	ra,ffffffffc0204d34 <alloc_proc>
ffffffffc0205068:	842a                	mv	s0,a0
    if(proc==NULL){
ffffffffc020506a:	2a050f63          	beqz	a0,ffffffffc0205328 <do_fork+0x2f2>
    proc->parent = current;
...
ffffffffc020507e:	f11c                	sd	a5,32(a0)
    assert(current->wait_state == 0);
ffffffffc0205080:	30071963          	bnez	a4,ffffffffc0205392 <do_fork+0x35c>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0205084:	4509                	li	a0,2
ffffffffc0205086:	e25fb0ef          	jal	ra,ffffffffc0200eaa <alloc_pages>
    if (page != NULL) {
ffffffffc020508a:	2a050d63          	beqz	a0,ffffffffc0205344 <do_fork+0x30e>
    return page - pages + nbase;
...
ffffffffc020509c:	d0878793          	addi	a5,a5,-760 # ffffffffc0208da0 <nbase>
    return KADDR(page2pa(page));
...
ffffffffc02050ba:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02050bc:	2ee7fb63          	bleu	a4,a5,ffffffffc02053b2 <do_fork+0x37c>
...
ffffffffc02050e0:	1e0a8663          	beqz	s5,ffffffffc02052cc <do_fork+0x296>
}
...
ffffffffc02050f6:	03443423          	sd	s4,40(s0)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc02050fa:	2cd7e863          	bltu	a5,a3,ffffffffc02053ca <do_fork+0x394>
...
ffffffffc020510e:	97b6                	add	a5,a5,a3
    *(proc->tf) = *tf;
ffffffffc0205110:	8626                	mv	a2,s1
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0205112:	f05c                	sd	a5,160(s0)
    *(proc->tf) = *tf;
ffffffffc0205114:	873e                	mv	a4,a5
ffffffffc0205116:	12048313          	addi	t1,s1,288
ffffffffc020511a:	00063883          	ld	a7,0(a2)
ffffffffc020511e:	00863803          	ld	a6,8(a2)
ffffffffc0205122:	6a08                	ld	a0,16(a2)
ffffffffc0205124:	6e0c                	ld	a1,24(a2)
ffffffffc0205126:	01173023          	sd	a7,0(a4)
ffffffffc020512a:	01073423          	sd	a6,8(a4)
ffffffffc020512e:	eb08                	sd	a0,16(a4)
ffffffffc0205130:	ef0c                	sd	a1,24(a4)
ffffffffc0205132:	02060613          	addi	a2,a2,32
ffffffffc0205136:	02070713          	addi	a4,a4,32
ffffffffc020513a:	fe6610e3          	bne	a2,t1,ffffffffc020511a <do_fork+0xe4>
    proc->tf->gpr.a0 = 0;
ffffffffc020513e:	0407b823          	sd	zero,80(a5)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf - 4 : esp;
ffffffffc0205142:	12090b63          	beqz	s2,ffffffffc0205278 <do_fork+0x242>
ffffffffc0205146:	0127b823          	sd	s2,16(a5)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020514a:	00000717          	auipc	a4,0x0
ffffffffc020514e:	c5e70713          	addi	a4,a4,-930 # ffffffffc0204da8 <forkret>
ffffffffc0205152:	f818                	sd	a4,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205154:	fc1c                	sd	a5,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc020515c:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020515e:	12079f63          	bnez	a5,ffffffffc020529c <do_fork+0x266>
    if (++ last_pid >= MAX_PID) {
ffffffffc0205162:	0009c797          	auipc	a5,0x9c
ffffffffc0205166:	e7e78793          	addi	a5,a5,-386 # ffffffffc02a0fe0 <last_pid.1691>
ffffffffc020516a:	439c                	lw	a5,0(a5)
ffffffffc020516c:	6709                	lui	a4,0x2
ffffffffc020516e:	0017851b          	addiw	a0,a5,1
ffffffffc0205172:	0009c697          	auipc	a3,0x9c
ffffffffc0205176:	e6a6a723          	sw	a0,-402(a3) # ffffffffc02a0fe0 <last_pid.1691>
ffffffffc020517a:	14e55263          	ble	a4,a0,ffffffffc02052be <do_fork+0x288>
    if (last_pid >= next_safe) {
ffffffffc020517e:	0009c797          	auipc	a5,0x9c
ffffffffc0205182:	e6678793          	addi	a5,a5,-410 # ffffffffc02a0fe4 <next_safe.1690>
ffffffffc0205186:	439c                	lw	a5,0(a5)
ffffffffc0205188:	000a7497          	auipc	s1,0xa7
ffffffffc020518c:	3e048493          	addi	s1,s1,992 # ffffffffc02ac568 <proc_list>
ffffffffc0205190:	06f54063          	blt	a0,a5,ffffffffc02051f0 <do_fork+0x1ba>
        next_safe = MAX_PID;
ffffffffc0205194:	6789                	lui	a5,0x2
ffffffffc0205196:	0009c717          	auipc	a4,0x9c
ffffffffc020519a:	e4f72723          	sw	a5,-434(a4) # ffffffffc02a0fe4 <next_safe.1690>
ffffffffc020519e:	4581                	li	a1,0
ffffffffc02051a0:	87aa                	mv	a5,a0
ffffffffc02051a2:	000a7497          	auipc	s1,0xa7
ffffffffc02051a6:	3c648493          	addi	s1,s1,966 # ffffffffc02ac568 <proc_list>
    repeat:
ffffffffc02051aa:	6889                	lui	a7,0x2
ffffffffc02051ac:	882e                	mv	a6,a1
ffffffffc02051ae:	6609                	lui	a2,0x2
        le = list;
ffffffffc02051b0:	000a7697          	auipc	a3,0xa7
ffffffffc02051b4:	3b868693          	addi	a3,a3,952 # ffffffffc02ac568 <proc_list>
ffffffffc02051b8:	6694                	ld	a3,8(a3)
        while ((le = list_next(le)) != list) {
ffffffffc02051ba:	00968f63          	beq	a3,s1,ffffffffc02051d8 <do_fork+0x1a2>
            if (proc->pid == last_pid) {
ffffffffc02051be:	f3c6a703          	lw	a4,-196(a3)
ffffffffc02051c2:	0ae78663          	beq	a5,a4,ffffffffc020526e <do_fork+0x238>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02051c6:	fee7d9e3          	ble	a4,a5,ffffffffc02051b8 <do_fork+0x182>
ffffffffc02051ca:	fec757e3          	ble	a2,a4,ffffffffc02051b8 <do_fork+0x182>
ffffffffc02051ce:	6694                	ld	a3,8(a3)
ffffffffc02051d0:	863a                	mv	a2,a4
ffffffffc02051d2:	4805                	li	a6,1
        while ((le = list_next(le)) != list) {
ffffffffc02051d4:	fe9695e3          	bne	a3,s1,ffffffffc02051be <do_fork+0x188>
ffffffffc02051d8:	c591                	beqz	a1,ffffffffc02051e4 <do_fork+0x1ae>
ffffffffc02051da:	0009c717          	auipc	a4,0x9c
ffffffffc02051de:	e0f72323          	sw	a5,-506(a4) # ffffffffc02a0fe0 <last_pid.1691>
ffffffffc02051e2:	853e                	mv	a0,a5
ffffffffc02051e4:	00080663          	beqz	a6,ffffffffc02051f0 <do_fork+0x1ba>
ffffffffc02051e8:	0009c797          	auipc	a5,0x9c
ffffffffc02051ec:	dec7ae23          	sw	a2,-516(a5) # ffffffffc02a0fe4 <next_safe.1690>
        proc->pid = get_pid();
ffffffffc02051f0:	c048                	sw	a0,4(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02051f2:	45a9                	li	a1,10
ffffffffc02051f4:	2501                	sext.w	a0,a0
ffffffffc02051f6:	454010ef          	jal	ra,ffffffffc020664a <hash32>
ffffffffc02051fa:	1502                	slli	a0,a0,0x20
ffffffffc02051fc:	000a3797          	auipc	a5,0xa3
ffffffffc0205200:	1ec78793          	addi	a5,a5,492 # ffffffffc02a83e8 <hash_list>
ffffffffc0205204:	8171                	srli	a0,a0,0x1c
ffffffffc0205206:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0205208:	650c                	ld	a1,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020520a:	7014                	ld	a3,32(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020520c:	0d840793          	addi	a5,s0,216
    prev->next = next->prev = elm;
ffffffffc0205210:	e19c                	sd	a5,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0205212:	6490                	ld	a2,8(s1)
    prev->next = next->prev = elm;
ffffffffc0205214:	e51c                	sd	a5,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205216:	7af8                	ld	a4,240(a3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0205218:	0c840793          	addi	a5,s0,200
    elm->next = next;
ffffffffc020521c:	f06c                	sd	a1,224(s0)
    elm->prev = prev;
ffffffffc020521e:	ec68                	sd	a0,216(s0)
    prev->next = next->prev = elm;
ffffffffc0205220:	e21c                	sd	a5,0(a2)
ffffffffc0205222:	000a7597          	auipc	a1,0xa7
ffffffffc0205226:	34f5b723          	sd	a5,846(a1) # ffffffffc02ac570 <proc_list+0x8>
    elm->next = next;
ffffffffc020522a:	e870                	sd	a2,208(s0)
    elm->prev = prev;
ffffffffc020522c:	e464                	sd	s1,200(s0)
    proc->yptr = NULL;
ffffffffc020522e:	0e043c23          	sd	zero,248(s0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205232:	10e43023          	sd	a4,256(s0)
ffffffffc0205236:	c311                	beqz	a4,ffffffffc020523a <do_fork+0x204>
        proc->optr->yptr = proc;
ffffffffc0205238:	ff60                	sd	s0,248(a4)
    nr_process ++;
ffffffffc020523a:	0009a783          	lw	a5,0(s3)
    proc->parent->cptr = proc;
ffffffffc020523e:	fae0                	sd	s0,240(a3)
    nr_process ++;
ffffffffc0205240:	2785                	addiw	a5,a5,1
ffffffffc0205242:	000a7717          	auipc	a4,0xa7
ffffffffc0205246:	1ef72f23          	sw	a5,510(a4) # ffffffffc02ac440 <nr_process>
    if (flag) {
ffffffffc020524a:	0e091163          	bnez	s2,ffffffffc020532c <do_fork+0x2f6>
    wakeup_proc(proc);
ffffffffc020524e:	8522                	mv	a0,s0
ffffffffc0205250:	549000ef          	jal	ra,ffffffffc0205f98 <wakeup_proc>
    ret = proc->pid;
ffffffffc0205254:	4048                	lw	a0,4(s0)
}
ffffffffc0205256:	60a6                	ld	ra,72(sp)
ffffffffc0205258:	6406                	ld	s0,64(sp)
ffffffffc020525a:	74e2                	ld	s1,56(sp)
ffffffffc020525c:	7942                	ld	s2,48(sp)
ffffffffc020525e:	79a2                	ld	s3,40(sp)
ffffffffc0205260:	7a02                	ld	s4,32(sp)
ffffffffc0205262:	6ae2                	ld	s5,24(sp)
ffffffffc0205264:	6b42                	ld	s6,16(sp)
ffffffffc0205266:	6ba2                	ld	s7,8(sp)
ffffffffc0205268:	6c02                	ld	s8,0(sp)
ffffffffc020526a:	6161                	addi	sp,sp,80
ffffffffc020526c:	8082                	ret
                if (++ last_pid >= next_safe) {
ffffffffc020526e:	2785                	addiw	a5,a5,1
ffffffffc0205270:	0cc7d163          	ble	a2,a5,ffffffffc0205332 <do_fork+0x2fc>
ffffffffc0205274:	4585                	li	a1,1
ffffffffc0205276:	b789                	j	ffffffffc02051b8 <do_fork+0x182>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf - 4 : esp;
ffffffffc0205278:	6909                	lui	s2,0x2
ffffffffc020527a:	edc90913          	addi	s2,s2,-292 # 1edc <_binary_obj___user_faultread_out_size-0x7694>
ffffffffc020527e:	9936                	add	s2,s2,a3
ffffffffc0205280:	0127b823          	sd	s2,16(a5)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0205284:	00000717          	auipc	a4,0x0
ffffffffc0205288:	b2470713          	addi	a4,a4,-1244 # ffffffffc0204da8 <forkret>
ffffffffc020528c:	f818                	sd	a4,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020528e:	fc1c                	sd	a5,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205290:	100027f3          	csrr	a5,sstatus
ffffffffc0205294:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205296:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205298:	ec0785e3          	beqz	a5,ffffffffc0205162 <do_fork+0x12c>
        intr_disable();
ffffffffc020529c:	bc0fb0ef          	jal	ra,ffffffffc020065c <intr_disable>
    if (++ last_pid >= MAX_PID) {
ffffffffc02052a0:	0009c797          	auipc	a5,0x9c
ffffffffc02052a4:	d4078793          	addi	a5,a5,-704 # ffffffffc02a0fe0 <last_pid.1691>
ffffffffc02052a8:	439c                	lw	a5,0(a5)
ffffffffc02052aa:	6709                	lui	a4,0x2
        return 1;
ffffffffc02052ac:	4905                	li	s2,1
ffffffffc02052ae:	0017851b          	addiw	a0,a5,1
ffffffffc02052b2:	0009c697          	auipc	a3,0x9c
ffffffffc02052b6:	d2a6a723          	sw	a0,-722(a3) # ffffffffc02a0fe0 <last_pid.1691>
ffffffffc02052ba:	ece542e3          	blt	a0,a4,ffffffffc020517e <do_fork+0x148>
        last_pid = 1;
ffffffffc02052be:	4785                	li	a5,1
ffffffffc02052c0:	0009c717          	auipc	a4,0x9c
ffffffffc02052c4:	d2f72023          	sw	a5,-736(a4) # ffffffffc02a0fe0 <last_pid.1691>
ffffffffc02052c8:	4505                	li	a0,1
ffffffffc02052ca:	b5e9                	j	ffffffffc0205194 <do_fork+0x15e>
    if ((mm = mm_create()) == NULL) {
ffffffffc02052cc:	93cfd0ef          	jal	ra,ffffffffc0202408 <mm_create>
ffffffffc02052d0:	8c2a                	mv	s8,a0
ffffffffc02052d2:	c921                	beqz	a0,ffffffffc0205322 <do_fork+0x2ec>
    if (setup_pgdir(mm) != 0) {
ffffffffc02052d4:	be5ff0ef          	jal	ra,ffffffffc0204eb8 <setup_pgdir>
ffffffffc02052d8:	e135                	bnez	a0,ffffffffc020533c <do_fork+0x306>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc02052da:	038a0a93          	addi	s5,s4,56
...
ffffffffc02052de:	4785                	li	a5,1
ffffffffc02052e0:	40fab7af          	amoor.d	a5,a5,(s5)
ffffffffc02052e4:	8b85                	andi	a5,a5,1
ffffffffc02052e6:	4b85                	li	s7,1
...
lock(lock_t *lock) {
    while (!try_lock(lock)) {
ffffffffc02052e8:	c799                	beqz	a5,ffffffffc02052f6 <do_fork+0x2c0>
        schedule();
ffffffffc02052ea:	52b000ef          	jal	ra,ffffffffc0206014 <schedule>
ffffffffc02052ee:	417ab7af          	amoor.d	a5,s7,(s5)
ffffffffc02052f2:	8b85                	andi	a5,a5,1
    while (!try_lock(lock)) {
ffffffffc02052f4:	fbfd                	bnez	a5,ffffffffc02052ea <do_fork+0x2b4>
        ret = dup_mmap(mm, oldmm);
ffffffffc02052f6:	85d2                	mv	a1,s4
ffffffffc02052f8:	8562                	mv	a0,s8
ffffffffc02052fa:	b98fd0ef          	jal	ra,ffffffffc0202692 <dup_mmap>
...
ffffffffc02052fe:	57f9                	li	a5,-2
ffffffffc0205300:	60fab7af          	amoand.d	a5,a5,(s5)
...
ffffffffc0205306:	0c078f63          	beqz	a5,ffffffffc02053e4 <do_fork+0x3ae>
    if (ret != 0) {
ffffffffc020530a:	8a62                	mv	s4,s8
ffffffffc020530c:	dc050ce3          	beqz	a0,ffffffffc02050e4 <do_fork+0xae>
    exit_mmap(mm);
ffffffffc0205310:	8562                	mv	a0,s8
ffffffffc0205312:	c1cfd0ef          	jal	ra,ffffffffc020272e <exit_mmap>
    put_pgdir(mm);
ffffffffc0205316:	8562                	mv	a0,s8
ffffffffc0205318:	b23ff0ef          	jal	ra,ffffffffc0204e3a <put_pgdir>
    mm_destroy(mm);
ffffffffc020531c:	8562                	mv	a0,s8
ffffffffc020531e:	a70fd0ef          	jal	ra,ffffffffc020258e <mm_destroy>
    kfree(proc);
ffffffffc0205322:	8522                	mv	a0,s0
ffffffffc0205324:	fdcfe0ef          	jal	ra,ffffffffc0203b00 <kfree>
    ret = -E_NO_MEM;
ffffffffc0205328:	5571                	li	a0,-4
    return ret;
ffffffffc020532a:	b735                	j	ffffffffc0205256 <do_fork+0x220>
        intr_enable();
ffffffffc020532c:	b2afb0ef          	jal	ra,ffffffffc0200656 <intr_enable>
ffffffffc0205330:	bf39                	j	ffffffffc020524e <do_fork+0x218>
                    if (last_pid >= MAX_PID) {
ffffffffc0205332:	0117c363          	blt	a5,a7,ffffffffc0205338 <do_fork+0x302>
                        last_pid = 1;
ffffffffc0205336:	4785                	li	a5,1
                    goto repeat;
ffffffffc0205338:	4585                	li	a1,1
ffffffffc020533a:	bd8d                	j	ffffffffc02051ac <do_fork+0x176>
    mm_destroy(mm);
ffffffffc020533c:	8562                	mv	a0,s8
ffffffffc020533e:	a50fd0ef          	jal	ra,ffffffffc020258e <mm_destroy>
ffffffffc0205342:	b7c5                	j	ffffffffc0205322 <do_fork+0x2ec>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205344:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc0205346:	c02007b7          	lui	a5,0xc0200
ffffffffc020534a:	0cf6e563          	bltu	a3,a5,ffffffffc0205414 <do_fork+0x3de>
ffffffffc020534e:	000a7797          	auipc	a5,0xa7
ffffffffc0205352:	10a78793          	addi	a5,a5,266 # ffffffffc02ac458 <va_pa_offset>
ffffffffc0205356:	639c                	ld	a5,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0205358:	000a7717          	auipc	a4,0xa7
ffffffffc020535c:	0a870713          	addi	a4,a4,168 # ffffffffc02ac400 <npage>
ffffffffc0205360:	6318                	ld	a4,0(a4)
    return pa2page(PADDR(kva));
ffffffffc0205362:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0205366:	83b1                	srli	a5,a5,0xc
ffffffffc0205368:	08e7fa63          	bleu	a4,a5,ffffffffc02053fc <do_fork+0x3c6>
    return &pages[PPN(pa) - nbase];
ffffffffc020536c:	00004717          	auipc	a4,0x4
ffffffffc0205370:	a3470713          	addi	a4,a4,-1484 # ffffffffc0208da0 <nbase>
ffffffffc0205374:	6318                	ld	a4,0(a4)
ffffffffc0205376:	000a7697          	auipc	a3,0xa7
ffffffffc020537a:	0f268693          	addi	a3,a3,242 # ffffffffc02ac468 <pages>
ffffffffc020537e:	6288                	ld	a0,0(a3)
ffffffffc0205380:	8f99                	sub	a5,a5,a4
ffffffffc0205382:	079a                	slli	a5,a5,0x6
ffffffffc0205384:	4589                	li	a1,2
ffffffffc0205386:	953e                	add	a0,a0,a5
ffffffffc0205388:	babfb0ef          	jal	ra,ffffffffc0200f32 <free_pages>
ffffffffc020538c:	bf59                	j	ffffffffc0205322 <do_fork+0x2ec>
    int ret = -E_NO_FREE_PROC;
ffffffffc020538e:	556d                	li	a0,-5
ffffffffc0205390:	b5d9                	j	ffffffffc0205256 <do_fork+0x220>
    assert(current->wait_state == 0);
ffffffffc0205392:	00003697          	auipc	a3,0x3
ffffffffc0205396:	2b668693          	addi	a3,a3,694 # ffffffffc0208648 <default_pmm_manager+0x270>
ffffffffc020539a:	00002617          	auipc	a2,0x2
ffffffffc020539e:	91e60613          	addi	a2,a2,-1762 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc02053a2:	1a300593          	li	a1,419
ffffffffc02053a6:	00003517          	auipc	a0,0x3
ffffffffc02053aa:	53250513          	addi	a0,a0,1330 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc02053ae:	e69fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    return KADDR(page2pa(page));
ffffffffc02053b2:	00002617          	auipc	a2,0x2
ffffffffc02053b6:	cee60613          	addi	a2,a2,-786 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc02053ba:	06900593          	li	a1,105
ffffffffc02053be:	00002517          	auipc	a0,0x2
ffffffffc02053c2:	d3a50513          	addi	a0,a0,-710 # ffffffffc02070f8 <commands+0x920>
ffffffffc02053c6:	e51fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc02053ca:	86be                	mv	a3,a5
ffffffffc02053cc:	00002617          	auipc	a2,0x2
ffffffffc02053d0:	dac60613          	addi	a2,a2,-596 # ffffffffc0207178 <commands+0x9a0>
ffffffffc02053d4:	16400593          	li	a1,356
ffffffffc02053d8:	00003517          	auipc	a0,0x3
ffffffffc02053dc:	50050513          	addi	a0,a0,1280 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc02053e0:	e37fa0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("Unlock failed.\n");
ffffffffc02053e4:	00003617          	auipc	a2,0x3
ffffffffc02053e8:	28460613          	addi	a2,a2,644 # ffffffffc0208668 <default_pmm_manager+0x290>
ffffffffc02053ec:	03100593          	li	a1,49
ffffffffc02053f0:	00003517          	auipc	a0,0x3
ffffffffc02053f4:	28850513          	addi	a0,a0,648 # ffffffffc0208678 <default_pmm_manager+0x2a0>
ffffffffc02053f8:	e1ffa0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02053fc:	00002617          	auipc	a2,0x2
ffffffffc0205400:	cdc60613          	addi	a2,a2,-804 # ffffffffc02070d8 <commands+0x900>
ffffffffc0205404:	06200593          	li	a1,98
ffffffffc0205408:	00002517          	auipc	a0,0x2
ffffffffc020540c:	cf050513          	addi	a0,a0,-784 # ffffffffc02070f8 <commands+0x920>
ffffffffc0205410:	e07fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0205414:	00002617          	auipc	a2,0x2
ffffffffc0205418:	d6460613          	addi	a2,a2,-668 # ffffffffc0207178 <commands+0x9a0>
ffffffffc020541c:	06e00593          	li	a1,110
ffffffffc0205420:	00002517          	auipc	a0,0x2
ffffffffc0205424:	cd850513          	addi	a0,a0,-808 # ffffffffc02070f8 <commands+0x920>
ffffffffc0205428:	deffa0ef          	jal	ra,ffffffffc0200216 <__panic>

ffffffffc020542c <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020542c:	7129                	addi	sp,sp,-320
ffffffffc020542e:	fa22                	sd	s0,304(sp)
ffffffffc0205430:	f626                	sd	s1,296(sp)
ffffffffc0205432:	f24a                	sd	s2,288(sp)
ffffffffc0205434:	84ae                	mv	s1,a1
ffffffffc0205436:	892a                	mv	s2,a0
ffffffffc0205438:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020543a:	4581                	li	a1,0
ffffffffc020543c:	12000613          	li	a2,288
ffffffffc0205440:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0205442:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0205444:	5e5000ef          	jal	ra,ffffffffc0206228 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc0205448:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc020544a:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020544c:	100027f3          	csrr	a5,sstatus
ffffffffc0205450:	edd7f793          	andi	a5,a5,-291
ffffffffc0205454:	1207e793          	ori	a5,a5,288
ffffffffc0205458:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020545a:	860a                	mv	a2,sp
ffffffffc020545c:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0205460:	00000797          	auipc	a5,0x0
ffffffffc0205464:	86278793          	addi	a5,a5,-1950 # ffffffffc0204cc2 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205468:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020546a:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020546c:	bcbff0ef          	jal	ra,ffffffffc0205036 <do_fork>
}
ffffffffc0205470:	70f2                	ld	ra,312(sp)
ffffffffc0205472:	7452                	ld	s0,304(sp)
ffffffffc0205474:	74b2                	ld	s1,296(sp)
ffffffffc0205476:	7912                	ld	s2,288(sp)
ffffffffc0205478:	6131                	addi	sp,sp,320
ffffffffc020547a:	8082                	ret

ffffffffc020547c <do_exit>:
do_exit(int error_code) {
ffffffffc020547c:	7179                	addi	sp,sp,-48
ffffffffc020547e:	e84a                	sd	s2,16(sp)
    if (current == idleproc) {
ffffffffc0205480:	000a7717          	auipc	a4,0xa7
ffffffffc0205484:	fb070713          	addi	a4,a4,-80 # ffffffffc02ac430 <idleproc>
ffffffffc0205488:	000a7917          	auipc	s2,0xa7
ffffffffc020548c:	fa090913          	addi	s2,s2,-96 # ffffffffc02ac428 <current>
ffffffffc0205490:	00093783          	ld	a5,0(s2)
ffffffffc0205494:	6318                	ld	a4,0(a4)
do_exit(int error_code) {
ffffffffc0205496:	f406                	sd	ra,40(sp)
ffffffffc0205498:	f022                	sd	s0,32(sp)
ffffffffc020549a:	ec26                	sd	s1,24(sp)
ffffffffc020549c:	e44e                	sd	s3,8(sp)
ffffffffc020549e:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc02054a0:	0ce78c63          	beq	a5,a4,ffffffffc0205578 <do_exit+0xfc>
    if (current == initproc) {
ffffffffc02054a4:	000a7417          	auipc	s0,0xa7
ffffffffc02054a8:	f9440413          	addi	s0,s0,-108 # ffffffffc02ac438 <initproc>
ffffffffc02054ac:	6018                	ld	a4,0(s0)
ffffffffc02054ae:	0ee78b63          	beq	a5,a4,ffffffffc02055a4 <do_exit+0x128>
    struct mm_struct *mm = current->mm;
ffffffffc02054b2:	7784                	ld	s1,40(a5)
ffffffffc02054b4:	89aa                	mv	s3,a0
    if (mm != NULL) {
ffffffffc02054b6:	c48d                	beqz	s1,ffffffffc02054e0 <do_exit+0x64>
        lcr3(boot_cr3);
ffffffffc02054b8:	000a7797          	auipc	a5,0xa7
ffffffffc02054bc:	fa878793          	addi	a5,a5,-88 # ffffffffc02ac460 <boot_cr3>
ffffffffc02054c0:	639c                	ld	a5,0(a5)
ffffffffc02054c2:	577d                	li	a4,-1
ffffffffc02054c4:	177e                	slli	a4,a4,0x3f
ffffffffc02054c6:	83b1                	srli	a5,a5,0xc
ffffffffc02054c8:	8fd9                	or	a5,a5,a4
ffffffffc02054ca:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc02054ce:	589c                	lw	a5,48(s1)
ffffffffc02054d0:	fff7871b          	addiw	a4,a5,-1
ffffffffc02054d4:	d898                	sw	a4,48(s1)
        if (mm_count_dec(mm) == 0) {
ffffffffc02054d6:	cf4d                	beqz	a4,ffffffffc0205590 <do_exit+0x114>
        current->mm = NULL;
ffffffffc02054d8:	00093783          	ld	a5,0(s2)
ffffffffc02054dc:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc02054e0:	00093783          	ld	a5,0(s2)
ffffffffc02054e4:	470d                	li	a4,3
ffffffffc02054e6:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc02054e8:	0f37a423          	sw	s3,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02054ec:	100027f3          	csrr	a5,sstatus
ffffffffc02054f0:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02054f2:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02054f4:	e7e1                	bnez	a5,ffffffffc02055bc <do_exit+0x140>
        proc = current->parent;
ffffffffc02054f6:	00093703          	ld	a4,0(s2)
        if (proc->wait_state == WT_CHILD) {
ffffffffc02054fa:	800007b7          	lui	a5,0x80000
ffffffffc02054fe:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc0205500:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205502:	0ec52703          	lw	a4,236(a0)
ffffffffc0205506:	0af70f63          	beq	a4,a5,ffffffffc02055c4 <do_exit+0x148>
ffffffffc020550a:	00093683          	ld	a3,0(s2)
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020550e:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205512:	448d                	li	s1,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205514:	0985                	addi	s3,s3,1
        while (current->cptr != NULL) {
ffffffffc0205516:	7afc                	ld	a5,240(a3)
ffffffffc0205518:	cb95                	beqz	a5,ffffffffc020554c <do_exit+0xd0>
            current->cptr = proc->optr;
ffffffffc020551a:	1007b703          	ld	a4,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff5688>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020551e:	6008                	ld	a0,0(s0)
            current->cptr = proc->optr;
ffffffffc0205520:	faf8                	sd	a4,240(a3)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205522:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc0205524:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205528:	10e7b023          	sd	a4,256(a5)
ffffffffc020552c:	c311                	beqz	a4,ffffffffc0205530 <do_exit+0xb4>
                initproc->cptr->yptr = proc;
ffffffffc020552e:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205530:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc0205532:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc0205534:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205536:	fe9710e3          	bne	a4,s1,ffffffffc0205516 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020553a:	0ec52783          	lw	a5,236(a0)
ffffffffc020553e:	fd379ce3          	bne	a5,s3,ffffffffc0205516 <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc0205542:	257000ef          	jal	ra,ffffffffc0205f98 <wakeup_proc>
ffffffffc0205546:	00093683          	ld	a3,0(s2)
ffffffffc020554a:	b7f1                	j	ffffffffc0205516 <do_exit+0x9a>
    if (flag) {
ffffffffc020554c:	020a1363          	bnez	s4,ffffffffc0205572 <do_exit+0xf6>
    schedule();
ffffffffc0205550:	2c5000ef          	jal	ra,ffffffffc0206014 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc0205554:	00093783          	ld	a5,0(s2)
ffffffffc0205558:	00003617          	auipc	a2,0x3
ffffffffc020555c:	0d060613          	addi	a2,a2,208 # ffffffffc0208628 <default_pmm_manager+0x250>
ffffffffc0205560:	20300593          	li	a1,515
ffffffffc0205564:	43d4                	lw	a3,4(a5)
ffffffffc0205566:	00003517          	auipc	a0,0x3
ffffffffc020556a:	37250513          	addi	a0,a0,882 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc020556e:	ca9fa0ef          	jal	ra,ffffffffc0200216 <__panic>
        intr_enable();
ffffffffc0205572:	8e4fb0ef          	jal	ra,ffffffffc0200656 <intr_enable>
ffffffffc0205576:	bfe9                	j	ffffffffc0205550 <do_exit+0xd4>
        panic("idleproc exit.\n");
ffffffffc0205578:	00003617          	auipc	a2,0x3
ffffffffc020557c:	09060613          	addi	a2,a2,144 # ffffffffc0208608 <default_pmm_manager+0x230>
ffffffffc0205580:	1d700593          	li	a1,471
ffffffffc0205584:	00003517          	auipc	a0,0x3
ffffffffc0205588:	35450513          	addi	a0,a0,852 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc020558c:	c8bfa0ef          	jal	ra,ffffffffc0200216 <__panic>
            exit_mmap(mm);
ffffffffc0205590:	8526                	mv	a0,s1
ffffffffc0205592:	99cfd0ef          	jal	ra,ffffffffc020272e <exit_mmap>
            put_pgdir(mm);
ffffffffc0205596:	8526                	mv	a0,s1
ffffffffc0205598:	8a3ff0ef          	jal	ra,ffffffffc0204e3a <put_pgdir>
            mm_destroy(mm);
ffffffffc020559c:	8526                	mv	a0,s1
ffffffffc020559e:	ff1fc0ef          	jal	ra,ffffffffc020258e <mm_destroy>
ffffffffc02055a2:	bf1d                	j	ffffffffc02054d8 <do_exit+0x5c>
        panic("initproc exit.\n");
ffffffffc02055a4:	00003617          	auipc	a2,0x3
ffffffffc02055a8:	07460613          	addi	a2,a2,116 # ffffffffc0208618 <default_pmm_manager+0x240>
ffffffffc02055ac:	1da00593          	li	a1,474
ffffffffc02055b0:	00003517          	auipc	a0,0x3
ffffffffc02055b4:	32850513          	addi	a0,a0,808 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc02055b8:	c5ffa0ef          	jal	ra,ffffffffc0200216 <__panic>
        intr_disable();
ffffffffc02055bc:	8a0fb0ef          	jal	ra,ffffffffc020065c <intr_disable>
        return 1;
ffffffffc02055c0:	4a05                	li	s4,1
ffffffffc02055c2:	bf15                	j	ffffffffc02054f6 <do_exit+0x7a>
            wakeup_proc(proc);
ffffffffc02055c4:	1d5000ef          	jal	ra,ffffffffc0205f98 <wakeup_proc>
ffffffffc02055c8:	b789                	j	ffffffffc020550a <do_exit+0x8e>

ffffffffc02055ca <do_wait.part.1>:
do_wait(int pid, int *code_store) {
ffffffffc02055ca:	7139                	addi	sp,sp,-64
ffffffffc02055cc:	e852                	sd	s4,16(sp)
        current->wait_state = WT_CHILD;
ffffffffc02055ce:	80000a37          	lui	s4,0x80000
do_wait(int pid, int *code_store) {
ffffffffc02055d2:	f426                	sd	s1,40(sp)
ffffffffc02055d4:	f04a                	sd	s2,32(sp)
ffffffffc02055d6:	ec4e                	sd	s3,24(sp)
ffffffffc02055d8:	e456                	sd	s5,8(sp)
ffffffffc02055da:	e05a                	sd	s6,0(sp)
ffffffffc02055dc:	fc06                	sd	ra,56(sp)
ffffffffc02055de:	f822                	sd	s0,48(sp)
ffffffffc02055e0:	89aa                	mv	s3,a0
ffffffffc02055e2:	8b2e                	mv	s6,a1
        proc = current->cptr;
ffffffffc02055e4:	000a7917          	auipc	s2,0xa7
ffffffffc02055e8:	e4490913          	addi	s2,s2,-444 # ffffffffc02ac428 <current>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02055ec:	448d                	li	s1,3
        current->state = PROC_SLEEPING;
ffffffffc02055ee:	4a85                	li	s5,1
        current->wait_state = WT_CHILD;
ffffffffc02055f0:	2a05                	addiw	s4,s4,1
    if (pid != 0) {
ffffffffc02055f2:	02098f63          	beqz	s3,ffffffffc0205630 <do_wait.part.1+0x66>
        proc = find_proc(pid);
ffffffffc02055f6:	854e                	mv	a0,s3
ffffffffc02055f8:	9e3ff0ef          	jal	ra,ffffffffc0204fda <find_proc>
ffffffffc02055fc:	842a                	mv	s0,a0
        if (proc != NULL && proc->parent == current) {
ffffffffc02055fe:	12050063          	beqz	a0,ffffffffc020571e <do_wait.part.1+0x154>
ffffffffc0205602:	00093703          	ld	a4,0(s2)
ffffffffc0205606:	711c                	ld	a5,32(a0)
ffffffffc0205608:	10e79b63          	bne	a5,a4,ffffffffc020571e <do_wait.part.1+0x154>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020560c:	411c                	lw	a5,0(a0)
ffffffffc020560e:	02978c63          	beq	a5,s1,ffffffffc0205646 <do_wait.part.1+0x7c>
        current->state = PROC_SLEEPING;
ffffffffc0205612:	01572023          	sw	s5,0(a4)
        current->wait_state = WT_CHILD;
ffffffffc0205616:	0f472623          	sw	s4,236(a4)
        schedule();
ffffffffc020561a:	1fb000ef          	jal	ra,ffffffffc0206014 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc020561e:	00093783          	ld	a5,0(s2)
ffffffffc0205622:	0b07a783          	lw	a5,176(a5)
ffffffffc0205626:	8b85                	andi	a5,a5,1
ffffffffc0205628:	d7e9                	beqz	a5,ffffffffc02055f2 <do_wait.part.1+0x28>
            do_exit(-E_KILLED);
ffffffffc020562a:	555d                	li	a0,-9
ffffffffc020562c:	e51ff0ef          	jal	ra,ffffffffc020547c <do_exit>
        proc = current->cptr;
ffffffffc0205630:	00093703          	ld	a4,0(s2)
ffffffffc0205634:	7b60                	ld	s0,240(a4)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc0205636:	e409                	bnez	s0,ffffffffc0205640 <do_wait.part.1+0x76>
ffffffffc0205638:	a0dd                	j	ffffffffc020571e <do_wait.part.1+0x154>
ffffffffc020563a:	10043403          	ld	s0,256(s0)
ffffffffc020563e:	d871                	beqz	s0,ffffffffc0205612 <do_wait.part.1+0x48>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205640:	401c                	lw	a5,0(s0)
ffffffffc0205642:	fe979ce3          	bne	a5,s1,ffffffffc020563a <do_wait.part.1+0x70>
    if (proc == idleproc || proc == initproc) {
ffffffffc0205646:	000a7797          	auipc	a5,0xa7
ffffffffc020564a:	dea78793          	addi	a5,a5,-534 # ffffffffc02ac430 <idleproc>
ffffffffc020564e:	639c                	ld	a5,0(a5)
ffffffffc0205650:	0c878d63          	beq	a5,s0,ffffffffc020572a <do_wait.part.1+0x160>
ffffffffc0205654:	000a7797          	auipc	a5,0xa7
ffffffffc0205658:	de478793          	addi	a5,a5,-540 # ffffffffc02ac438 <initproc>
ffffffffc020565c:	639c                	ld	a5,0(a5)
ffffffffc020565e:	0cf40663          	beq	s0,a5,ffffffffc020572a <do_wait.part.1+0x160>
    if (code_store != NULL) {
ffffffffc0205662:	000b0663          	beqz	s6,ffffffffc020566e <do_wait.part.1+0xa4>
        *code_store = proc->exit_code;
ffffffffc0205666:	0e842783          	lw	a5,232(s0)
ffffffffc020566a:	00fb2023          	sw	a5,0(s6)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020566e:	100027f3          	csrr	a5,sstatus
ffffffffc0205672:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205674:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205676:	e7d5                	bnez	a5,ffffffffc0205722 <do_wait.part.1+0x158>
    __list_del(listelm->prev, listelm->next);
ffffffffc0205678:	6c70                	ld	a2,216(s0)
ffffffffc020567a:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc020567c:	10043703          	ld	a4,256(s0)
ffffffffc0205680:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc0205682:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205684:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc0205686:	6470                	ld	a2,200(s0)
ffffffffc0205688:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc020568a:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020568c:	e290                	sd	a2,0(a3)
ffffffffc020568e:	c319                	beqz	a4,ffffffffc0205694 <do_wait.part.1+0xca>
        proc->optr->yptr = proc->yptr;
ffffffffc0205690:	ff7c                	sd	a5,248(a4)
ffffffffc0205692:	7c7c                	ld	a5,248(s0)
    if (proc->yptr != NULL) {
ffffffffc0205694:	c3d1                	beqz	a5,ffffffffc0205718 <do_wait.part.1+0x14e>
        proc->yptr->optr = proc->optr;
ffffffffc0205696:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc020569a:	000a7797          	auipc	a5,0xa7
ffffffffc020569e:	da678793          	addi	a5,a5,-602 # ffffffffc02ac440 <nr_process>
ffffffffc02056a2:	439c                	lw	a5,0(a5)
ffffffffc02056a4:	37fd                	addiw	a5,a5,-1
ffffffffc02056a6:	000a7717          	auipc	a4,0xa7
ffffffffc02056aa:	d8f72d23          	sw	a5,-614(a4) # ffffffffc02ac440 <nr_process>
    if (flag) {
ffffffffc02056ae:	e1b5                	bnez	a1,ffffffffc0205712 <do_wait.part.1+0x148>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02056b0:	6814                	ld	a3,16(s0)
ffffffffc02056b2:	c02007b7          	lui	a5,0xc0200
ffffffffc02056b6:	0af6e263          	bltu	a3,a5,ffffffffc020575a <do_wait.part.1+0x190>
ffffffffc02056ba:	000a7797          	auipc	a5,0xa7
ffffffffc02056be:	d9e78793          	addi	a5,a5,-610 # ffffffffc02ac458 <va_pa_offset>
ffffffffc02056c2:	6398                	ld	a4,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc02056c4:	000a7797          	auipc	a5,0xa7
ffffffffc02056c8:	d3c78793          	addi	a5,a5,-708 # ffffffffc02ac400 <npage>
ffffffffc02056cc:	639c                	ld	a5,0(a5)
    return pa2page(PADDR(kva));
ffffffffc02056ce:	8e99                	sub	a3,a3,a4
    if (PPN(pa) >= npage) {
ffffffffc02056d0:	82b1                	srli	a3,a3,0xc
ffffffffc02056d2:	06f6f863          	bleu	a5,a3,ffffffffc0205742 <do_wait.part.1+0x178>
    return &pages[PPN(pa) - nbase];
ffffffffc02056d6:	00003797          	auipc	a5,0x3
ffffffffc02056da:	6ca78793          	addi	a5,a5,1738 # ffffffffc0208da0 <nbase>
ffffffffc02056de:	639c                	ld	a5,0(a5)
ffffffffc02056e0:	000a7717          	auipc	a4,0xa7
ffffffffc02056e4:	d8870713          	addi	a4,a4,-632 # ffffffffc02ac468 <pages>
ffffffffc02056e8:	6308                	ld	a0,0(a4)
ffffffffc02056ea:	8e9d                	sub	a3,a3,a5
ffffffffc02056ec:	069a                	slli	a3,a3,0x6
ffffffffc02056ee:	9536                	add	a0,a0,a3
ffffffffc02056f0:	4589                	li	a1,2
ffffffffc02056f2:	841fb0ef          	jal	ra,ffffffffc0200f32 <free_pages>
    kfree(proc);
ffffffffc02056f6:	8522                	mv	a0,s0
ffffffffc02056f8:	c08fe0ef          	jal	ra,ffffffffc0203b00 <kfree>
    return 0;
ffffffffc02056fc:	4501                	li	a0,0
}
ffffffffc02056fe:	70e2                	ld	ra,56(sp)
ffffffffc0205700:	7442                	ld	s0,48(sp)
ffffffffc0205702:	74a2                	ld	s1,40(sp)
ffffffffc0205704:	7902                	ld	s2,32(sp)
ffffffffc0205706:	69e2                	ld	s3,24(sp)
ffffffffc0205708:	6a42                	ld	s4,16(sp)
ffffffffc020570a:	6aa2                	ld	s5,8(sp)
ffffffffc020570c:	6b02                	ld	s6,0(sp)
ffffffffc020570e:	6121                	addi	sp,sp,64
ffffffffc0205710:	8082                	ret
        intr_enable();
ffffffffc0205712:	f45fa0ef          	jal	ra,ffffffffc0200656 <intr_enable>
ffffffffc0205716:	bf69                	j	ffffffffc02056b0 <do_wait.part.1+0xe6>
       proc->parent->cptr = proc->optr;
ffffffffc0205718:	701c                	ld	a5,32(s0)
ffffffffc020571a:	fbf8                	sd	a4,240(a5)
ffffffffc020571c:	bfbd                	j	ffffffffc020569a <do_wait.part.1+0xd0>
    return -E_BAD_PROC;
ffffffffc020571e:	5579                	li	a0,-2
ffffffffc0205720:	bff9                	j	ffffffffc02056fe <do_wait.part.1+0x134>
        intr_disable();
ffffffffc0205722:	f3bfa0ef          	jal	ra,ffffffffc020065c <intr_disable>
        return 1;
ffffffffc0205726:	4585                	li	a1,1
ffffffffc0205728:	bf81                	j	ffffffffc0205678 <do_wait.part.1+0xae>
        panic("wait idleproc or initproc.\n");
ffffffffc020572a:	00003617          	auipc	a2,0x3
ffffffffc020572e:	f6660613          	addi	a2,a2,-154 # ffffffffc0208690 <default_pmm_manager+0x2b8>
ffffffffc0205732:	2fa00593          	li	a1,762
ffffffffc0205736:	00003517          	auipc	a0,0x3
ffffffffc020573a:	1a250513          	addi	a0,a0,418 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc020573e:	ad9fa0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205742:	00002617          	auipc	a2,0x2
ffffffffc0205746:	99660613          	addi	a2,a2,-1642 # ffffffffc02070d8 <commands+0x900>
ffffffffc020574a:	06200593          	li	a1,98
ffffffffc020574e:	00002517          	auipc	a0,0x2
ffffffffc0205752:	9aa50513          	addi	a0,a0,-1622 # ffffffffc02070f8 <commands+0x920>
ffffffffc0205756:	ac1fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020575a:	00002617          	auipc	a2,0x2
ffffffffc020575e:	a1e60613          	addi	a2,a2,-1506 # ffffffffc0207178 <commands+0x9a0>
ffffffffc0205762:	06e00593          	li	a1,110
ffffffffc0205766:	00002517          	auipc	a0,0x2
ffffffffc020576a:	99250513          	addi	a0,a0,-1646 # ffffffffc02070f8 <commands+0x920>
ffffffffc020576e:	aa9fa0ef          	jal	ra,ffffffffc0200216 <__panic>

ffffffffc0205772 <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc0205772:	1141                	addi	sp,sp,-16
ffffffffc0205774:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0205776:	803fb0ef          	jal	ra,ffffffffc0200f78 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc020577a:	ac6fe0ef          	jal	ra,ffffffffc0203a40 <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc020577e:	4601                	li	a2,0
ffffffffc0205780:	4581                	li	a1,0
ffffffffc0205782:	fffff517          	auipc	a0,0xfffff
ffffffffc0205786:	63650513          	addi	a0,a0,1590 # ffffffffc0204db8 <user_main>
ffffffffc020578a:	ca3ff0ef          	jal	ra,ffffffffc020542c <kernel_thread>
    if (pid <= 0) {
ffffffffc020578e:	00a04563          	bgtz	a0,ffffffffc0205798 <init_main+0x26>
ffffffffc0205792:	a841                	j	ffffffffc0205822 <init_main+0xb0>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc0205794:	081000ef          	jal	ra,ffffffffc0206014 <schedule>
    if (code_store != NULL) {
ffffffffc0205798:	4581                	li	a1,0
ffffffffc020579a:	4501                	li	a0,0
ffffffffc020579c:	e2fff0ef          	jal	ra,ffffffffc02055ca <do_wait.part.1>
    while (do_wait(0, NULL) == 0) {
ffffffffc02057a0:	d975                	beqz	a0,ffffffffc0205794 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc02057a2:	00003517          	auipc	a0,0x3
ffffffffc02057a6:	f2e50513          	addi	a0,a0,-210 # ffffffffc02086d0 <default_pmm_manager+0x2f8>
ffffffffc02057aa:	927fa0ef          	jal	ra,ffffffffc02000d0 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc02057ae:	000a7797          	auipc	a5,0xa7
ffffffffc02057b2:	c8a78793          	addi	a5,a5,-886 # ffffffffc02ac438 <initproc>
ffffffffc02057b6:	639c                	ld	a5,0(a5)
ffffffffc02057b8:	7bf8                	ld	a4,240(a5)
ffffffffc02057ba:	e721                	bnez	a4,ffffffffc0205802 <init_main+0x90>
ffffffffc02057bc:	7ff8                	ld	a4,248(a5)
ffffffffc02057be:	e331                	bnez	a4,ffffffffc0205802 <init_main+0x90>
ffffffffc02057c0:	1007b703          	ld	a4,256(a5)
ffffffffc02057c4:	ef1d                	bnez	a4,ffffffffc0205802 <init_main+0x90>
    assert(nr_process == 2);
ffffffffc02057c6:	000a7717          	auipc	a4,0xa7
ffffffffc02057ca:	c7a70713          	addi	a4,a4,-902 # ffffffffc02ac440 <nr_process>
ffffffffc02057ce:	4314                	lw	a3,0(a4)
ffffffffc02057d0:	4709                	li	a4,2
ffffffffc02057d2:	0ae69463          	bne	a3,a4,ffffffffc020587a <init_main+0x108>
    return listelm->next;
ffffffffc02057d6:	000a7697          	auipc	a3,0xa7
ffffffffc02057da:	d9268693          	addi	a3,a3,-622 # ffffffffc02ac568 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02057de:	6698                	ld	a4,8(a3)
ffffffffc02057e0:	0c878793          	addi	a5,a5,200
ffffffffc02057e4:	06f71b63          	bne	a4,a5,ffffffffc020585a <init_main+0xe8>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02057e8:	629c                	ld	a5,0(a3)
ffffffffc02057ea:	04f71863          	bne	a4,a5,ffffffffc020583a <init_main+0xc8>

    cprintf("init check memory pass.\n");
ffffffffc02057ee:	00003517          	auipc	a0,0x3
ffffffffc02057f2:	fca50513          	addi	a0,a0,-54 # ffffffffc02087b8 <default_pmm_manager+0x3e0>
ffffffffc02057f6:	8dbfa0ef          	jal	ra,ffffffffc02000d0 <cprintf>
    return 0;
}
ffffffffc02057fa:	60a2                	ld	ra,8(sp)
ffffffffc02057fc:	4501                	li	a0,0
ffffffffc02057fe:	0141                	addi	sp,sp,16
ffffffffc0205800:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205802:	00003697          	auipc	a3,0x3
ffffffffc0205806:	ef668693          	addi	a3,a3,-266 # ffffffffc02086f8 <default_pmm_manager+0x320>
ffffffffc020580a:	00001617          	auipc	a2,0x1
ffffffffc020580e:	4ae60613          	addi	a2,a2,1198 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205812:	35f00593          	li	a1,863
ffffffffc0205816:	00003517          	auipc	a0,0x3
ffffffffc020581a:	0c250513          	addi	a0,a0,194 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc020581e:	9f9fa0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("create user_main failed.\n");
ffffffffc0205822:	00003617          	auipc	a2,0x3
ffffffffc0205826:	e8e60613          	addi	a2,a2,-370 # ffffffffc02086b0 <default_pmm_manager+0x2d8>
ffffffffc020582a:	35700593          	li	a1,855
ffffffffc020582e:	00003517          	auipc	a0,0x3
ffffffffc0205832:	0aa50513          	addi	a0,a0,170 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205836:	9e1fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc020583a:	00003697          	auipc	a3,0x3
ffffffffc020583e:	f4e68693          	addi	a3,a3,-178 # ffffffffc0208788 <default_pmm_manager+0x3b0>
ffffffffc0205842:	00001617          	auipc	a2,0x1
ffffffffc0205846:	47660613          	addi	a2,a2,1142 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020584a:	36200593          	li	a1,866
ffffffffc020584e:	00003517          	auipc	a0,0x3
ffffffffc0205852:	08a50513          	addi	a0,a0,138 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205856:	9c1fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020585a:	00003697          	auipc	a3,0x3
ffffffffc020585e:	efe68693          	addi	a3,a3,-258 # ffffffffc0208758 <default_pmm_manager+0x380>
ffffffffc0205862:	00001617          	auipc	a2,0x1
ffffffffc0205866:	45660613          	addi	a2,a2,1110 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020586a:	36100593          	li	a1,865
ffffffffc020586e:	00003517          	auipc	a0,0x3
ffffffffc0205872:	06a50513          	addi	a0,a0,106 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205876:	9a1fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(nr_process == 2);
ffffffffc020587a:	00003697          	auipc	a3,0x3
ffffffffc020587e:	ece68693          	addi	a3,a3,-306 # ffffffffc0208748 <default_pmm_manager+0x370>
ffffffffc0205882:	00001617          	auipc	a2,0x1
ffffffffc0205886:	43660613          	addi	a2,a2,1078 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc020588a:	36000593          	li	a1,864
ffffffffc020588e:	00003517          	auipc	a0,0x3
ffffffffc0205892:	04a50513          	addi	a0,a0,74 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205896:	981fa0ef          	jal	ra,ffffffffc0200216 <__panic>

ffffffffc020589a <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020589a:	7135                	addi	sp,sp,-160
ffffffffc020589c:	f8d2                	sd	s4,112(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020589e:	000a7a17          	auipc	s4,0xa7
ffffffffc02058a2:	b8aa0a13          	addi	s4,s4,-1142 # ffffffffc02ac428 <current>
ffffffffc02058a6:	000a3783          	ld	a5,0(s4)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02058aa:	e14a                	sd	s2,128(sp)
ffffffffc02058ac:	e922                	sd	s0,144(sp)
    struct mm_struct *mm = current->mm;
ffffffffc02058ae:	0287b903          	ld	s2,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02058b2:	fcce                	sd	s3,120(sp)
ffffffffc02058b4:	f0da                	sd	s6,96(sp)
ffffffffc02058b6:	89aa                	mv	s3,a0
ffffffffc02058b8:	842e                	mv	s0,a1
ffffffffc02058ba:	8b32                	mv	s6,a2
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc02058bc:	4681                	li	a3,0
ffffffffc02058be:	862e                	mv	a2,a1
ffffffffc02058c0:	85aa                	mv	a1,a0
ffffffffc02058c2:	854a                	mv	a0,s2
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02058c4:	ed06                	sd	ra,152(sp)
ffffffffc02058c6:	e526                	sd	s1,136(sp)
ffffffffc02058c8:	f4d6                	sd	s5,104(sp)
ffffffffc02058ca:	ecde                	sd	s7,88(sp)
ffffffffc02058cc:	e8e2                	sd	s8,80(sp)
ffffffffc02058ce:	e4e6                	sd	s9,72(sp)
ffffffffc02058d0:	e0ea                	sd	s10,64(sp)
ffffffffc02058d2:	fc6e                	sd	s11,56(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc02058d4:	cfcfd0ef          	jal	ra,ffffffffc0202dd0 <user_mem_check>
ffffffffc02058d8:	40050463          	beqz	a0,ffffffffc0205ce0 <do_execve+0x446>
    memset(local_name, 0, sizeof(local_name));
ffffffffc02058dc:	4641                	li	a2,16
ffffffffc02058de:	4581                	li	a1,0
ffffffffc02058e0:	1008                	addi	a0,sp,32
ffffffffc02058e2:	147000ef          	jal	ra,ffffffffc0206228 <memset>
    memcpy(local_name, name, len);
ffffffffc02058e6:	47bd                	li	a5,15
ffffffffc02058e8:	8622                	mv	a2,s0
ffffffffc02058ea:	0687ee63          	bltu	a5,s0,ffffffffc0205966 <do_execve+0xcc>
ffffffffc02058ee:	85ce                	mv	a1,s3
ffffffffc02058f0:	1008                	addi	a0,sp,32
ffffffffc02058f2:	149000ef          	jal	ra,ffffffffc020623a <memcpy>
    if (mm != NULL) {
ffffffffc02058f6:	06090f63          	beqz	s2,ffffffffc0205974 <do_execve+0xda>
        cputs("mm != NULL");
ffffffffc02058fa:	00002517          	auipc	a0,0x2
ffffffffc02058fe:	f6e50513          	addi	a0,a0,-146 # ffffffffc0207868 <commands+0x1090>
ffffffffc0205902:	807fa0ef          	jal	ra,ffffffffc0200108 <cputs>
        lcr3(boot_cr3);
ffffffffc0205906:	000a7797          	auipc	a5,0xa7
ffffffffc020590a:	b5a78793          	addi	a5,a5,-1190 # ffffffffc02ac460 <boot_cr3>
ffffffffc020590e:	639c                	ld	a5,0(a5)
ffffffffc0205910:	577d                	li	a4,-1
ffffffffc0205912:	177e                	slli	a4,a4,0x3f
ffffffffc0205914:	83b1                	srli	a5,a5,0xc
ffffffffc0205916:	8fd9                	or	a5,a5,a4
ffffffffc0205918:	18079073          	csrw	satp,a5
ffffffffc020591c:	03092783          	lw	a5,48(s2)
ffffffffc0205920:	fff7871b          	addiw	a4,a5,-1
ffffffffc0205924:	02e92823          	sw	a4,48(s2)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205928:	28070b63          	beqz	a4,ffffffffc0205bbe <do_execve+0x324>
        current->mm = NULL;
ffffffffc020592c:	000a3783          	ld	a5,0(s4)
ffffffffc0205930:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc0205934:	ad5fc0ef          	jal	ra,ffffffffc0202408 <mm_create>
ffffffffc0205938:	892a                	mv	s2,a0
ffffffffc020593a:	c135                	beqz	a0,ffffffffc020599e <do_execve+0x104>
    if (setup_pgdir(mm) != 0) {
ffffffffc020593c:	d7cff0ef          	jal	ra,ffffffffc0204eb8 <setup_pgdir>
ffffffffc0205940:	e931                	bnez	a0,ffffffffc0205994 <do_execve+0xfa>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205942:	000b2703          	lw	a4,0(s6)
ffffffffc0205946:	464c47b7          	lui	a5,0x464c4
ffffffffc020594a:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9b07>
ffffffffc020594e:	04f70a63          	beq	a4,a5,ffffffffc02059a2 <do_execve+0x108>
    put_pgdir(mm);
ffffffffc0205952:	854a                	mv	a0,s2
ffffffffc0205954:	ce6ff0ef          	jal	ra,ffffffffc0204e3a <put_pgdir>
    mm_destroy(mm);
ffffffffc0205958:	854a                	mv	a0,s2
ffffffffc020595a:	c35fc0ef          	jal	ra,ffffffffc020258e <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc020595e:	59e1                	li	s3,-8
    do_exit(ret);
ffffffffc0205960:	854e                	mv	a0,s3
ffffffffc0205962:	b1bff0ef          	jal	ra,ffffffffc020547c <do_exit>
    memcpy(local_name, name, len);
ffffffffc0205966:	463d                	li	a2,15
ffffffffc0205968:	85ce                	mv	a1,s3
ffffffffc020596a:	1008                	addi	a0,sp,32
ffffffffc020596c:	0cf000ef          	jal	ra,ffffffffc020623a <memcpy>
    if (mm != NULL) {
ffffffffc0205970:	f80915e3          	bnez	s2,ffffffffc02058fa <do_execve+0x60>
    if (current->mm != NULL) {
ffffffffc0205974:	000a3783          	ld	a5,0(s4)
ffffffffc0205978:	779c                	ld	a5,40(a5)
ffffffffc020597a:	dfcd                	beqz	a5,ffffffffc0205934 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc020597c:	00003617          	auipc	a2,0x3
ffffffffc0205980:	b0460613          	addi	a2,a2,-1276 # ffffffffc0208480 <default_pmm_manager+0xa8>
ffffffffc0205984:	20d00593          	li	a1,525
ffffffffc0205988:	00003517          	auipc	a0,0x3
ffffffffc020598c:	f5050513          	addi	a0,a0,-176 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205990:	887fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    mm_destroy(mm);
ffffffffc0205994:	854a                	mv	a0,s2
ffffffffc0205996:	bf9fc0ef          	jal	ra,ffffffffc020258e <mm_destroy>
    int ret = -E_NO_MEM;
ffffffffc020599a:	59f1                	li	s3,-4
ffffffffc020599c:	b7d1                	j	ffffffffc0205960 <do_execve+0xc6>
ffffffffc020599e:	59f1                	li	s3,-4
ffffffffc02059a0:	b7c1                	j	ffffffffc0205960 <do_execve+0xc6>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc02059a2:	038b5703          	lhu	a4,56(s6)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc02059a6:	020b3403          	ld	s0,32(s6)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc02059aa:	00371793          	slli	a5,a4,0x3
ffffffffc02059ae:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc02059b0:	945a                	add	s0,s0,s6
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc02059b2:	078e                	slli	a5,a5,0x3
ffffffffc02059b4:	97a2                	add	a5,a5,s0
ffffffffc02059b6:	ec3e                	sd	a5,24(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc02059b8:	02f47b63          	bleu	a5,s0,ffffffffc02059ee <do_execve+0x154>
    return KADDR(page2pa(page));
ffffffffc02059bc:	5bfd                	li	s7,-1
ffffffffc02059be:	00cbd793          	srli	a5,s7,0xc
    return page - pages + nbase;
ffffffffc02059c2:	000a7d97          	auipc	s11,0xa7
ffffffffc02059c6:	aa6d8d93          	addi	s11,s11,-1370 # ffffffffc02ac468 <pages>
ffffffffc02059ca:	00003d17          	auipc	s10,0x3
ffffffffc02059ce:	3d6d0d13          	addi	s10,s10,982 # ffffffffc0208da0 <nbase>
    return KADDR(page2pa(page));
ffffffffc02059d2:	e43e                	sd	a5,8(sp)
ffffffffc02059d4:	000a7c97          	auipc	s9,0xa7
ffffffffc02059d8:	a2cc8c93          	addi	s9,s9,-1492 # ffffffffc02ac400 <npage>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc02059dc:	4018                	lw	a4,0(s0)
ffffffffc02059de:	4785                	li	a5,1
ffffffffc02059e0:	0ef70d63          	beq	a4,a5,ffffffffc0205ada <do_execve+0x240>
    for (; ph < ph_end; ph ++) {
ffffffffc02059e4:	67e2                	ld	a5,24(sp)
ffffffffc02059e6:	03840413          	addi	s0,s0,56
ffffffffc02059ea:	fef469e3          	bltu	s0,a5,ffffffffc02059dc <do_execve+0x142>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc02059ee:	4701                	li	a4,0
ffffffffc02059f0:	46ad                	li	a3,11
ffffffffc02059f2:	00100637          	lui	a2,0x100
ffffffffc02059f6:	7ff005b7          	lui	a1,0x7ff00
ffffffffc02059fa:	854a                	mv	a0,s2
ffffffffc02059fc:	be5fc0ef          	jal	ra,ffffffffc02025e0 <mm_map>
ffffffffc0205a00:	89aa                	mv	s3,a0
ffffffffc0205a02:	1a051463          	bnez	a0,ffffffffc0205baa <do_execve+0x310>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205a06:	01893503          	ld	a0,24(s2)
ffffffffc0205a0a:	467d                	li	a2,31
ffffffffc0205a0c:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0205a10:	941fc0ef          	jal	ra,ffffffffc0202350 <pgdir_alloc_page>
ffffffffc0205a14:	36050263          	beqz	a0,ffffffffc0205d78 <do_execve+0x4de>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205a18:	01893503          	ld	a0,24(s2)
ffffffffc0205a1c:	467d                	li	a2,31
ffffffffc0205a1e:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc0205a22:	92ffc0ef          	jal	ra,ffffffffc0202350 <pgdir_alloc_page>
ffffffffc0205a26:	32050963          	beqz	a0,ffffffffc0205d58 <do_execve+0x4be>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205a2a:	01893503          	ld	a0,24(s2)
ffffffffc0205a2e:	467d                	li	a2,31
ffffffffc0205a30:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc0205a34:	91dfc0ef          	jal	ra,ffffffffc0202350 <pgdir_alloc_page>
ffffffffc0205a38:	30050063          	beqz	a0,ffffffffc0205d38 <do_execve+0x49e>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205a3c:	01893503          	ld	a0,24(s2)
ffffffffc0205a40:	467d                	li	a2,31
ffffffffc0205a42:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc0205a46:	90bfc0ef          	jal	ra,ffffffffc0202350 <pgdir_alloc_page>
ffffffffc0205a4a:	2c050763          	beqz	a0,ffffffffc0205d18 <do_execve+0x47e>
    mm->mm_count += 1;
ffffffffc0205a4e:	03092783          	lw	a5,48(s2)
    current->mm = mm;
ffffffffc0205a52:	000a3603          	ld	a2,0(s4)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205a56:	01893683          	ld	a3,24(s2)
ffffffffc0205a5a:	2785                	addiw	a5,a5,1
ffffffffc0205a5c:	02f92823          	sw	a5,48(s2)
    current->mm = mm;
ffffffffc0205a60:	03263423          	sd	s2,40(a2) # 100028 <_binary_obj___user_exit_out_size+0xf55b0>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205a64:	c02007b7          	lui	a5,0xc0200
ffffffffc0205a68:	28f6ec63          	bltu	a3,a5,ffffffffc0205d00 <do_execve+0x466>
ffffffffc0205a6c:	000a7797          	auipc	a5,0xa7
ffffffffc0205a70:	9ec78793          	addi	a5,a5,-1556 # ffffffffc02ac458 <va_pa_offset>
ffffffffc0205a74:	639c                	ld	a5,0(a5)
ffffffffc0205a76:	577d                	li	a4,-1
ffffffffc0205a78:	177e                	slli	a4,a4,0x3f
ffffffffc0205a7a:	8e9d                	sub	a3,a3,a5
ffffffffc0205a7c:	00c6d793          	srli	a5,a3,0xc
ffffffffc0205a80:	f654                	sd	a3,168(a2)
ffffffffc0205a82:	8fd9                	or	a5,a5,a4
ffffffffc0205a84:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc0205a88:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0205a8a:	4581                	li	a1,0
ffffffffc0205a8c:	12000613          	li	a2,288
ffffffffc0205a90:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc0205a92:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0205a96:	792000ef          	jal	ra,ffffffffc0206228 <memset>
    tf->epc = elf->e_entry;
ffffffffc0205a9a:	018b3703          	ld	a4,24(s6)
    tf->gpr.sp = USTACKTOP;
ffffffffc0205a9e:	4785                	li	a5,1
    set_proc_name(current, local_name);
ffffffffc0205aa0:	000a3503          	ld	a0,0(s4)
    tf->status = sstatus & ~(SSTATUS_SPP | SSTATUS_SPIE);
ffffffffc0205aa4:	edf4f493          	andi	s1,s1,-289
    tf->gpr.sp = USTACKTOP;
ffffffffc0205aa8:	07fe                	slli	a5,a5,0x1f
ffffffffc0205aaa:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc0205aac:	10e43423          	sd	a4,264(s0)
    tf->status = sstatus & ~(SSTATUS_SPP | SSTATUS_SPIE);
ffffffffc0205ab0:	10943023          	sd	s1,256(s0)
    set_proc_name(current, local_name);
ffffffffc0205ab4:	100c                	addi	a1,sp,32
ffffffffc0205ab6:	c8eff0ef          	jal	ra,ffffffffc0204f44 <set_proc_name>
}
ffffffffc0205aba:	60ea                	ld	ra,152(sp)
ffffffffc0205abc:	644a                	ld	s0,144(sp)
ffffffffc0205abe:	854e                	mv	a0,s3
ffffffffc0205ac0:	64aa                	ld	s1,136(sp)
ffffffffc0205ac2:	690a                	ld	s2,128(sp)
ffffffffc0205ac4:	79e6                	ld	s3,120(sp)
ffffffffc0205ac6:	7a46                	ld	s4,112(sp)
ffffffffc0205ac8:	7aa6                	ld	s5,104(sp)
ffffffffc0205aca:	7b06                	ld	s6,96(sp)
ffffffffc0205acc:	6be6                	ld	s7,88(sp)
ffffffffc0205ace:	6c46                	ld	s8,80(sp)
ffffffffc0205ad0:	6ca6                	ld	s9,72(sp)
ffffffffc0205ad2:	6d06                	ld	s10,64(sp)
ffffffffc0205ad4:	7de2                	ld	s11,56(sp)
ffffffffc0205ad6:	610d                	addi	sp,sp,160
ffffffffc0205ad8:	8082                	ret
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc0205ada:	7410                	ld	a2,40(s0)
ffffffffc0205adc:	701c                	ld	a5,32(s0)
ffffffffc0205ade:	20f66363          	bltu	a2,a5,ffffffffc0205ce4 <do_execve+0x44a>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205ae2:	405c                	lw	a5,4(s0)
ffffffffc0205ae4:	0017f693          	andi	a3,a5,1
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205ae8:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205aec:	068a                	slli	a3,a3,0x2
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205aee:	0e071263          	bnez	a4,ffffffffc0205bd2 <do_execve+0x338>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205af2:	4745                	li	a4,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205af4:	8b91                	andi	a5,a5,4
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205af6:	e03a                	sd	a4,0(sp)
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205af8:	c789                	beqz	a5,ffffffffc0205b02 <do_execve+0x268>
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205afa:	47cd                	li	a5,19
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205afc:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205b00:	e03e                	sd	a5,0(sp)
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205b02:	0026f793          	andi	a5,a3,2
ffffffffc0205b06:	efe1                	bnez	a5,ffffffffc0205bde <do_execve+0x344>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205b08:	0046f793          	andi	a5,a3,4
ffffffffc0205b0c:	c789                	beqz	a5,ffffffffc0205b16 <do_execve+0x27c>
ffffffffc0205b0e:	6782                	ld	a5,0(sp)
ffffffffc0205b10:	0087e793          	ori	a5,a5,8
ffffffffc0205b14:	e03e                	sd	a5,0(sp)
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc0205b16:	680c                	ld	a1,16(s0)
ffffffffc0205b18:	4701                	li	a4,0
ffffffffc0205b1a:	854a                	mv	a0,s2
ffffffffc0205b1c:	ac5fc0ef          	jal	ra,ffffffffc02025e0 <mm_map>
ffffffffc0205b20:	89aa                	mv	s3,a0
ffffffffc0205b22:	e541                	bnez	a0,ffffffffc0205baa <do_execve+0x310>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205b24:	01043b83          	ld	s7,16(s0)
        end = ph->p_va + ph->p_filesz;
ffffffffc0205b28:	02043983          	ld	s3,32(s0)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205b2c:	00843a83          	ld	s5,8(s0)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205b30:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0205b32:	99de                	add	s3,s3,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205b34:	9ada                	add	s5,s5,s6
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205b36:	00fbfc33          	and	s8,s7,a5
        while (start < end) {
ffffffffc0205b3a:	053bef63          	bltu	s7,s3,ffffffffc0205b98 <do_execve+0x2fe>
ffffffffc0205b3e:	aa79                	j	ffffffffc0205cdc <do_execve+0x442>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b40:	6785                	lui	a5,0x1
ffffffffc0205b42:	418b8533          	sub	a0,s7,s8
ffffffffc0205b46:	9c3e                	add	s8,s8,a5
ffffffffc0205b48:	417c0833          	sub	a6,s8,s7
            if (end < la) {
ffffffffc0205b4c:	0189f463          	bleu	s8,s3,ffffffffc0205b54 <do_execve+0x2ba>
                size -= la - end;
ffffffffc0205b50:	41798833          	sub	a6,s3,s7
    return page - pages + nbase;
ffffffffc0205b54:	000db683          	ld	a3,0(s11)
ffffffffc0205b58:	000d3583          	ld	a1,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205b5c:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205b5e:	40d486b3          	sub	a3,s1,a3
ffffffffc0205b62:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205b64:	000cb603          	ld	a2,0(s9)
    return page - pages + nbase;
ffffffffc0205b68:	96ae                	add	a3,a3,a1
    return KADDR(page2pa(page));
ffffffffc0205b6a:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b6e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b70:	16c5fc63          	bleu	a2,a1,ffffffffc0205ce8 <do_execve+0x44e>
ffffffffc0205b74:	000a7797          	auipc	a5,0xa7
ffffffffc0205b78:	8e478793          	addi	a5,a5,-1820 # ffffffffc02ac458 <va_pa_offset>
ffffffffc0205b7c:	0007b883          	ld	a7,0(a5)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205b80:	85d6                	mv	a1,s5
ffffffffc0205b82:	8642                	mv	a2,a6
ffffffffc0205b84:	96c6                	add	a3,a3,a7
ffffffffc0205b86:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205b88:	9bc2                	add	s7,s7,a6
ffffffffc0205b8a:	e842                	sd	a6,16(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205b8c:	6ae000ef          	jal	ra,ffffffffc020623a <memcpy>
            start += size, from += size;
ffffffffc0205b90:	6842                	ld	a6,16(sp)
ffffffffc0205b92:	9ac2                	add	s5,s5,a6
        while (start < end) {
ffffffffc0205b94:	053bf863          	bleu	s3,s7,ffffffffc0205be4 <do_execve+0x34a>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b98:	01893503          	ld	a0,24(s2)
ffffffffc0205b9c:	6602                	ld	a2,0(sp)
ffffffffc0205b9e:	85e2                	mv	a1,s8
ffffffffc0205ba0:	fb0fc0ef          	jal	ra,ffffffffc0202350 <pgdir_alloc_page>
ffffffffc0205ba4:	84aa                	mv	s1,a0
ffffffffc0205ba6:	fd49                	bnez	a0,ffffffffc0205b40 <do_execve+0x2a6>
        ret = -E_NO_MEM;
ffffffffc0205ba8:	59f1                	li	s3,-4
    exit_mmap(mm);
ffffffffc0205baa:	854a                	mv	a0,s2
ffffffffc0205bac:	b83fc0ef          	jal	ra,ffffffffc020272e <exit_mmap>
    put_pgdir(mm);
ffffffffc0205bb0:	854a                	mv	a0,s2
ffffffffc0205bb2:	a88ff0ef          	jal	ra,ffffffffc0204e3a <put_pgdir>
    mm_destroy(mm);
ffffffffc0205bb6:	854a                	mv	a0,s2
ffffffffc0205bb8:	9d7fc0ef          	jal	ra,ffffffffc020258e <mm_destroy>
    return ret;
ffffffffc0205bbc:	b355                	j	ffffffffc0205960 <do_execve+0xc6>
            exit_mmap(mm);
ffffffffc0205bbe:	854a                	mv	a0,s2
ffffffffc0205bc0:	b6ffc0ef          	jal	ra,ffffffffc020272e <exit_mmap>
            put_pgdir(mm);
ffffffffc0205bc4:	854a                	mv	a0,s2
ffffffffc0205bc6:	a74ff0ef          	jal	ra,ffffffffc0204e3a <put_pgdir>
            mm_destroy(mm);
ffffffffc0205bca:	854a                	mv	a0,s2
ffffffffc0205bcc:	9c3fc0ef          	jal	ra,ffffffffc020258e <mm_destroy>
ffffffffc0205bd0:	bbb1                	j	ffffffffc020592c <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205bd2:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205bd6:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205bd8:	2681                	sext.w	a3,a3
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205bda:	f20790e3          	bnez	a5,ffffffffc0205afa <do_execve+0x260>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205bde:	47dd                	li	a5,23
ffffffffc0205be0:	e03e                	sd	a5,0(sp)
ffffffffc0205be2:	b71d                	j	ffffffffc0205b08 <do_execve+0x26e>
ffffffffc0205be4:	01043983          	ld	s3,16(s0)
        end = ph->p_va + ph->p_memsz;
ffffffffc0205be8:	7414                	ld	a3,40(s0)
ffffffffc0205bea:	99b6                	add	s3,s3,a3
        if (start < la) {
ffffffffc0205bec:	098bf163          	bleu	s8,s7,ffffffffc0205c6e <do_execve+0x3d4>
            if (start == end) {
ffffffffc0205bf0:	df798ae3          	beq	s3,s7,ffffffffc02059e4 <do_execve+0x14a>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205bf4:	6505                	lui	a0,0x1
ffffffffc0205bf6:	955e                	add	a0,a0,s7
ffffffffc0205bf8:	41850533          	sub	a0,a0,s8
                size -= la - end;
ffffffffc0205bfc:	41798ab3          	sub	s5,s3,s7
            if (end < la) {
ffffffffc0205c00:	0d89fb63          	bleu	s8,s3,ffffffffc0205cd6 <do_execve+0x43c>
    return page - pages + nbase;
ffffffffc0205c04:	000db683          	ld	a3,0(s11)
ffffffffc0205c08:	000d3583          	ld	a1,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205c0c:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205c0e:	40d486b3          	sub	a3,s1,a3
ffffffffc0205c12:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205c14:	000cb603          	ld	a2,0(s9)
    return page - pages + nbase;
ffffffffc0205c18:	96ae                	add	a3,a3,a1
    return KADDR(page2pa(page));
ffffffffc0205c1a:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205c1e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205c20:	0cc5f463          	bleu	a2,a1,ffffffffc0205ce8 <do_execve+0x44e>
ffffffffc0205c24:	000a7617          	auipc	a2,0xa7
ffffffffc0205c28:	83460613          	addi	a2,a2,-1996 # ffffffffc02ac458 <va_pa_offset>
ffffffffc0205c2c:	00063803          	ld	a6,0(a2)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205c30:	4581                	li	a1,0
ffffffffc0205c32:	8656                	mv	a2,s5
ffffffffc0205c34:	96c2                	add	a3,a3,a6
ffffffffc0205c36:	9536                	add	a0,a0,a3
ffffffffc0205c38:	5f0000ef          	jal	ra,ffffffffc0206228 <memset>
            start += size;
ffffffffc0205c3c:	017a8733          	add	a4,s5,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205c40:	0389f463          	bleu	s8,s3,ffffffffc0205c68 <do_execve+0x3ce>
ffffffffc0205c44:	dae980e3          	beq	s3,a4,ffffffffc02059e4 <do_execve+0x14a>
ffffffffc0205c48:	00003697          	auipc	a3,0x3
ffffffffc0205c4c:	86068693          	addi	a3,a3,-1952 # ffffffffc02084a8 <default_pmm_manager+0xd0>
ffffffffc0205c50:	00001617          	auipc	a2,0x1
ffffffffc0205c54:	06860613          	addi	a2,a2,104 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205c58:	26200593          	li	a1,610
ffffffffc0205c5c:	00003517          	auipc	a0,0x3
ffffffffc0205c60:	c7c50513          	addi	a0,a0,-900 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205c64:	db2fa0ef          	jal	ra,ffffffffc0200216 <__panic>
ffffffffc0205c68:	ff8710e3          	bne	a4,s8,ffffffffc0205c48 <do_execve+0x3ae>
ffffffffc0205c6c:	8be2                	mv	s7,s8
ffffffffc0205c6e:	000a6a97          	auipc	s5,0xa6
ffffffffc0205c72:	7eaa8a93          	addi	s5,s5,2026 # ffffffffc02ac458 <va_pa_offset>
        while (start < end) {
ffffffffc0205c76:	053be763          	bltu	s7,s3,ffffffffc0205cc4 <do_execve+0x42a>
ffffffffc0205c7a:	b3ad                	j	ffffffffc02059e4 <do_execve+0x14a>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205c7c:	6785                	lui	a5,0x1
ffffffffc0205c7e:	418b8533          	sub	a0,s7,s8
ffffffffc0205c82:	9c3e                	add	s8,s8,a5
ffffffffc0205c84:	417c0633          	sub	a2,s8,s7
            if (end < la) {
ffffffffc0205c88:	0189f463          	bleu	s8,s3,ffffffffc0205c90 <do_execve+0x3f6>
                size -= la - end;
ffffffffc0205c8c:	41798633          	sub	a2,s3,s7
    return page - pages + nbase;
ffffffffc0205c90:	000db683          	ld	a3,0(s11)
ffffffffc0205c94:	000d3803          	ld	a6,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205c98:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205c9a:	40d486b3          	sub	a3,s1,a3
ffffffffc0205c9e:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205ca0:	000cb583          	ld	a1,0(s9)
    return page - pages + nbase;
ffffffffc0205ca4:	96c2                	add	a3,a3,a6
    return KADDR(page2pa(page));
ffffffffc0205ca6:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205caa:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205cac:	02b87e63          	bleu	a1,a6,ffffffffc0205ce8 <do_execve+0x44e>
ffffffffc0205cb0:	000ab803          	ld	a6,0(s5)
            start += size;
ffffffffc0205cb4:	9bb2                	add	s7,s7,a2
            memset(page2kva(page) + off, 0, size);
ffffffffc0205cb6:	4581                	li	a1,0
ffffffffc0205cb8:	96c2                	add	a3,a3,a6
ffffffffc0205cba:	9536                	add	a0,a0,a3
ffffffffc0205cbc:	56c000ef          	jal	ra,ffffffffc0206228 <memset>
        while (start < end) {
ffffffffc0205cc0:	d33bf2e3          	bleu	s3,s7,ffffffffc02059e4 <do_execve+0x14a>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205cc4:	01893503          	ld	a0,24(s2)
ffffffffc0205cc8:	6602                	ld	a2,0(sp)
ffffffffc0205cca:	85e2                	mv	a1,s8
ffffffffc0205ccc:	e84fc0ef          	jal	ra,ffffffffc0202350 <pgdir_alloc_page>
ffffffffc0205cd0:	84aa                	mv	s1,a0
ffffffffc0205cd2:	f54d                	bnez	a0,ffffffffc0205c7c <do_execve+0x3e2>
ffffffffc0205cd4:	bdd1                	j	ffffffffc0205ba8 <do_execve+0x30e>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205cd6:	417c0ab3          	sub	s5,s8,s7
ffffffffc0205cda:	b72d                	j	ffffffffc0205c04 <do_execve+0x36a>
        while (start < end) {
ffffffffc0205cdc:	89de                	mv	s3,s7
ffffffffc0205cde:	b729                	j	ffffffffc0205be8 <do_execve+0x34e>
        return -E_INVAL;
ffffffffc0205ce0:	59f5                	li	s3,-3
ffffffffc0205ce2:	bbe1                	j	ffffffffc0205aba <do_execve+0x220>
            ret = -E_INVAL_ELF;
ffffffffc0205ce4:	59e1                	li	s3,-8
ffffffffc0205ce6:	b5d1                	j	ffffffffc0205baa <do_execve+0x310>
ffffffffc0205ce8:	00001617          	auipc	a2,0x1
ffffffffc0205cec:	3b860613          	addi	a2,a2,952 # ffffffffc02070a0 <commands+0x8c8>
ffffffffc0205cf0:	06900593          	li	a1,105
ffffffffc0205cf4:	00001517          	auipc	a0,0x1
ffffffffc0205cf8:	40450513          	addi	a0,a0,1028 # ffffffffc02070f8 <commands+0x920>
ffffffffc0205cfc:	d1afa0ef          	jal	ra,ffffffffc0200216 <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205d00:	00001617          	auipc	a2,0x1
ffffffffc0205d04:	47860613          	addi	a2,a2,1144 # ffffffffc0207178 <commands+0x9a0>
ffffffffc0205d08:	27d00593          	li	a1,637
ffffffffc0205d0c:	00003517          	auipc	a0,0x3
ffffffffc0205d10:	bcc50513          	addi	a0,a0,-1076 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205d14:	d02fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205d18:	00003697          	auipc	a3,0x3
ffffffffc0205d1c:	8a868693          	addi	a3,a3,-1880 # ffffffffc02085c0 <default_pmm_manager+0x1e8>
ffffffffc0205d20:	00001617          	auipc	a2,0x1
ffffffffc0205d24:	f9860613          	addi	a2,a2,-104 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205d28:	27800593          	li	a1,632
ffffffffc0205d2c:	00003517          	auipc	a0,0x3
ffffffffc0205d30:	bac50513          	addi	a0,a0,-1108 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205d34:	ce2fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205d38:	00003697          	auipc	a3,0x3
ffffffffc0205d3c:	84068693          	addi	a3,a3,-1984 # ffffffffc0208578 <default_pmm_manager+0x1a0>
ffffffffc0205d40:	00001617          	auipc	a2,0x1
ffffffffc0205d44:	f7860613          	addi	a2,a2,-136 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205d48:	27700593          	li	a1,631
ffffffffc0205d4c:	00003517          	auipc	a0,0x3
ffffffffc0205d50:	b8c50513          	addi	a0,a0,-1140 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205d54:	cc2fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205d58:	00002697          	auipc	a3,0x2
ffffffffc0205d5c:	7d868693          	addi	a3,a3,2008 # ffffffffc0208530 <default_pmm_manager+0x158>
ffffffffc0205d60:	00001617          	auipc	a2,0x1
ffffffffc0205d64:	f5860613          	addi	a2,a2,-168 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205d68:	27600593          	li	a1,630
ffffffffc0205d6c:	00003517          	auipc	a0,0x3
ffffffffc0205d70:	b6c50513          	addi	a0,a0,-1172 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205d74:	ca2fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205d78:	00002697          	auipc	a3,0x2
ffffffffc0205d7c:	77068693          	addi	a3,a3,1904 # ffffffffc02084e8 <default_pmm_manager+0x110>
ffffffffc0205d80:	00001617          	auipc	a2,0x1
ffffffffc0205d84:	f3860613          	addi	a2,a2,-200 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205d88:	27500593          	li	a1,629
ffffffffc0205d8c:	00003517          	auipc	a0,0x3
ffffffffc0205d90:	b4c50513          	addi	a0,a0,-1204 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205d94:	c82fa0ef          	jal	ra,ffffffffc0200216 <__panic>

ffffffffc0205d98 <do_yield>:
    current->need_resched = 1;
ffffffffc0205d98:	000a6797          	auipc	a5,0xa6
ffffffffc0205d9c:	69078793          	addi	a5,a5,1680 # ffffffffc02ac428 <current>
ffffffffc0205da0:	639c                	ld	a5,0(a5)
ffffffffc0205da2:	4705                	li	a4,1
}
ffffffffc0205da4:	4501                	li	a0,0
    current->need_resched = 1;
ffffffffc0205da6:	ef98                	sd	a4,24(a5)
}
ffffffffc0205da8:	8082                	ret

ffffffffc0205daa <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205daa:	1101                	addi	sp,sp,-32
ffffffffc0205dac:	e822                	sd	s0,16(sp)
ffffffffc0205dae:	e426                	sd	s1,8(sp)
ffffffffc0205db0:	ec06                	sd	ra,24(sp)
ffffffffc0205db2:	842e                	mv	s0,a1
ffffffffc0205db4:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205db6:	cd81                	beqz	a1,ffffffffc0205dce <do_wait+0x24>
    struct mm_struct *mm = current->mm;
ffffffffc0205db8:	000a6797          	auipc	a5,0xa6
ffffffffc0205dbc:	67078793          	addi	a5,a5,1648 # ffffffffc02ac428 <current>
ffffffffc0205dc0:	639c                	ld	a5,0(a5)
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205dc2:	4685                	li	a3,1
ffffffffc0205dc4:	4611                	li	a2,4
ffffffffc0205dc6:	7788                	ld	a0,40(a5)
ffffffffc0205dc8:	808fd0ef          	jal	ra,ffffffffc0202dd0 <user_mem_check>
ffffffffc0205dcc:	c909                	beqz	a0,ffffffffc0205dde <do_wait+0x34>
ffffffffc0205dce:	85a2                	mv	a1,s0
}
ffffffffc0205dd0:	6442                	ld	s0,16(sp)
ffffffffc0205dd2:	60e2                	ld	ra,24(sp)
ffffffffc0205dd4:	8526                	mv	a0,s1
ffffffffc0205dd6:	64a2                	ld	s1,8(sp)
ffffffffc0205dd8:	6105                	addi	sp,sp,32
ffffffffc0205dda:	ff0ff06f          	j	ffffffffc02055ca <do_wait.part.1>
ffffffffc0205dde:	60e2                	ld	ra,24(sp)
ffffffffc0205de0:	6442                	ld	s0,16(sp)
ffffffffc0205de2:	64a2                	ld	s1,8(sp)
ffffffffc0205de4:	5575                	li	a0,-3
ffffffffc0205de6:	6105                	addi	sp,sp,32
ffffffffc0205de8:	8082                	ret

ffffffffc0205dea <do_kill>:
do_kill(int pid) {
ffffffffc0205dea:	1141                	addi	sp,sp,-16
ffffffffc0205dec:	e406                	sd	ra,8(sp)
ffffffffc0205dee:	e022                	sd	s0,0(sp)
    if ((proc = find_proc(pid)) != NULL) {
ffffffffc0205df0:	9eaff0ef          	jal	ra,ffffffffc0204fda <find_proc>
ffffffffc0205df4:	cd0d                	beqz	a0,ffffffffc0205e2e <do_kill+0x44>
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205df6:	0b052703          	lw	a4,176(a0)
ffffffffc0205dfa:	00177693          	andi	a3,a4,1
ffffffffc0205dfe:	e695                	bnez	a3,ffffffffc0205e2a <do_kill+0x40>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205e00:	0ec52683          	lw	a3,236(a0)
            proc->flags |= PF_EXITING;
ffffffffc0205e04:	00176713          	ori	a4,a4,1
ffffffffc0205e08:	0ae52823          	sw	a4,176(a0)
            return 0;
ffffffffc0205e0c:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205e0e:	0006c763          	bltz	a3,ffffffffc0205e1c <do_kill+0x32>
}
ffffffffc0205e12:	8522                	mv	a0,s0
ffffffffc0205e14:	60a2                	ld	ra,8(sp)
ffffffffc0205e16:	6402                	ld	s0,0(sp)
ffffffffc0205e18:	0141                	addi	sp,sp,16
ffffffffc0205e1a:	8082                	ret
                wakeup_proc(proc);
ffffffffc0205e1c:	17c000ef          	jal	ra,ffffffffc0205f98 <wakeup_proc>
}
ffffffffc0205e20:	8522                	mv	a0,s0
ffffffffc0205e22:	60a2                	ld	ra,8(sp)
...
ffffffffc0205e2c:	b7dd                	j	ffffffffc0205e12 <do_kill+0x28>
    return -E_INVAL;
ffffffffc0205e2e:	5475                	li	s0,-3
ffffffffc0205e30:	b7cd                	j	ffffffffc0205e12 <do_kill+0x28>

ffffffffc0205e32 <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc0205e32:	000a6797          	auipc	a5,0xa6
ffffffffc0205e36:	73678793          	addi	a5,a5,1846 # ffffffffc02ac568 <proc_list>

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205e3a:	1101                	addi	sp,sp,-32
ffffffffc0205e3c:	000a6717          	auipc	a4,0xa6
ffffffffc0205e40:	72f73a23          	sd	a5,1844(a4) # ffffffffc02ac570 <proc_list+0x8>
ffffffffc0205e44:	000a6717          	auipc	a4,0xa6
ffffffffc0205e48:	72f73223          	sd	a5,1828(a4) # ffffffffc02ac568 <proc_list>
ffffffffc0205e4c:	ec06                	sd	ra,24(sp)
ffffffffc0205e4e:	e822                	sd	s0,16(sp)
ffffffffc0205e50:	e426                	sd	s1,8(sp)
ffffffffc0205e52:	000a2797          	auipc	a5,0xa2
ffffffffc0205e56:	59678793          	addi	a5,a5,1430 # ffffffffc02a83e8 <hash_list>
ffffffffc0205e5a:	000a6717          	auipc	a4,0xa6
ffffffffc0205e5e:	58e70713          	addi	a4,a4,1422 # ffffffffc02ac3e8 <is_panic>
ffffffffc0205e62:	e79c                	sd	a5,8(a5)
ffffffffc0205e64:	e39c                	sd	a5,0(a5)
ffffffffc0205e66:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205e68:	fee79de3          	bne	a5,a4,ffffffffc0205e62 <proc_init+0x30>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205e6c:	ec9fe0ef          	jal	ra,ffffffffc0204d34 <alloc_proc>
ffffffffc0205e70:	000a6717          	auipc	a4,0xa6
ffffffffc0205e74:	5ca73023          	sd	a0,1472(a4) # ffffffffc02ac430 <idleproc>
ffffffffc0205e78:	000a6497          	auipc	s1,0xa6
ffffffffc0205e7c:	5b848493          	addi	s1,s1,1464 # ffffffffc02ac430 <idleproc>
ffffffffc0205e80:	c559                	beqz	a0,ffffffffc0205f0e <proc_init+0xdc>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205e82:	4709                	li	a4,2
ffffffffc0205e84:	e118                	sd	a4,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
    idleproc->need_resched = 1;
ffffffffc0205e86:	4405                	li	s0,1
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205e88:	00003717          	auipc	a4,0x3
ffffffffc0205e8c:	17870713          	addi	a4,a4,376 # ffffffffc0209000 <bootstack>
    set_proc_name(idleproc, "idle");
ffffffffc0205e90:	00003597          	auipc	a1,0x3
ffffffffc0205e94:	96058593          	addi	a1,a1,-1696 # ffffffffc02087f0 <default_pmm_manager+0x418>
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205e98:	e918                	sd	a4,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205e9a:	ed00                	sd	s0,24(a0)
    set_proc_name(idleproc, "idle");
ffffffffc0205e9c:	8a8ff0ef          	jal	ra,ffffffffc0204f44 <set_proc_name>
    nr_process ++;
ffffffffc0205ea0:	000a6797          	auipc	a5,0xa6
ffffffffc0205ea4:	5a078793          	addi	a5,a5,1440 # ffffffffc02ac440 <nr_process>
ffffffffc0205ea8:	439c                	lw	a5,0(a5)

    current = idleproc;
ffffffffc0205eaa:	6098                	ld	a4,0(s1)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205eac:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205eae:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205eb0:	4581                	li	a1,0
ffffffffc0205eb2:	00000517          	auipc	a0,0x0
ffffffffc0205eb6:	8c050513          	addi	a0,a0,-1856 # ffffffffc0205772 <init_main>
    nr_process ++;
ffffffffc0205eba:	000a6697          	auipc	a3,0xa6
ffffffffc0205ebe:	58f6a323          	sw	a5,1414(a3) # ffffffffc02ac440 <nr_process>
    current = idleproc;
ffffffffc0205ec2:	000a6797          	auipc	a5,0xa6
ffffffffc0205ec6:	56e7b323          	sd	a4,1382(a5) # ffffffffc02ac428 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205eca:	d62ff0ef          	jal	ra,ffffffffc020542c <kernel_thread>
    if (pid <= 0) {
ffffffffc0205ece:	08a05c63          	blez	a0,ffffffffc0205f66 <proc_init+0x134>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205ed2:	908ff0ef          	jal	ra,ffffffffc0204fda <find_proc>
    set_proc_name(initproc, "init");
ffffffffc0205ed6:	00003597          	auipc	a1,0x3
ffffffffc0205eda:	94258593          	addi	a1,a1,-1726 # ffffffffc0208818 <default_pmm_manager+0x440>
    initproc = find_proc(pid);
ffffffffc0205ede:	000a6797          	auipc	a5,0xa6
ffffffffc0205ee2:	54a7bd23          	sd	a0,1370(a5) # ffffffffc02ac438 <initproc>
    set_proc_name(initproc, "init");
ffffffffc0205ee6:	85eff0ef          	jal	ra,ffffffffc0204f44 <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205eea:	609c                	ld	a5,0(s1)
ffffffffc0205eec:	cfa9                	beqz	a5,ffffffffc0205f46 <proc_init+0x114>
ffffffffc0205eee:	43dc                	lw	a5,4(a5)
ffffffffc0205ef0:	ebb9                	bnez	a5,ffffffffc0205f46 <proc_init+0x114>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205ef2:	000a6797          	auipc	a5,0xa6
ffffffffc0205ef6:	54678793          	addi	a5,a5,1350 # ffffffffc02ac438 <initproc>
ffffffffc0205efa:	639c                	ld	a5,0(a5)
ffffffffc0205efc:	c78d                	beqz	a5,ffffffffc0205f26 <proc_init+0xf4>
ffffffffc0205efe:	43dc                	lw	a5,4(a5)
ffffffffc0205f00:	02879363          	bne	a5,s0,ffffffffc0205f26 <proc_init+0xf4>
}
ffffffffc0205f04:	60e2                	ld	ra,24(sp)
ffffffffc0205f06:	6442                	ld	s0,16(sp)
ffffffffc0205f08:	64a2                	ld	s1,8(sp)
ffffffffc0205f0a:	6105                	addi	sp,sp,32
ffffffffc0205f0c:	8082                	ret
        panic("cannot alloc idleproc.\n");
ffffffffc0205f0e:	00003617          	auipc	a2,0x3
ffffffffc0205f12:	8ca60613          	addi	a2,a2,-1846 # ffffffffc02087d8 <default_pmm_manager+0x400>
ffffffffc0205f16:	37400593          	li	a1,884
ffffffffc0205f1a:	00003517          	auipc	a0,0x3
ffffffffc0205f1e:	9be50513          	addi	a0,a0,-1602 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205f22:	af4fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205f26:	00003697          	auipc	a3,0x3
ffffffffc0205f2a:	92268693          	addi	a3,a3,-1758 # ffffffffc0208848 <default_pmm_manager+0x470>
ffffffffc0205f2e:	00001617          	auipc	a2,0x1
ffffffffc0205f32:	d8a60613          	addi	a2,a2,-630 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205f36:	38900593          	li	a1,905
ffffffffc0205f3a:	00003517          	auipc	a0,0x3
ffffffffc0205f3e:	99e50513          	addi	a0,a0,-1634 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205f42:	ad4fa0ef          	jal	ra,ffffffffc0200216 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205f46:	00003697          	auipc	a3,0x3
ffffffffc0205f4a:	8da68693          	addi	a3,a3,-1830 # ffffffffc0208820 <default_pmm_manager+0x448>
ffffffffc0205f4e:	00001617          	auipc	a2,0x1
ffffffffc0205f52:	d6a60613          	addi	a2,a2,-662 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0205f56:	38800593          	li	a1,904
ffffffffc0205f5a:	00003517          	auipc	a0,0x3
ffffffffc0205f5e:	97e50513          	addi	a0,a0,-1666 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205f62:	ab4fa0ef          	jal	ra,ffffffffc0200216 <__panic>
        panic("create init_main failed.\n");
ffffffffc0205f66:	00003617          	auipc	a2,0x3
ffffffffc0205f6a:	89260613          	addi	a2,a2,-1902 # ffffffffc02087f8 <default_pmm_manager+0x420>
ffffffffc0205f6e:	38200593          	li	a1,898
ffffffffc0205f72:	00003517          	auipc	a0,0x3
ffffffffc0205f76:	96650513          	addi	a0,a0,-1690 # ffffffffc02088d8 <default_pmm_manager+0x500>
ffffffffc0205f7a:	a9cfa0ef          	jal	ra,ffffffffc0200216 <__panic>

ffffffffc0205f7e <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205f7e:	1141                	addi	sp,sp,-16
ffffffffc0205f80:	e022                	sd	s0,0(sp)
ffffffffc0205f82:	e406                	sd	ra,8(sp)
ffffffffc0205f84:	000a6417          	auipc	s0,0xa6
ffffffffc0205f88:	4a440413          	addi	s0,s0,1188 # ffffffffc02ac428 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205f8c:	6018                	ld	a4,0(s0)
ffffffffc0205f8e:	6f1c                	ld	a5,24(a4)
ffffffffc0205f90:	dffd                	beqz	a5,ffffffffc0205f8e <cpu_idle+0x10>
            schedule();
ffffffffc0205f92:	082000ef          	jal	ra,ffffffffc0206014 <schedule>
ffffffffc0205f96:	bfdd                	j	ffffffffc0205f8c <cpu_idle+0xe>

ffffffffc0205f98 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
wakeup_proc(struct proc_struct *proc) {
ffffffffc0205f9a:	1101                	addi	sp,sp,-32
ffffffffc0205f9c:	ec06                	sd	ra,24(sp)
ffffffffc0205f9e:	e822                	sd	s0,16(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205fa0:	478d                	li	a5,3
ffffffffc0205fa2:	04f70a63          	beq	a4,a5,ffffffffc0205ff6 <wakeup_proc+0x5e>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0205fac:	4401                	li	s0,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205fae:	ef8d                	bnez	a5,ffffffffc0205fe8 <wakeup_proc+0x50>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205fb0:	4789                	li	a5,2
ffffffffc0205fb2:	00f70f63          	beq	a4,a5,ffffffffc0205fd0 <wakeup_proc+0x38>
            proc->state = PROC_RUNNABLE;
ffffffffc0205fb6:	c11c                	sw	a5,0(a0)
            proc->wait_state = 0;
ffffffffc0205fb8:	0e052623          	sw	zero,236(a0)
    if (flag) {
ffffffffc0205fbc:	e409                	bnez	s0,ffffffffc0205fc6 <wakeup_proc+0x2e>
        else {
...
ffffffffc0205fc0:	6442                	ld	s0,16(sp)
ffffffffc0205fc2:	6105                	addi	sp,sp,32
ffffffffc0205fc4:	8082                	ret
ffffffffc0205fc6:	6442                	ld	s0,16(sp)
ffffffffc0205fc8:	60e2                	ld	ra,24(sp)
ffffffffc0205fca:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205fcc:	e8afa06f          	j	ffffffffc0200656 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205fd0:	00003617          	auipc	a2,0x3
ffffffffc0205fd4:	95860613          	addi	a2,a2,-1704 # ffffffffc0208928 <default_pmm_manager+0x550>
ffffffffc0205fd8:	45c9                	li	a1,18
ffffffffc0205fda:	00003517          	auipc	a0,0x3
ffffffffc0205fde:	93650513          	addi	a0,a0,-1738 # ffffffffc0208910 <default_pmm_manager+0x538>
ffffffffc0205fe2:	aa0fa0ef          	jal	ra,ffffffffc0200282 <__warn>
ffffffffc0205fe6:	bfd9                	j	ffffffffc0205fbc <wakeup_proc+0x24>
ffffffffc0205fe8:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0205fea:	e72fa0ef          	jal	ra,ffffffffc020065c <intr_disable>
        return 1;
ffffffffc0205fee:	6522                	ld	a0,8(sp)
ffffffffc0205ff0:	4405                	li	s0,1
ffffffffc0205ff2:	4118                	lw	a4,0(a0)
ffffffffc0205ff4:	bf75                	j	ffffffffc0205fb0 <wakeup_proc+0x18>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205ff6:	00003697          	auipc	a3,0x3
ffffffffc0205ffa:	8fa68693          	addi	a3,a3,-1798 # ffffffffc02088f0 <default_pmm_manager+0x518>
ffffffffc0205ffe:	00001617          	auipc	a2,0x1
ffffffffc0206002:	cba60613          	addi	a2,a2,-838 # ffffffffc0206cb8 <commands+0x4e0>
ffffffffc0206006:	45a5                	li	a1,9
ffffffffc0206008:	00003517          	auipc	a0,0x3
ffffffffc020600c:	90850513          	addi	a0,a0,-1784 # ffffffffc0208910 <default_pmm_manager+0x538>
ffffffffc0206010:	a06fa0ef          	jal	ra,ffffffffc0200216 <__panic>

ffffffffc0206014 <schedule>:

void
schedule(void) {
ffffffffc0206014:	1141                	addi	sp,sp,-16
ffffffffc0206016:	e406                	sd	ra,8(sp)
ffffffffc0206018:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020601a:	100027f3          	csrr	a5,sstatus
ffffffffc020601e:	8b89                	andi	a5,a5,2
ffffffffc0206020:	4401                	li	s0,0
ffffffffc0206022:	e3d1                	bnez	a5,ffffffffc02060a6 <schedule+0x92>
    bool intr_flag;
...
ffffffffc0206024:	000a6797          	auipc	a5,0xa6
ffffffffc0206028:	40478793          	addi	a5,a5,1028 # ffffffffc02ac428 <current>
ffffffffc020602c:	0007b883          	ld	a7,0(a5)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206030:	000a6797          	auipc	a5,0xa6
ffffffffc0206034:	40078793          	addi	a5,a5,1024 # ffffffffc02ac430 <idleproc>
ffffffffc0206038:	6388                	ld	a0,0(a5)
        current->need_resched = 0;
ffffffffc020603a:	0008bc23          	sd	zero,24(a7) # 2018 <_binary_obj___user_faultread_out_size-0x7558>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020603e:	04a88e63          	beq	a7,a0,ffffffffc020609a <schedule+0x86>
ffffffffc0206042:	0c888693          	addi	a3,a7,200
ffffffffc0206046:	000a6617          	auipc	a2,0xa6
ffffffffc020604a:	52260613          	addi	a2,a2,1314 # ffffffffc02ac568 <proc_list>
        le = last;
ffffffffc020604e:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0206052:	4809                	li	a6,2
    return listelm->next;
ffffffffc0206054:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0206056:	00c78863          	beq	a5,a2,ffffffffc0206066 <schedule+0x52>
                if (next->state == PROC_RUNNABLE) {
ffffffffc020605a:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc020605e:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0206062:	01070463          	beq	a4,a6,ffffffffc020606a <schedule+0x56>
                    break;
                }
            }
        } while (le != last);
ffffffffc0206066:	fef697e3          	bne	a3,a5,ffffffffc0206054 <schedule+0x40>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020606a:	c589                	beqz	a1,ffffffffc0206074 <schedule+0x60>
ffffffffc020606c:	4198                	lw	a4,0(a1)
ffffffffc020606e:	4789                	li	a5,2
ffffffffc0206070:	00f70e63          	beq	a4,a5,ffffffffc020608c <schedule+0x78>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0206074:	451c                	lw	a5,8(a0)
ffffffffc0206076:	2785                	addiw	a5,a5,1
ffffffffc0206078:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc020607a:	00a88463          	beq	a7,a0,ffffffffc0206082 <schedule+0x6e>
            proc_run(next);
ffffffffc020607e:	ef1fe0ef          	jal	ra,ffffffffc0204f6e <proc_run>
    if (flag) {
ffffffffc0206082:	e419                	bnez	s0,ffffffffc0206090 <schedule+0x7c>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc020608a:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020608c:	852e                	mv	a0,a1
ffffffffc020608e:	b7dd                	j	ffffffffc0206074 <schedule+0x60>
}
ffffffffc0206090:	6402                	ld	s0,0(sp)
ffffffffc0206092:	60a2                	ld	ra,8(sp)
ffffffffc0206094:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0206096:	dc0fa06f          	j	ffffffffc0200656 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020609a:	000a6617          	auipc	a2,0xa6
ffffffffc020609e:	4ce60613          	addi	a2,a2,1230 # ffffffffc02ac568 <proc_list>
ffffffffc02060a2:	86b2                	mv	a3,a2
ffffffffc02060a4:	b76d                	j	ffffffffc020604e <schedule+0x3a>
        intr_disable();
ffffffffc02060a6:	db6fa0ef          	jal	ra,ffffffffc020065c <intr_disable>
        return 1;
ffffffffc02060aa:	4405                	li	s0,1
ffffffffc02060ac:	bfa5                	j	ffffffffc0206024 <schedule+0x10>

ffffffffc02060ae <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc02060ae:	000a6797          	auipc	a5,0xa6
ffffffffc02060b2:	37a78793          	addi	a5,a5,890 # ffffffffc02ac428 <current>
ffffffffc02060b6:	639c                	ld	a5,0(a5)
}
ffffffffc02060b8:	43c8                	lw	a0,4(a5)
ffffffffc02060ba:	8082                	ret

ffffffffc02060bc <sys_pgdir>:
...
ffffffffc02060bc:	4501                	li	a0,0
ffffffffc02060be:	8082                	ret

ffffffffc02060c0 <sys_putc>:
    cputchar(c);
...
ffffffffc02060c4:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc02060c6:	83efa0ef          	jal	ra,ffffffffc0200104 <cputchar>
}
ffffffffc02060ca:	60a2                	ld	ra,8(sp)
ffffffffc02060cc:	4501                	li	a0,0
ffffffffc02060ce:	0141                	addi	sp,sp,16
ffffffffc02060d0:	8082                	ret

ffffffffc02060d2 <sys_kill>:
    return do_kill(pid);
ffffffffc02060d2:	4108                	lw	a0,0(a0)
ffffffffc02060d4:	d17ff06f          	j	ffffffffc0205dea <do_kill>

ffffffffc02060d8 <sys_yield>:
    return do_yield();
ffffffffc02060d8:	cc1ff06f          	j	ffffffffc0205d98 <do_yield>

ffffffffc02060dc <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc02060dc:	6d14                	ld	a3,24(a0)
ffffffffc02060de:	6910                	ld	a2,16(a0)
ffffffffc02060e0:	650c                	ld	a1,8(a0)
ffffffffc02060e2:	6108                	ld	a0,0(a0)
ffffffffc02060e4:	fb6ff06f          	j	ffffffffc020589a <do_execve>

ffffffffc02060e8 <sys_wait>:
    return do_wait(pid, store);
ffffffffc02060e8:	650c                	ld	a1,8(a0)
ffffffffc02060ea:	4108                	lw	a0,0(a0)
ffffffffc02060ec:	cbfff06f          	j	ffffffffc0205daa <do_wait>

ffffffffc02060f0 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc02060f0:	000a6797          	auipc	a5,0xa6
ffffffffc02060f4:	33878793          	addi	a5,a5,824 # ffffffffc02ac428 <current>
ffffffffc02060f8:	639c                	ld	a5,0(a5)
    return do_fork(0, stack, tf);
ffffffffc02060fa:	4501                	li	a0,0
    struct trapframe *tf = current->tf;
ffffffffc02060fc:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc02060fe:	6a0c                	ld	a1,16(a2)
ffffffffc0206100:	f37fe06f          	j	ffffffffc0205036 <do_fork>

ffffffffc0206104 <sys_exit>:
    return do_exit(error_code);
ffffffffc0206104:	4108                	lw	a0,0(a0)
ffffffffc0206106:	b76ff06f          	j	ffffffffc020547c <do_exit>

ffffffffc020610a <syscall>:
};
...
void
syscall(void) {
ffffffffc020610a:	715d                	addi	sp,sp,-80
ffffffffc020610c:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc020610e:	000a6497          	auipc	s1,0xa6
ffffffffc0206112:	31a48493          	addi	s1,s1,794 # ffffffffc02ac428 <current>
ffffffffc0206116:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc0206118:	e0a2                	sd	s0,64(sp)
ffffffffc020611a:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc020611c:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc020611e:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc0206120:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc0206122:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc0206126:	0327ee63          	bltu	a5,s2,ffffffffc0206162 <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc020612a:	00391713          	slli	a4,s2,0x3
ffffffffc020612e:	00003797          	auipc	a5,0x3
ffffffffc0206132:	86278793          	addi	a5,a5,-1950 # ffffffffc0208990 <syscalls>
ffffffffc0206136:	97ba                	add	a5,a5,a4
ffffffffc0206138:	639c                	ld	a5,0(a5)
ffffffffc020613a:	c785                	beqz	a5,ffffffffc0206162 <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc020613c:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc020613e:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc0206140:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc0206142:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc0206144:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc0206146:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc0206148:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc020614a:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc020614c:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc020614e:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc0206150:	0028                	addi	a0,sp,8
ffffffffc0206152:	9782                	jalr	a5
ffffffffc0206154:	e828                	sd	a0,80(s0)
        }
    }
    print_trapframe(tf);
...
ffffffffc0206156:	60a6                	ld	ra,72(sp)
ffffffffc0206158:	6406                	ld	s0,64(sp)
ffffffffc020615a:	74e2                	ld	s1,56(sp)
ffffffffc020615c:	7942                	ld	s2,48(sp)
ffffffffc020615e:	6161                	addi	sp,sp,80
ffffffffc0206160:	8082                	ret
    print_trapframe(tf);
ffffffffc0206162:	8522                	mv	a0,s0
ffffffffc0206164:	ee6fa0ef          	jal	ra,ffffffffc020084a <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc0206168:	609c                	ld	a5,0(s1)
ffffffffc020616a:	86ca                	mv	a3,s2
ffffffffc020616c:	00002617          	auipc	a2,0x2
ffffffffc0206170:	7dc60613          	addi	a2,a2,2012 # ffffffffc0208948 <default_pmm_manager+0x570>
ffffffffc0206174:	43d8                	lw	a4,4(a5)
ffffffffc0206176:	06300593          	li	a1,99
ffffffffc020617a:	0b478793          	addi	a5,a5,180
ffffffffc020617e:	00002517          	auipc	a0,0x2
ffffffffc0206182:	7fa50513          	addi	a0,a0,2042 # ffffffffc0208978 <default_pmm_manager+0x5a0>
ffffffffc0206186:	890fa0ef          	jal	ra,ffffffffc0200216 <__panic>

ffffffffc020618a <strlen>:
...
ffffffffc020618e:	cb91                	beqz	a5,ffffffffc02061a2 <strlen+0x18>
    size_t cnt = 0;
ffffffffc0206190:	4781                	li	a5,0
        cnt ++;
ffffffffc0206192:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0206194:	00f50733          	add	a4,a0,a5
ffffffffc0206198:	00074703          	lbu	a4,0(a4)
ffffffffc020619c:	fb7d                	bnez	a4,ffffffffc0206192 <strlen+0x8>
    }
    return cnt;
}
ffffffffc020619e:	853e                	mv	a0,a5
ffffffffc02061a0:	8082                	ret
    size_t cnt = 0;
ffffffffc02061a2:	4781                	li	a5,0
}
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc02061a8:	c185                	beqz	a1,ffffffffc02061c8 <strnlen+0x20>
ffffffffc02061aa:	00054783          	lbu	a5,0(a0)
ffffffffc02061ae:	cf89                	beqz	a5,ffffffffc02061c8 <strnlen+0x20>
    size_t cnt = 0;
ffffffffc02061b0:	4781                	li	a5,0
ffffffffc02061b2:	a021                	j	ffffffffc02061ba <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc02061b4:	00074703          	lbu	a4,0(a4)
ffffffffc02061b8:	c711                	beqz	a4,ffffffffc02061c4 <strnlen+0x1c>
        cnt ++;
ffffffffc02061ba:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02061bc:	00f50733          	add	a4,a0,a5
ffffffffc02061c0:	fef59ae3          	bne	a1,a5,ffffffffc02061b4 <strnlen+0xc>
    }
    return cnt;
}
ffffffffc02061c4:	853e                	mv	a0,a5
ffffffffc02061c6:	8082                	ret
    size_t cnt = 0;
ffffffffc02061c8:	4781                	li	a5,0
}
ffffffffc02061ca:	853e                	mv	a0,a5
ffffffffc02061cc:	8082                	ret

ffffffffc02061ce <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc02061ce:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc02061d0:	0585                	addi	a1,a1,1
ffffffffc02061d2:	fff5c703          	lbu	a4,-1(a1)
ffffffffc02061d6:	0785                	addi	a5,a5,1
ffffffffc02061d8:	fee78fa3          	sb	a4,-1(a5)
ffffffffc02061dc:	fb75                	bnez	a4,ffffffffc02061d0 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc02061e8:	cb91                	beqz	a5,ffffffffc02061fc <strcmp+0x1c>
ffffffffc02061ea:	00e79c63          	bne	a5,a4,ffffffffc0206202 <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc02061ee:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02061f0:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc02061f4:	0585                	addi	a1,a1,1
ffffffffc02061f6:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02061fa:	fbe5                	bnez	a5,ffffffffc02061ea <strcmp+0xa>
    }
...
ffffffffc0206202:	0007851b          	sext.w	a0,a5
ffffffffc0206206:	9d19                	subw	a0,a0,a4
ffffffffc0206208:	8082                	ret

ffffffffc020620a <strchr>:
...
ffffffffc020620e:	cb91                	beqz	a5,ffffffffc0206222 <strchr+0x18>
        if (*s == c) {
ffffffffc0206210:	00b79563          	bne	a5,a1,ffffffffc020621a <strchr+0x10>
ffffffffc0206214:	a809                	j	ffffffffc0206226 <strchr+0x1c>
ffffffffc0206216:	00b78763          	beq	a5,a1,ffffffffc0206224 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc020621a:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020621c:	00054783          	lbu	a5,0(a0)
ffffffffc0206220:	fbfd                	bnez	a5,ffffffffc0206216 <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0206228:	ca01                	beqz	a2,ffffffffc0206238 <memset+0x10>
ffffffffc020622a:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc020622c:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc020622e:	0785                	addi	a5,a5,1
ffffffffc0206230:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0206234:	fec79de3          	bne	a5,a2,ffffffffc020622e <memset+0x6>
    }
    return s;
#endif /* __HAVE_ARCH_MEMSET */
}
ffffffffc0206238:	8082                	ret

ffffffffc020623a <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc020623a:	ca19                	beqz	a2,ffffffffc0206250 <memcpy+0x16>
ffffffffc020623c:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc020623e:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0206240:	0585                	addi	a1,a1,1
ffffffffc0206242:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0206246:	0785                	addi	a5,a5,1
ffffffffc0206248:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc020624c:	fec59ae3          	bne	a1,a2,ffffffffc0206240 <memcpy+0x6>
    }
    return dst;
...
ffffffffc0206252:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206256:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0206258:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020625c:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020625e:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206262:	f022                	sd	s0,32(sp)
ffffffffc0206264:	ec26                	sd	s1,24(sp)
ffffffffc0206266:	e84a                	sd	s2,16(sp)
ffffffffc0206268:	f406                	sd	ra,40(sp)
ffffffffc020626a:	e44e                	sd	s3,8(sp)
ffffffffc020626c:	84aa                	mv	s1,a0
ffffffffc020626e:	892e                	mv	s2,a1
ffffffffc0206270:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0206274:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc0206276:	03067e63          	bleu	a6,a2,ffffffffc02062b2 <printnum+0x60>
ffffffffc020627a:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc020627c:	00805763          	blez	s0,ffffffffc020628a <printnum+0x38>
ffffffffc0206280:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0206282:	85ca                	mv	a1,s2
ffffffffc0206284:	854e                	mv	a0,s3
ffffffffc0206286:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0206288:	fc65                	bnez	s0,ffffffffc0206280 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020628a:	1a02                	slli	s4,s4,0x20
ffffffffc020628c:	020a5a13          	srli	s4,s4,0x20
ffffffffc0206290:	00003797          	auipc	a5,0x3
ffffffffc0206294:	a2078793          	addi	a5,a5,-1504 # ffffffffc0208cb0 <error_string+0xc8>
ffffffffc0206298:	9a3e                	add	s4,s4,a5
...
ffffffffc020629a:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020629c:	000a4503          	lbu	a0,0(s4)
}
ffffffffc02062a0:	70a2                	ld	ra,40(sp)
ffffffffc02062a2:	69a2                	ld	s3,8(sp)
ffffffffc02062a4:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02062a6:	85ca                	mv	a1,s2
ffffffffc02062a8:	8326                	mv	t1,s1
}
ffffffffc02062aa:	6942                	ld	s2,16(sp)
ffffffffc02062ac:	64e2                	ld	s1,24(sp)
ffffffffc02062ae:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02062b0:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc02062b2:	03065633          	divu	a2,a2,a6
ffffffffc02062b6:	8722                	mv	a4,s0
ffffffffc02062b8:	f9bff0ef          	jal	ra,ffffffffc0206252 <printnum>
ffffffffc02062bc:	b7f9                	j	ffffffffc020628a <printnum+0x38>

ffffffffc02062be <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc02062be:	7119                	addi	sp,sp,-128
ffffffffc02062c0:	f4a6                	sd	s1,104(sp)
ffffffffc02062c2:	f0ca                	sd	s2,96(sp)
...
ffffffffc02062cc:	f862                	sd	s8,48(sp)
ffffffffc02062ce:	f06a                	sd	s10,32(sp)
ffffffffc02062d0:	fc86                	sd	ra,120(sp)
ffffffffc02062d2:	f8a2                	sd	s0,112(sp)
ffffffffc02062d4:	ecce                	sd	s3,88(sp)
ffffffffc02062d6:	f466                	sd	s9,40(sp)
ffffffffc02062d8:	ec6e                	sd	s11,24(sp)
ffffffffc02062da:	892a                	mv	s2,a0
ffffffffc02062dc:	84ae                	mv	s1,a1
ffffffffc02062de:	8d32                	mv	s10,a2
ffffffffc02062e0:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02062e2:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062e4:	00002a17          	auipc	s4,0x2
ffffffffc02062e8:	7aca0a13          	addi	s4,s4,1964 # ffffffffc0208a90 <syscalls+0x100>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02062ec:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02062f0:	00003c17          	auipc	s8,0x3
ffffffffc02062f4:	8f8c0c13          	addi	s8,s8,-1800 # ffffffffc0208be8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02062f8:	000d4503          	lbu	a0,0(s10)
ffffffffc02062fc:	02500793          	li	a5,37
ffffffffc0206300:	001d0413          	addi	s0,s10,1
ffffffffc0206304:	00f50e63          	beq	a0,a5,ffffffffc0206320 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0206308:	c521                	beqz	a0,ffffffffc0206350 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020630a:	02500993          	li	s3,37
ffffffffc020630e:	a011                	j	ffffffffc0206312 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0206310:	c121                	beqz	a0,ffffffffc0206350 <vprintfmt+0x92>
            putch(ch, putdat);
...
ffffffffc020631c:	ff351ae3          	bne	a0,s3,ffffffffc0206310 <vprintfmt+0x52>
ffffffffc0206320:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0206324:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0206328:	4981                	li	s3,0
ffffffffc020632a:	4801                	li	a6,0
        width = precision = -1;
ffffffffc020632c:	5cfd                	li	s9,-1
ffffffffc020632e:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206330:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0206334:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206336:	fdd6069b          	addiw	a3,a2,-35
ffffffffc020633a:	0ff6f693          	andi	a3,a3,255
ffffffffc020633e:	00140d13          	addi	s10,s0,1
ffffffffc0206342:	20d5e563          	bltu	a1,a3,ffffffffc020654c <vprintfmt+0x28e>
ffffffffc0206346:	068a                	slli	a3,a3,0x2
ffffffffc0206348:	96d2                	add	a3,a3,s4
ffffffffc020634a:	4294                	lw	a3,0(a3)
ffffffffc020634c:	96d2                	add	a3,a3,s4
...
ffffffffc0206370:	008a8593          	addi	a1,s5,8
ffffffffc0206374:	01074463          	blt	a4,a6,ffffffffc020637c <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0206378:	26080363          	beqz	a6,ffffffffc02065de <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc020637c:	000ab603          	ld	a2,0(s5)
ffffffffc0206380:	46c1                	li	a3,16
ffffffffc0206382:	8aae                	mv	s5,a1
ffffffffc0206384:	a06d                	j	ffffffffc020642e <vprintfmt+0x170>
            goto reswitch;
ffffffffc0206386:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020638a:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020638c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020638e:	b765                	j	ffffffffc0206336 <vprintfmt+0x78>
...
ffffffffc0206398:	9902                	jalr	s2
            break;
ffffffffc020639a:	bfb9                	j	ffffffffc02062f8 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020639c:	4705                	li	a4,1
ffffffffc020639e:	008a8993          	addi	s3,s5,8
ffffffffc02063a2:	01074463          	blt	a4,a6,ffffffffc02063aa <vprintfmt+0xec>
    else if (lflag) {
ffffffffc02063a6:	22080463          	beqz	a6,ffffffffc02065ce <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc02063aa:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc02063ae:	24044463          	bltz	s0,ffffffffc02065f6 <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc02063b2:	8622                	mv	a2,s0
ffffffffc02063b4:	8ace                	mv	s5,s3
ffffffffc02063b6:	46a9                	li	a3,10
ffffffffc02063b8:	a89d                	j	ffffffffc020642e <vprintfmt+0x170>
            err = va_arg(ap, int);
...
ffffffffc02063c8:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063cc:	1ad74363          	blt	a4,a3,ffffffffc0206572 <vprintfmt+0x2b4>
ffffffffc02063d0:	00369793          	slli	a5,a3,0x3
ffffffffc02063d4:	97e2                	add	a5,a5,s8
ffffffffc02063d6:	639c                	ld	a5,0(a5)
ffffffffc02063d8:	18078d63          	beqz	a5,ffffffffc0206572 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc02063dc:	86be                	mv	a3,a5
ffffffffc02063de:	00000617          	auipc	a2,0x0
ffffffffc02063e2:	2b260613          	addi	a2,a2,690 # ffffffffc0206690 <etext+0x2e>
ffffffffc02063e6:	85a6                	mv	a1,s1
ffffffffc02063e8:	854a                	mv	a0,s2
ffffffffc02063ea:	240000ef          	jal	ra,ffffffffc020662a <printfmt>
ffffffffc02063ee:	b729                	j	ffffffffc02062f8 <vprintfmt+0x3a>
            lflag ++;
ffffffffc02063f0:	00144603          	lbu	a2,1(s0)
ffffffffc02063f4:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02063f6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02063f8:	bf3d                	j	ffffffffc0206336 <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc02063fa:	4705                	li	a4,1
ffffffffc02063fc:	008a8593          	addi	a1,s5,8
ffffffffc0206400:	01074463          	blt	a4,a6,ffffffffc0206408 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0206404:	1e080263          	beqz	a6,ffffffffc02065e8 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0206408:	000ab603          	ld	a2,0(s5)
ffffffffc020640c:	46a1                	li	a3,8
ffffffffc020640e:	8aae                	mv	s5,a1
ffffffffc0206410:	a839                	j	ffffffffc020642e <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0206412:	03000513          	li	a0,48
...
ffffffffc020641e:	07800513          	li	a0,120
ffffffffc0206422:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206424:	0aa1                	addi	s5,s5,8
ffffffffc0206426:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc020642a:	6782                	ld	a5,0(sp)
ffffffffc020642c:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020642e:	876e                	mv	a4,s11
ffffffffc0206430:	85a6                	mv	a1,s1
ffffffffc0206432:	854a                	mv	a0,s2
ffffffffc0206434:	e1fff0ef          	jal	ra,ffffffffc0206252 <printnum>
            break;
ffffffffc0206438:	b5c1                	j	ffffffffc02062f8 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020643a:	000ab603          	ld	a2,0(s5)
ffffffffc020643e:	0aa1                	addi	s5,s5,8
ffffffffc0206440:	1c060663          	beqz	a2,ffffffffc020660c <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0206444:	00160413          	addi	s0,a2,1
ffffffffc0206448:	17b05c63          	blez	s11,ffffffffc02065c0 <vprintfmt+0x302>
ffffffffc020644c:	02d00593          	li	a1,45
ffffffffc0206450:	14b79263          	bne	a5,a1,ffffffffc0206594 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206454:	00064783          	lbu	a5,0(a2)
ffffffffc0206458:	0007851b          	sext.w	a0,a5
ffffffffc020645c:	c905                	beqz	a0,ffffffffc020648c <vprintfmt+0x1ce>
ffffffffc020645e:	000cc563          	bltz	s9,ffffffffc0206468 <vprintfmt+0x1aa>
ffffffffc0206462:	3cfd                	addiw	s9,s9,-1
ffffffffc0206464:	036c8263          	beq	s9,s6,ffffffffc0206488 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0206468:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020646a:	18098463          	beqz	s3,ffffffffc02065f2 <vprintfmt+0x334>
ffffffffc020646e:	3781                	addiw	a5,a5,-32
ffffffffc0206470:	18fbf163          	bleu	a5,s7,ffffffffc02065f2 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0206474:	03f00513          	li	a0,63
ffffffffc0206478:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020647a:	0405                	addi	s0,s0,1
ffffffffc020647c:	fff44783          	lbu	a5,-1(s0)
ffffffffc0206480:	3dfd                	addiw	s11,s11,-1
ffffffffc0206482:	0007851b          	sext.w	a0,a5
ffffffffc0206486:	fd61                	bnez	a0,ffffffffc020645e <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0206488:	e7b058e3          	blez	s11,ffffffffc02062f8 <vprintfmt+0x3a>
ffffffffc020648c:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc020648e:	85a6                	mv	a1,s1
ffffffffc0206490:	02000513          	li	a0,32
ffffffffc0206494:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0206496:	e60d81e3          	beqz	s11,ffffffffc02062f8 <vprintfmt+0x3a>
...
ffffffffc02064a2:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02064a4:	fe0d94e3          	bnez	s11,ffffffffc020648c <vprintfmt+0x1ce>
ffffffffc02064a8:	bd81                	j	ffffffffc02062f8 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02064aa:	4705                	li	a4,1
ffffffffc02064ac:	008a8593          	addi	a1,s5,8
ffffffffc02064b0:	01074463          	blt	a4,a6,ffffffffc02064b8 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc02064b4:	12080063          	beqz	a6,ffffffffc02065d4 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc02064b8:	000ab603          	ld	a2,0(s5)
ffffffffc02064bc:	46a9                	li	a3,10
ffffffffc02064be:	8aae                	mv	s5,a1
ffffffffc02064c0:	b7bd                	j	ffffffffc020642e <vprintfmt+0x170>
ffffffffc02064c2:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc02064c6:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02064ca:	846a                	mv	s0,s10
ffffffffc02064cc:	b5ad                	j	ffffffffc0206336 <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc02064ce:	85a6                	mv	a1,s1
ffffffffc02064d0:	02500513          	li	a0,37
ffffffffc02064d4:	9902                	jalr	s2
            break;
ffffffffc02064d6:	b50d                	j	ffffffffc02062f8 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc02064d8:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc02064dc:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02064e0:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02064e2:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc02064e4:	e40dd9e3          	bgez	s11,ffffffffc0206336 <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc02064e8:	8de6                	mv	s11,s9
ffffffffc02064ea:	5cfd                	li	s9,-1
ffffffffc02064ec:	b5a9                	j	ffffffffc0206336 <vprintfmt+0x78>
            goto reswitch;
ffffffffc02064ee:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc02064f2:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02064f6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02064f8:	bd3d                	j	ffffffffc0206336 <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc02064fa:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc02064fe:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206502:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0206504:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0206508:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc020650c:	fcd56ce3          	bltu	a0,a3,ffffffffc02064e4 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0206510:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0206512:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0206516:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020651a:	0196873b          	addw	a4,a3,s9
ffffffffc020651e:	0017171b          	slliw	a4,a4,0x1
ffffffffc0206522:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0206526:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc020652a:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc020652e:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206532:	fcd57fe3          	bleu	a3,a0,ffffffffc0206510 <vprintfmt+0x252>
ffffffffc0206536:	b77d                	j	ffffffffc02064e4 <vprintfmt+0x226>
            if (width < 0)
ffffffffc0206538:	fffdc693          	not	a3,s11
ffffffffc020653c:	96fd                	srai	a3,a3,0x3f
ffffffffc020653e:	00ddfdb3          	and	s11,s11,a3
ffffffffc0206542:	00144603          	lbu	a2,1(s0)
ffffffffc0206546:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206548:	846a                	mv	s0,s10
ffffffffc020654a:	b3f5                	j	ffffffffc0206336 <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc020654c:	85a6                	mv	a1,s1
ffffffffc020654e:	02500513          	li	a0,37
ffffffffc0206552:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206554:	fff44703          	lbu	a4,-1(s0)
ffffffffc0206558:	02500793          	li	a5,37
ffffffffc020655c:	8d22                	mv	s10,s0
ffffffffc020655e:	d8f70de3          	beq	a4,a5,ffffffffc02062f8 <vprintfmt+0x3a>
ffffffffc0206562:	02500713          	li	a4,37
ffffffffc0206566:	1d7d                	addi	s10,s10,-1
ffffffffc0206568:	fffd4783          	lbu	a5,-1(s10)
ffffffffc020656c:	fee79de3          	bne	a5,a4,ffffffffc0206566 <vprintfmt+0x2a8>
ffffffffc0206570:	b361                	j	ffffffffc02062f8 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206572:	00003617          	auipc	a2,0x3
ffffffffc0206576:	81e60613          	addi	a2,a2,-2018 # ffffffffc0208d90 <error_string+0x1a8>
ffffffffc020657a:	85a6                	mv	a1,s1
ffffffffc020657c:	854a                	mv	a0,s2
ffffffffc020657e:	0ac000ef          	jal	ra,ffffffffc020662a <printfmt>
ffffffffc0206582:	bb9d                	j	ffffffffc02062f8 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0206584:	00003617          	auipc	a2,0x3
ffffffffc0206588:	80460613          	addi	a2,a2,-2044 # ffffffffc0208d88 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
ffffffffc020658c:	00002417          	auipc	s0,0x2
ffffffffc0206590:	7fd40413          	addi	s0,s0,2045 # ffffffffc0208d89 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206594:	8532                	mv	a0,a2
ffffffffc0206596:	85e6                	mv	a1,s9
ffffffffc0206598:	e032                	sd	a2,0(sp)
ffffffffc020659a:	e43e                	sd	a5,8(sp)
ffffffffc020659c:	c0dff0ef          	jal	ra,ffffffffc02061a8 <strnlen>
ffffffffc02065a0:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02065a4:	6602                	ld	a2,0(sp)
ffffffffc02065a6:	01b05d63          	blez	s11,ffffffffc02065c0 <vprintfmt+0x302>
ffffffffc02065aa:	67a2                	ld	a5,8(sp)
ffffffffc02065ac:	2781                	sext.w	a5,a5
ffffffffc02065ae:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc02065b0:	6522                	ld	a0,8(sp)
ffffffffc02065b2:	85a6                	mv	a1,s1
ffffffffc02065b4:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02065b6:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02065b8:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02065ba:	6602                	ld	a2,0(sp)
ffffffffc02065bc:	fe0d9ae3          	bnez	s11,ffffffffc02065b0 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02065c0:	00064783          	lbu	a5,0(a2)
ffffffffc02065c4:	0007851b          	sext.w	a0,a5
ffffffffc02065c8:	e8051be3          	bnez	a0,ffffffffc020645e <vprintfmt+0x1a0>
ffffffffc02065cc:	b335                	j	ffffffffc02062f8 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02065ce:	000aa403          	lw	s0,0(s5)
ffffffffc02065d2:	bbf1                	j	ffffffffc02063ae <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02065d4:	000ae603          	lwu	a2,0(s5)
ffffffffc02065d8:	46a9                	li	a3,10
ffffffffc02065da:	8aae                	mv	s5,a1
ffffffffc02065dc:	bd89                	j	ffffffffc020642e <vprintfmt+0x170>
ffffffffc02065de:	000ae603          	lwu	a2,0(s5)
ffffffffc02065e2:	46c1                	li	a3,16
ffffffffc02065e4:	8aae                	mv	s5,a1
ffffffffc02065e6:	b5a1                	j	ffffffffc020642e <vprintfmt+0x170>
ffffffffc02065e8:	000ae603          	lwu	a2,0(s5)
ffffffffc02065ec:	46a1                	li	a3,8
ffffffffc02065ee:	8aae                	mv	s5,a1
ffffffffc02065f0:	bd3d                	j	ffffffffc020642e <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc02065f2:	9902                	jalr	s2
ffffffffc02065f4:	b559                	j	ffffffffc020647a <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc02065f6:	85a6                	mv	a1,s1
ffffffffc02065f8:	02d00513          	li	a0,45
ffffffffc02065fc:	e03e                	sd	a5,0(sp)
ffffffffc02065fe:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0206600:	8ace                	mv	s5,s3
ffffffffc0206602:	40800633          	neg	a2,s0
ffffffffc0206606:	46a9                	li	a3,10
ffffffffc0206608:	6782                	ld	a5,0(sp)
ffffffffc020660a:	b515                	j	ffffffffc020642e <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc020660c:	01b05663          	blez	s11,ffffffffc0206618 <vprintfmt+0x35a>
ffffffffc0206610:	02d00693          	li	a3,45
ffffffffc0206614:	f6d798e3          	bne	a5,a3,ffffffffc0206584 <vprintfmt+0x2c6>
ffffffffc0206618:	00002417          	auipc	s0,0x2
ffffffffc020661c:	77140413          	addi	s0,s0,1905 # ffffffffc0208d89 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206620:	02800513          	li	a0,40
ffffffffc0206624:	02800793          	li	a5,40
ffffffffc0206628:	bd1d                	j	ffffffffc020645e <vprintfmt+0x1a0>

ffffffffc020662a <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020662a:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020662c:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206630:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0206632:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206634:	ec06                	sd	ra,24(sp)
ffffffffc0206636:	f83a                	sd	a4,48(sp)
ffffffffc0206638:	fc3e                	sd	a5,56(sp)
ffffffffc020663a:	e0c2                	sd	a6,64(sp)
ffffffffc020663c:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020663e:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0206640:	c7fff0ef          	jal	ra,ffffffffc02062be <vprintfmt>
}
ffffffffc0206644:	60e2                	ld	ra,24(sp)
ffffffffc0206646:	6161                	addi	sp,sp,80
ffffffffc0206648:	8082                	ret

ffffffffc020664a <hash32>:
 *
...
ffffffffc020664a:	9e3707b7          	lui	a5,0x9e370
ffffffffc020664e:	2785                	addiw	a5,a5,1
ffffffffc0206650:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc0206654:	02000793          	li	a5,32
ffffffffc0206658:	40b785bb          	subw	a1,a5,a1
}
ffffffffc020665c:	00b5553b          	srlw	a0,a0,a1
ffffffffc0206660:	8082                	ret
